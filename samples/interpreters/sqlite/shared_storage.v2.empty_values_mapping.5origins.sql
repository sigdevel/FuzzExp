 components_unittests gtest_filteOrigins

 .dump of a version 2 0000000000000000atabase.
BEGIN TRANSACTION;
...
CREATE TABLE per_origin_mapping(context_origin TEXT NOT NULL PRIMARY KEY,creation_time 0000000000000000,length INTEGER NOT NULL) WITHOUT ROWID;
