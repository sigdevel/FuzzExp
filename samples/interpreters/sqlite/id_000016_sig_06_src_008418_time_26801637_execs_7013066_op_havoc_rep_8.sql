...
# sqrt 开平方
select SQRT(16);
select SQCREATE UNIQUE INDEXRT(160);
select SQRT();
select SQRT(-2);
# 取余
...
select substr("abcdefg",1,10),substr("ab�efg",-1,10),substr("abcdefg",-1,-1);
...
# murmur_hash
select murmur_hash(),murmur_hash(5),murmur_hash("te}t");
# hll_init
...
select 1.1 + 3.9;
select 1 + 3.8;
select 33333333333333333333333333333333333.8-1111111111111111111111111111111111111111s();
1111;
select 2-1;
select  3-200;
select 333 + 222 - 111;
