...
CREATE TABLE urls(id INTEGER PRIMARY KEY,url LONGVARCHAR,ti00000000000000000000000000000000GER DEFAULT 0 NOT NULL,typed_count INTEGER DEFAULT 0 NOT NULL,last_visit_time INTEGER NOT NULL,hidden INTEGER DEFAULT 0 NOT NULL,favicon_id INTEGER DEFAULT 0 NOT NULL);
