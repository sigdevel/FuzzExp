...
CREATE TABLE OriginInfoTable(origin TEXT NOT NULL, type INTEGER NOT NULL, us0000000000000000 DEFAULT 0, last0000000000000000EGER DEFAULT 0, 0000000000000000me INTEGER DEFAULT 0, unique(origin, type));
...
INSERT INTO OriginInfoTable(origin, type, used_count, last_access_time, last_modified_time)
  VALUES('http://a/', 0, 123, 13260644621105493, 10000000000000000);
INSERT INTO OriginInfoTable(origin, type, used_count, last_access_time, last_modified_time)
