...
BEGIN TRANSACTION;
 ...
 For the schemas t0000000000000000000000000000000000000000ed to match the code
CREATE TABL0000000000000000d INTEGER PRIMARY KEY NOT NULL,    url TEXT NOT NULL,    fetch_time INTEGER NOT NULL,    expiry_time INTEGER NOT NULL);
