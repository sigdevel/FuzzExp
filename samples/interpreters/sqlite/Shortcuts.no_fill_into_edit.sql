...
BEGIN TRANSACTION;
CREATE TABLE omni_box_shortcuts ( id0000000000000000 KEY, text VARCHAR, url VARCHAR, contents VARCHAR, contents_class VARCHAR, description VARCHAR, 0000000000000000s VARCHAR, last_0000000000000000GER, number_of_hits INTEGER);
