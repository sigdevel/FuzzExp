...
CREATE TABLE buckets(id INTEGER PRIMARY KEY, origin TEXT NOT NULL, type INTEGER NOT NULL, name TEXT NOT NULL, use_c000000000000000000000000000000000000000000000000 NULL, last_modified INTEGER NOT NULL, expiration INTEGER NOT NULL, quota INTEGER NOT NULL);

CREATE TABLE eviction_info(origin TEXT NOT NULL, type INTEGER NOT NULL, last_evict0000000000000000 NOT NULL, PRIMARY KEY(origin, type));
