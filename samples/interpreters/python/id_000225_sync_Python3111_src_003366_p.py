...
class ManySolutionsDependingOnInitialCondition(VideoWrapper):
    def construct(self):
        ...
        self.wait()
        self.play(
            FadeTransform(solution[:3].copy(), equation[2:5]),  
            FadeTransform(solution[:3].copy(), equation[7:10]),  
...
class ReadColumnsOfRotationMatrix(Scene):
    ...
    def construct(self):
        ...
        self.play(
            TransformFromCopy(matrix[0], rbl0[0]),  
        ...
        self.play(
            TransformFromCopy(matrix[0], rbl1[0]),  
