...
'https://knowtechie.com/rocket-pass-4-in-rocket-league-brings-with-it-a-new-rally-inspired-car/': {
    ...
    'with': ['Rocket Pass 4 will begin at 10:00 a.m. PDT', 'Let us know down below in the comments', 'Holy shit, Mortal Kombat 11'],  
...
'https://www.toptal.com/python/top-10-mistakes-that-python-programmers-make': {
    ...
    'categories': [],
    'tags': [],
    'with': ['and code reuse.', 'bar is optional', 'What the $%
    'without': ['Martin has worked as', 'delivered weekly.', 'MCMC Methods:'],
    'comments': ['for common mistake 
    'license': '',
    'region': '',
},
...
'https://nurmeinstandpunkt.wordpress.com/2020/01/23/blogposting-01-23-2020/': {
    ...
    'date': '2020-01-23',
    'description': 'Presseförderung: Studie zweifelt an Stütze vom Staat via Horizont Gewalt im Netz &
...
'https://gnadlib.wordpress.com/2020/01/05/scherenschnitt-3/': {
    ...
    'date': '2020-01-05',
    'description': 'Die Stadt steht schwarz und schweiget&
...
'https://murdeltas.wordpress.com/2015/04/05/barcamp-graz-2015-politcamp-call-for-action/': {
    ...
    'date': '2015-04-05',
    'description': 'In nicht mehr ganz 2 Wochen ist es soweit: das Barcamp Graz 2015 steht vor der Tür &
...
'https://andreabottlinger.wordpress.com/2019/12/26/arent-we-all/': {
    ...
    'title': 'Aren’t we all …?',
    'date': '2019-12-26',
    'description': 'Es wird Zeit, dass ich hier auch etwas dazu schreibe: Wir machen ein Spiel! Es heißt &
    'categories': ['Allgemein'],
    'tags': [],
...
'https://alexanderlasch.wordpress.com/2019/11/14/was-das-christkind-und-native-americans-gemeinsam-haben-oder-warum-wir-sprachgeschichte-brauchen/': {
    ...
    'date': '2019-11-14',
    'description': 'An dieser und anderer Stelle habe ich vor kurzem das Projekt 
...
'https://ritinardo.wordpress.com/2017/11/26/bundesregierung-2017-btw17-groko/': {
    ...
    'without': ['Erstelle eine kostenlose Website oder Blog', 'Teilen Sie dies mit:', 'Fall 
    'comments': [],
    'license': '',
    'region': '',
},
...
'https://www.parallels.com/products/desktop/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Quickly move files, apps and more', '
...
'https://madame.lefigaro.fr/bien-etre/problemes-dintestin-quoi-manger-pour-aller-bien-110417-130897': {
    ...
    'date': '2017-04-12',
    'description': 'Pour aller bien «en haut», commençons par aller bien «en bas». Mode d&
    'categories': [],
...
'https://www.timesofisrael.com/state-of-washington-swears-in-first-native-american-jewish-supreme-court-justice/': {
    ...
    'date': '2020-01-08',
    'description': 'Governor says naming of &
    'categories': [],
...
'https://deleuze.enacademic.com/104/micropolitics': {
    ...
    'title': 'micropolitics',
    'date': '', 
    'description': 'by Kenneth Surin   Deleuze and Guattari oppose micropolitics to the politics of molarisation. Where the molar (or arborescent , to use their equivalent term) designates structures and principles that are based on rigid stratifications or&amp;
    'categories': [],
    'tags': [],
...
'https://www.tafelblog.de/welches-europa-wir-wollen/': {
    ...
    'with': ['Knapp zwei Tage vor der Europawahl', 'Die Ergebnisse der Bülow-Wahl', 'bei uns viele Stimmen hinzugewinnen'],  
...
'https://zahlenzauberin.wordpress.com/2012/08/22/was-zum-horen-in-den-ferien/': {
    ...
    'date': '2010-08-22',
    'description': 'Dank Kabelanschluss kann ich, auch in Sachsen ,Bayern 2  hören. Da läuft gerade ein spannendes nah dran zum Thema: Freude, Falle, Frust: Der Mutterliebe zarte Sorgen Raben- versus Gluckenmütter &amp;
...
'http://www.interscenar.io/politik/eindruecke/was-wir-ueber-uns-nicht-hoeren-wollen': {
    ...
    'date': '2019-03-03',
    'description': 'Merkel: Warum alles gut ist wie&
...
'https://mitternachtskabinett.wordpress.com/2016/06/19/geister-spuk-gentrifizierung/': {
    ...
    'author': '',
    'title': 'Geister, Spuk & Gentrifizierung (
    'date': '2016-06-19',
...
'https://insubordinant.wordpress.com/2015/08/11/need-for-speed/': {
    ...
    'date': '2015-08-11',
    'description': 'Der kleine Junge bremst abrupt vor mir ab: &
...
'http://thenervousbreakdown.com/tanderson/2011/07/the-loneliest-woman-in-the-world-an-appreciation-of-hearts-alone/': {
    ...
    'date': '2011-07-11',
    'description': 'Tim Anderson thinks the best way to appreciate Heart&
    'categories': [],
...
'http://www.regards.fr/politique/article/deux-ans-et-demi-en-macronie-9-mises-en-examen-10-enquetes-en-cours-et-2': {
    ...
    'date': '2018-09-30',
    'description': 'On vous aurait bien fait un top 10 des macronistes confront&
    'categories': ['Accueil'],
...
'https://www.soundofscience.fr/1927': {
    ...
    'date': '2020-01-20',
    'description': 'En réaction à la candidature du conseiller recherche d&
...
'https://www.theguardian.com/education/2020/jan/20/thousands-of-uk-academics-treated-as-second-class-citizens': {
    ...
    'with': ['It calls on the', 'But a spokesperson for'],  
...
'https://laviedesidees.fr/L-evaluation-et-les-listes-de.html': {
    ...
    'date': '2009-09-15',
    'description': 'L&"L'évaluation, et la place")
...
'https://weselpower.wordpress.com/2009/12/23/monstergesprche-1/': {
    ...
    'title': 'Monstergespräche 
    'date': '2009-12-23',
    'description': 'M:Wer rutscht als n&auml;chstes aus auf dem Glatteis? Ich: Ich wette,dass du als n&auml;chstes ausr&
    'categories': ['meins'],
    'tags': ['Monster', 'winter'],
...
'https://telebasel.ch/2019/10/19/junge-lenker-schrotten-corvette-und-audi-in-einer-nacht/?channel=105100': {
    ...
    'date': '2019-10-19',
    'description': 'Am Freitagabend krachte ein 19-jähriger Neulenker in Lenzburg in eine Leitplanke. Am Auto und an der Leitplanke entstand ein Sachschaden von 80&
    'categories': [],
    'tags': [],
...
'https://web.archive.org/web/20171008220355/http://juergenheitmann.com/essays/2017/01/aggression-fotografie/': {
    ...
    'without': ['View all essays by tag', '
    'comments': [],
    'license': '',
    'region': '',
},
...
'https://www.fr.de/politik/kim-jong-un-nordkorea-bilder-diktator-donald-trump-zr-13680734.html': {
    ...
    'date': '2020-05-04',
    'description': 'Kim Jong Un taucht nach Wochen wieder auf. Die Bilder, die das beweisen sollen, erfreuen Donald Trump. Er sendet Gr&
    'categories': ['Politik'],
...
'https://legrandcontinent.eu/fr/2020/03/02/francois-heran/': {
    ...
    'date': '2020-03-02',
    'description': 'Alors qu’Erdogan ouvre les frontières turques et que la Méditerranée est encore une fois la scène d&
...
'https://www.infocomcgt.fr/caisse-de-solidarite-financiere/': {
    ...
    'date': '',
    'description': 'Faire un don : En ligneEnvoyer un chèque ou faire un virement    Site internet de la 
    'categories': [],
    'tags': [],
    'with': ['ou tout autre régression sociale', '1 545 500 EUROS', 'Reportage JT 13 heures de France 2'],  
    'without': ['On n’est pas de la chair à patron', 'Votre adresse e-mail ne sera pas publiée', 'Contactez vos représentants'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.ok-magazin.de/people/real-life/horror-fund-instagram-star-24-einbetoniert-62276.html': {
    ...
    'categories': ['Tod'],
    'tags': [],
    'with': ['Die Ermittler gehen davon aus, dass der drogensüchtige Mann', 'das alles wäre nur ein Traum, es tut mir so leid.', 'Kaum zu fassen, dass diese Story wirklich passiert ist:'],  
    'without': ['TikTok-Star begeht', 'Real Life', 'Themen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.zdf.de/sport/us-sport-corona-100.html': {
    ...
    'categories': ['Sport'],
    'tags': [],
    'with': ['New York ist das Epizentrum der Corona-Pandemie', ' Auch der Sport ist zum Stillstand', 'Die Anteilnahme in den Top-Ligen ist groß. Wie es '],  
    'without': ['Video verfügbar bis 28.02.2021', 'Auch interessant', 'ZDF Unternehmen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.fluter.de/corona-big-data-suedkorea-vorbild-fuer-deutschland': {
    ...
    'with': ['Felix Stalder: Zu wissen, mit wem Corona-Patienten', 'gleichzeitig Dutzende, vielleicht sogar Hunderte Nutzer eingewählt.', 'möglich zu machen. In jedem Fall bricht eine ander'],  
    'without': ['Titelbild:', 'Auch interessant', 'Dieser Text wurde veröffentlicht'],  
    'comments': [],  
...
'https://geschichtedergegenwart.ch/mit-foucault-die-pandemie-verstehen/': {
    ...
    'with': ['„Über­le­bens“ aller demo­kra­ti­schen Hinder­nisse und können endlich', 'Daher sei das „Verhältnis zu sich selbst“, wie Foucault', 'einge­führt, um das Auftau­chen neuer poli­ti­scher Ziele und Stra­te­gien in'],  
    'without': ['Die Versu­chungen des Abso­lu­tismus.', 'Sinn ohne Wort. Vom „Volks­thum“ und anderen „Thum­heiten“', 'lehrt Geschichte der Neu­zeit'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.giga.de/downloads/google-chrome/tipps/google-chrome-exportieren-alle-daten-sichern-und-nichts-mehr-verlieren/': {
    ...
    'tags': [],
    'with': ['Es gibt zwei Methoden, mit denen ihr Google Chrome', 'Google Chrome speichert alle benutzerrelevanten Daten,', 'funktioniert - in eingeschränktem Maße - natürlich auch auf'],  
    'without': ['Für Links auf dieser Seite erhält GIGA', 'oder blauer Unterstreichung gekennzeichnete. Mehr Infos.', 'Alle Rechte vorbehalten.'],  
    'comments': ['Und wie macht man das auf Andriod', 'das Orwell recht behält und der Datenüberwachungskrake', 'Deine so krass wertvollen Passwörter für Online Foren und'],  
    'license': '',  
    'region': 'DE',  
},
'https://www.antary.de/2017/06/29/wireshark-besuchte-urls-anzeigen-http-und-https/': {
    ...
    'tags': [],
    'with': ['Wireshark möglich ist, alle aufgerufenen', 'Paketmitschnitt und eine aktuelle Version von Wireshark voraus. Beim', 'angezeigt werden, was meiner Meinung nach komfortabler ist.'],  
    'without': ['Mit der Nutzung dieses Formulars erklärst du dich mit der Speicherung', 'Über ein Geschenk von meine', 'mich über nachfolgende Kommentare per E-Mail.'],  
    'comments': ['umindest einigermaßen dem Thema nähern :)', 'Aufruf dafür aussehen muss.'],  
    'license': '',  
    'region': 'DE',  
},
'https://www.dalloz-actualite.fr/node/libre-cours-raoult-nazis-et-moi': {
    ...
    'categories': ['Avocat'],
    'tags': [],
    'with': ['C’est la guerre. Et pourtant', 'Vive le professeur Raoult !', 'Que les magistrats sachent qu’ils peuvent com'],  
    'without': ['Votre commentaire ', 'otre adresse e-m', 'otre no'],  
    'comments': ['En ce temps de confinement, Ceyss', 'Le confinement chauffe les esprits'],  
    'license': '',  
    'region': 'FR',  
},
'https://www.pocketpc.ch/windows-phone-7-allgemein/122760-microsoft-beginnt-auslieferung-vorbereitungsupdate-34.html': {
    ...
    'categories': [],
    'tags': [],
    'with': ['as war noch nicht das Update, sondern nur', 's auf Gerät, Telefon oder Ha', 'hat keine 5 Minuten gedauert, warum denn bei einigen'],  
    'without': ['Gewinnspiel: Das neue Quizdue', '[Apple Pay] und eure Erfahrun', 'Review: InLine BT-POCKET falt'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://strangemachines.io/articles/performant-python': {
    ...
    'categories': ['articles'],
    'tags': [],
    'with': ['There are many ways to improve Python', 'complicated, there are a number of ways ', 'Map and filter are sometimes faster'],  
    'without': ['Challenges', 'hello@strangemachines.io', '06 December 2019'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://wordsmith.org/words/maudlin.html': {
    ...
    'categories': ['words'],
    'tags': [],
    'with': ['adjective: Overly sentimental', 'derived after a town on the Sea ', 'Jeannette Layne-Clark; Minister on Stage; Daily Nation '],  
    'without': ['spread the magic of words to readers everywhere', '“A word in the head is worth two in the book.”', '“A trawl through the site’s archive yields all kinds of delights.”'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://businessjargons.com/leadership-styles.html': {
    ...
    'categories': ['Business'],
    'tags': [],
    'with': ['the way he gives directions to his subordinates and ', 'The leadership styles can either be classified on', 'adopts to influence the behavior of his subordinates.'],  
    'without': ['Effective Communication', 'International Marketing', 'Communication Process'],  
    'comments': ['well detailed article. More knowledge', 'I haven’t come across a more succinct', 'very informative I have learnt a lot'],  
    'license': '',  
    'region': '',  
},
'https://www.mesopinions.com/petition/art-culture/mutilation-choeur-radio-france-unique-choeur/76519': {
    ...
    'categories': [],
    'tags': [],
    'with': ['National de France et du Philharmonique de Radio France.', 'bien des promesses non tenues par des directions successives', 'vide de toute ambition artistique et culturelle.'],  
    'without': ['Notre communauté', 'Espace presse', 'Réussir votre mobilisation'],  
    'comments': ['un fleuron du patrimoine artistique et culturel français', "L'art c'est les hommes...humains !", 'Arrêtez la casse du service public !'],  
    'license': '',  
    'region': '',  
},
'https://www.linkedin.com/pulse/ich-war-am-wochenende-auf-einer-hochzeit-im-wendland-inga-hoeltmann': {
    ...
    'with': ['Das Wendland ist eine schöne, aber sehr ländliche', 'hinnehmen als sei es nicht zu ändern. Beschämend.', 'Konzepte abseits der urbanen Räume in'],  
    'without': ['Einstellungen für Nichtmitglieder', 'Nutzervereinbarung', 'Markenrichtlinine'],  
    'comments': ['Meine Antworten sin, laut LinkedIn,', 'sondern häufig an den fehlenden Baggern.', 'Die gibt es bereits zuhauf ohne gute Connectivity.'],  
    'license': '',  
    'region': '',  
},
'https://www.wolfgangmichal.de/2017/06/07/publizistische-sorgfaltspflicht-statt-netzwerkdurchsetzungsgesetz/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Die Repräsentanten der Republik sind nervös. ', 'verkaufen, muss jedes Unternehmen in die Bredouille bringen.', 'EU-Urheberrechts-Richtlinie sogar bindend vorgeschrieben werden.'],  
    'without': ['verteidigt sie ihre Linie gegen die Zumutungen der Moderne.', 'verhindert, sondern zu Geld gemacht werden.', 'den Rechtspopulisten mehr nützen als schaden.'],  
    'comments': ['Sehr schön zusammengefasst bzw. heraus gearbeitet.', 'Soziodemographische Untersuchungen?'],  
    'license': '',  
    'region': 'DE',  
},
'https://www.zooroyal.de/trixie-natura-kleintierstall-mit-freilaufgehege': {
    ...
    'tags': [],
    'with': ['stabilem Kiefernholz gefertigt mit herausziehbarem, kunststoffbeschichtetem Boden.', 'Der Natura Stall lässt sich von oben sowie von vorne öffnen ', 'verschließbare Bodenluke mit Kunststoffbeschichtung'],  
    'without': ['Kleintierheim', 'dass ZooRoyal mir per E-Mail an mich gerichtete Werbung', 'Trixie Kleintierfutter'],  
    'comments': ['Danke dem Team von zoo royale.', 'und preisleistungsverhaltniss ist auch o.k', 'Unsere Meerschweinchen fühlen sich sehr wohl darin'],  
    'license': '',  
    'region': 'DE',  
},
'https://www.lopinion.fr/edition/economie/glyphosate-radiographie-d-intoxication-collective-186859': {
    ...
    'categories': ['Economie'],
    'tags': [],
    'with': ['La firme Bayer, propriétaire', 'Jackpot pour Monsanto qui vend à la fois les semences', 'puisque le champ des recherches est infini...'],  
    'without': ['Mentions légales', 'Conditions générales de vente', 'Charte des commentaires'],  
    'comments': ['Sauf sur une forme rarissime de lymphome.', 'de prouver la nocivité, autre que végétale', 'suffisant. Notre société est redevenue religieuse.'],  
    'license': '',  
    'region': 'FR',  
},
'https://www.tagesanzeiger.ch/wie-umweltzerstoerung-neue-epidemien-beguenstigt-633956751547': {
    ...
    'categories': ['Wissen'],
    'tags': [],
    'with': ['Dichter Rauch hing im Herbst des Jahres 1997', 'es kann auch von Mensch zu Mensch weitergegeben werden.', 'Im Wesentlichen geht es da aber um Fragen der Wirtschaft und'],  
    'without': ['Aktualisiert:', '03.04.2020', 'All Rights Reserved'],  
    'comments': ['Jetzt werden wir den Preis bezahlen für stetigen Wachstum', 'Verhütungsmitteln (rein technische Massnahmen) mit ', 'Was nicht unbedingt schlecht ist - sonst würde die Menschheit wohl'],  
    'license': '',  
    'region': 'CH',  
},
'https://www.freitag.de/autoren/benjamin-immanuel-hoff/heute-schon-an-morgen-denken': {
    ...
    'with': ['Kommunen, die Länder und der Bund einschneidende', 'Durch die Beschränkungen des öffentlichen Lebens wurde erreicht', 'Kultur mit dem gemeinwirtschaftlichen Gedanken des Genossenschaftswesens verbinden'],  
    'without': ['© der Freitag Mediengesellschaft mbH & Co. KG', 'Beitrag gibt die Meinung des Autors wieder, nicht notwendigerweise die der Redaktion des Freitag.', 'Beitrag handelt es sich um ein Blog aus der Freitag-Community'],  
    'comments': ['Nun ... erst gestern wurde dem Zuschauer '],  
    'license': '',  
    'region': 'DE',  
},
'https://www.stylegart.de/naturkosmetik-doch-gesuender/': {
    ...
    'with': ['Wer meine Instastorys fleißig verfolgt, der weiß, dass ich', 'Tuben und Tiegel mit natürlichen Verpackungen, meist mit Blütenprints umrankt versprechen ', 'Dr. Scheller und Lavera, die natürliche Kosmetika zu fairen Preisen anbieten!'],  
    'without': ['Was dich erwartet', 'Datenschutzerklärung', 'Vorher-Nachher'],  
    'comments': ['Ich verwende sehr viel Naturkosmetik, denn wir haben', 'Vielen Dank für deinen Kommentar… ja. das sagt meine Mutter auch immer zu mir', 'Hey, ich würde nie sagen, dass Natur- oder konventionelle Kosmetik'],  
    'license': '',  
    'region': 'DE',  
},
'http://fouryears.eu/2019/10/21/interning-of-small-integers-in-python/': {
    ...
    'with': ['Note that depending on the version of Python the value of the integer', 'lovely example, illustrating the way Python', '(addr, ctypes.'],  
    'without': ['Best western clearfield pa on Skype "removed" messages', '6 Regularization Techniques for Deep Learning', 'Konstantin on ROC Area-Under-the-Curve Explained'],  
    'comments': [],  
    'license': '',  
    'region': 'EU',  
},
'https://www.axios.com/newsletters/axios-future-7120a6cf-cf67-4e01-9f15-f73f114e8d27.html': {
    ...
    'tags': [],
    'with': ['A new breed of intelligent video surveillance is being installed', 'good kid, m.A.A.d city," the 5th song starts 19 ', 'to school districts and universities, in addition to banks'],  
    'without': ['Axios newsletters', 'Online tracking choices', 'Axios podcasts'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.nytimes.com/2020/08/16/business/california-blackouts.html': {
    ...
    'categories': ['Business'],
    'tags': [],
    'with': ['As temperatures began to rise in California on', '“If there’s really a problem and not just the ISO', 'In particular, California ISO said two natural gas power'],  
    'without': ['Her Husband Abused Her. But Getting a Divorce Was', 'Chris Rock Tried to Warn Us', 'Opinion: Which Party Represents the Racial Future?'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://californiaglobe.com/section-2/amazon-liable-for-defective-third-party-products-rules-ca-appelate-court/': {
    ...
    'with': ['The ruling has grouped Amazon with other retailers who', 'provided by Lenoge for its product listing.', 'case to a higher court in the near future.'],  
    'without': ['Get a weekly summary of California Globe stories:', 'Follow Us', 'Leave a Reply'],  
    'comments': ['Nail them to the wall. amazon is bad', 'together like Ebay, but also offer to', 'to groups that are determined to tear down society.'],  
    'license': '',  
    'region': '',  
},
'https://www.sciencesetavenir.fr/sante/covid-19-et-infox-comment-une-rumeur-devient-realite_147359': {
    ...
    'with': ['Aussi contagieuses que le virus ?', 'contagieux (et potentiellement dangereux) que le SARS-CoV-2.', 'popularité du sujet a explosé suite à ce'],  
    'without': ['L’essentiel santé', 'A découvrir sur Challenges', 'En images'],  
    'comments': [],  
    'license': '',  
    'region': 'FR',  
},
'https://www.siegfried-marcus-berufsschule.at/kraftfahrzeugtechnik/lehrberufe-kft-2/': {
    ...
    'tags': [],
    'with': ['Lehrstoffinhalte', '3. Klasse', 'Module'],  
    'without': ['Direktor: OSR Dipl.-Päd. Markus Fuchs', 'Verein der Freunde für berufsbegleitende Aus- und ', 'Obmann: OSR Markus Fuchs'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://www.minusl.de/produkt_kategorien/joghurt/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['wohl, denn MinusL bringt Genuss in mein Leben.', 'generell die Zutatenliste einer Verpackung beachten. Allergene Zutaten ', 'Sie lieben Joghurt mit frischen Früchten un'],  
    'without': ['Senden', 'ZURÜCK', 'MinusL Athentikos'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://sass-ag.de': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Wir beraten herstellerunabhängig und planen immer objektiv', 'Kaufen Sie bei uns preiswerte Etiketten in Ihrem', 'Wir bieten professionelle Drucksysteme für alle Anwendungsbereiche; ganz'],  
    'without': ['Produkte & Leistungen', 'Zentrale Gilching', 'Störungen:'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://web.archive.org/web/20130217080612/http://tv-orange.de/2012/08/future-of-hope-island-befreit-sich-von-den-bankstern-der-film/': {
    ...
    'with': ['Dieser Film wird bislang von den Kontinental-Europäischen Medien', 'Ein Beispiel von Selbstzensur, symptomatisch für die Haltung gefälliger', 'Außerdem verbreitet sich über Facebook die Information über'],  
    'without': ['Hiesige Medien schwören die Bevölkerung auf Gedeih', 'In den von den Banken verursachten Immobilienblasen und unsauberen', 'Wir haben Gutwettermacher, Medienmacher, Meinungsmacher, Schlechtwettermacher, Schuhmacher'],  
    'comments': ['Zum Trailer des Filmes geht es hier'],  
    'license': 'DE',  
    'region': '',  
},
'https://web.archive.org/web/20120216182711/http://www.stol.it/Artikel/Politik-im-Ueberblick/Politik/Verfassungsgericht-Berlusconis-Sex-Prozess-geht-weiter': {
    ...
    'categories': ['Politik'],
    'tags': [],
    'with': ['Das Verfassungsgericht in Rom verwarf am Dienstag einen Antrag', 'Das Argument hatten die Mailänder Staatsanwälte „lächerlich“ genannt.', 'Das laufende Verfahren gegen den im November als'],  
    'without': ['IT 00853870210', 'Hier können Sie den Artikel bewerten', 'On-Tour Fotos'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://blog.leichtathletik-ostalbkreis.de/2007/05/20/ergebnisse-rm-schuelerinnen-a-aalen-unterkochen-1952007/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['1. und Regionalmeister 2007', 'Schlumberger, Lea 1993;', 'LG Staufen'],  
    'without': ['LA-Kreis Ulm/Alb-Donau', 'LA-Kreis Göppingen', 'LAC Essingen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://next2games.de/previews,id1085,0,anno_1800_beta.html': {
    ...
    'categories': [],
    'tags': [],
    'with': ['zu entdecken, was Anno 1800 noch in petto hält.', 'Neben dem Startgebiet in einer klimatisch eher gemäßigten', 'Wie in jedem Titel der mittlerweile über 20 Jahre'],  
    'without': ['n2g media network', 'CMS: Apexx by Stylemotion', 'Diese Website nutzt Cookies'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'http://www.exlibris-deg.de/2019/10/24/balsamo-stella-guido/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['M. Akt mit Axt einen Baum fällend; Rem', 'Adler nach Klippe, nach links blickend, Schooner im', 'Exlibrissammlung PALMIRANI, Remo: Guido Balsamo Stella'],  
    'without': ['Winkler, Eduard', 'Rechtliches', 'German'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://foren.myoos.de/viewtopic.php?f=4&t=167&sid=58428beaa14598c2e02d93ad5c773e4d': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Freie Software ist Software, die ohne Ansicht der Person', 'http://www.gnu.org/philosophy/free-sw.de.html', 'Software (OSS) ein und entwickeln einen Praxisleitfaden.'],  
    'without': ['Forum Software', 'Alle Zeiten sind UTC+02:00', 'Mitglieder in diesem Forum:'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'http://www.mueritzurlauber.de/blockhaus-typ-3/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Das helle und liebevoll eingerichtete Blockhaus 1 hat', 'Buchung ab 3 Nächte oder nach Absprache.', 'über die freien Termine oder nehmen einfach Kontakt zu uns auf.'],  
    'without': ['info@mueritzurlauber.de', '039931 51438', 'Datenschutzerklärung'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'http://harddecor.at/work/denkmaler-neuem-licht/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['CONDITIONING. of Atmospheres in Architecture', 'Denkmalpflegerinnen, Politikerinnen und der interessierten Öffentlichkeit fördern.', 'Thema Planen und Bauen in historisch wertvoller Umgebung'],  
    'without': ['Best of 2016.', 'Gegen Leerstand und Wertminderung.', 'Mission Statement'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://web.archive.org/web/20130307194448/the-pain.net/2008/05/silkroad-roc-mountain-quests-und-npcs.html': {
    ...
    'with': ['Ich wurde von vielen Leuten darum gebeten zum neuen', 'man kann ja nicht alles wissen', 'Bringe eine Nachricht über den vermissten Sohn zu'],  
    'without': ['Silkroad Online und alle damit in Verbindung stehenden Logos', '2007 - 2013', 'Alle anderen Warenzeichen oder'],  
    'comments': ['Servus ich wollte dich bitten ob ich diesen', 'gegeben, aber bei der vorraussetzung von Rahid', 'joymax, weil es nicht deine sachen sind !'],  
    'license': 'CC BY-SA 3.0 DE',  
    'region': '',  
},
'https://mywakenews.wordpress.com/2016/07/09/nwo-psyop-unitedwestrike-radio-marathon/': {
    ...
    'with': ['diesen Bastarden diese Worte einvernehmlicher Verkehr in den Mund???', 'Kritische Betrachter haben bereits sehr viele Indizien zusammengetragen', 'und unsere Wahrnehmung gefangen gehalten, manipuliert und gesteuert'],  
    'without': ['For all who want to wake up!', 'Erstelle eine kostenlose Website oder Blog – auf WordPress.com', 'Meine persönlichen Informationen nicht verkaufen'],  
    'comments': ['Hat dies auf meinfreundhawey.com rebloggt.'],  
    'license': '',  
    'region': 'DE',  
},
'https://uniqz.de/produkte/katzendecke-zweilagig-mit-namen-und-main-coon/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Lieferzeit: 15 - 21 Tag(e)', 'Hochwertige Hunde- oder Katzendecke in besonders kuscheliger', 'Main Coon-Stickerei'],  
    'without': ['Das Kleingedruckte', 'Informationen', 'Copyright / Rechte'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.oekonomenstimme.org/artikel/2015/01/eine-realistische-interpretation-des-keynes-hicks-multiplikators/': {
    ...
    'with': ['In seinem Beitrag von 5. Januar 2015 erörtert Wolfgang', 'Wirtschaftsdienst, 92. Jahrgang, Heft 10, Oktober 2012', 'Erfasst werden. Dabei steht T für den technologischen Fortschritt'],  
    'without': ['Die paradigmatische Struktur der Makroökonomik', 'um Kommentare zu schreiben', 'Faktor Arbeit im Sinkflug'],  
    'comments': ['Sie fliesst nur in die Taschen der Haushalte, die damit nichts anzufangen wissen.', 'bitte darum, die anderen Themen woanders, beispielsweise in einem eigenen', 'Multiplikators – aber der Theorie, die sich darum herumrankt, aufzudecken. '],  
    'license': '',  
    'region': '',  
},
'https://leukefeld-handball.de/dago-leukefeld-wird-botschafter-des-sports-der-ifzw-impulsstiftung/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Die ifzw impulsstiftung und Dago Leukefeld besiegeln ihre gute', 'mit Ihm und auf spannende Projekte im Vereinssport“, so Mechthild Aßmann.', 'in die beteiligten Vereine beigetreten sind. Für uns ein tolles Ergebnis.'],  
    'without': ['© 2017 Dago Leukefeld Handball', 'Lieferzeit: 9-12 Tage', 'Hier geht es zu den'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.propellets.at/soziale-energie': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Besonders für Haushalte mit geringem Einkommen stellen steigende', 'Ziel der vorliegenden Studie war es, zu klären ob', 'hohen Anfangsinvestition von rund 2700 € schwer erschwinglich.'],  
    'without': ['Newsletter', 'teilen', 'Alles über den Verein'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://chabermu.wordpress.com/2015/09/02/windows-expertenwissen-per-update-spioniert-microsoft-nun-auch-windows-7-8-und-8-1-aus-microsoft-privacy-windows10-chabermu/': {
    ...
    'title': '[Windows Expertenwissen] Per Update spioniert Microsoft nun auch Windows 7, 8 und 8.1 aus // 
    'date': '2015-09-02',
    ...
    'with': ['Nun hat es der Softwarekonzern auch auf die Nutzerdaten', 'Klicken Sie die betroffenen, optionalen Windows-Updates', 'Wann jedoch Microsoft diese Abhilfe gegen seine Abhör-Updates blockiert'],  
    'without': ['© since 2010', 'News vom Computerarchiv München', 'Gib deine E-Mail-Adresse ein'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://web.archive.org/web/20110106023242/http://dzs-clan.de/index.php?site=news_comments&newsID=111': {
    ...
    'categories': [],
    'tags': [],
    'with': ['In dieser News möchten wir euch über das Geschehen', 'Diese Nachrichten könnt ihr auch auf unserer Homepage in unserer Twitter-Box lesen.', 'Aller Voraussicht nach wird dieses auf der kommenden'],  
    'without': ['Hi, ihr habt das falsche Statment von mir', 'sein um Kommentare zu schreiben!', '© 2010 by dzs'],  
    'comments': ['ich werde wohl auch auf die Mega Lan kommen'],  
    'license': '',  
    'region': 'DE',  
},
'http://sibenlab.blogspot.com/2018/06/sibenlab-privacy-policy.html': {
    ...
    'categories': [],
    'tags': [],
    'with': ['This privacy policy has been compiled to', 'If at any time you would like to', 'visiting the Google Ad and Content Network privacy'],  
    'without': ['Thème Simple. Fourni par', 'Inscription à', 'Publier un commentaire'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://hellogiggles.com/beauty/dead-skin-cells-build-up/': {
    ...
    'categories': ['Beauty'],
    'tags': [],
    'with': ['Admit it: Ever since the first rough, grainy glob', 'exfoliating acids, you kind of owe them an apology.', 'Desquamation can only take place when the skin is functioning'],  
    'without': ['adhere to in the morning and at night.', 'two makeup artists to get their top tips on how to extend', 'spots caused by melasma, sun damage, or pigmentation'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://link.springer.com/article/10.1007/s11926-017-0626-z': {
    ...
    'with': ['The purpose of the review is to summarise', 'The most commonly reported drugs are allopurinol', 'Kirchhof MG, Wong A, Dutz JP. Cyclosporine treatment'],  
    'without': ['Immediate online access to all issues from 2019.', '© 2020 Springer Nature Switzerland AG', 'Instant access to the full article PDF.'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.royalroad.com/fiction/34798/melas/chapter/535107/chapter-1-prologue-murdered': {
    ...
    'categories': [],
    'tags': [],
    'with': ['When I woke up, there was nothing.', 'If it was limited to my birth, I', 'Make me the most powerful spellcaster, or whatever'],  
    'without': ['Royal Road® is the home of web novels', 'Royal Road® © 2013-2020, background by', 'advertising fees by advertising and linking to amazon.com.'],  
    'comments': ['Nice chapter! I had Melas in my PTR list', ' the entity is an incompetent with a quick trucker finger.', 'Her mother is wearing a purple pointed hat, something'],  
    'license': '',  
    'region': '',  
},
'https://harpers.org/a-letter-on-justice-and-open-debate/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Our cultural institutions are facing a moment of trial', 'expect the public or the state to defend it for us.', 'The free exchange of information and ideas, the'],  
    'without': ['Do Not Sell My Personal Information', 'Privacy Policy ', 'Customer Care'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://nymag.com/intelligencer/2020/05/polarization-republicans-democracy-ezra-klein-book-review.html': {
    ...
    'with': ['Which is to say, why was a solipsistic reality', 'of its contradictions. As African-Americans migrated North in', 'truth that our own identities are preventing'],  
    'without': ['This site is protected by reCAPTCHA and the Googl', 'Daily news about the politics, business, and technolog', '© 2020 Vox Media, LLC. All rights reserved.'],  
    'comments': ['I wrote Klein off as intolerably naive a', 'bombers of the grand old pedophile criminal gang.', 'Trump supporters believe Trump when he says'],  
    'license': '',  
    'region': '',  
},
'http://www.netbits.us/docs/stunnel_rsync.html': {
    ...
    'categories': [],
    'tags': [],
    'with': ['documentation examples rely heavily on tcp-wrappers and Stunnel', 'cd to the directory containing the tarball', 'cert = /etc/stunnel/langly_stunnel_cert.pem'],  
...
'https://emacspeak.blogspot.com/2019/10/meta-programming-in-emacs-using.html': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Decorators in Python enable you to modify', 'entitled Beautiful Code, OReilly.', 'Speak line moved to after next-line and'],  
    'without': ['Followers (7) ', 'View my complete profile', 'Simple theme. Powered by'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.politico.com/news/2019/12/30/mark-meadows-retirement-elect-wife-friend-090838': {
    ...
    'categories': [],
    'tags': [],
    'with': ['shock retirement — revealed just 30 hours before the', 'though he faces another stiff primary challenge next year.', '“I don’t expect anyone to hand me anything.'],  
    'without': ['Credit Card Payments', 'Notice to California Residents', 'Terms of Service'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://security.googleblog.com/2020/05/enhanced-safe-browsing-protection-now.html': {
    ...
    'with': ['ve seen threats on the web becoming increasingly sophisticated', 'This protocol is designed so that Google cannot', 'billions of users are incredibly diverse, with'],  
    'without': ['Give us feedback in our', 'Google Privacy Terms ', 'insights from Google on security and safety on the Internet'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.wevolver.com/article/2020.autonomous.vehicle.technology.report': {
    ...
    'with': ['Following the Autonomous Vehicle Hype.', 'At the same time, technology developers have', 'most important market, and the company supplies'],  
    'without': ['By combining two types of computers, this system could speed up', 'Moose UGV an handle tough environments', 'EngineeringClicks.com is the No. 1 mechanical design'],  
    'comments': ['Thanks to all the contributors, for the comprehensive', 'With reference to FLIR dataset, the concept ', 'Keep me posted on your progress!'],  
    'license': '',  
    'region': '',  
},
'https://www3.nhk.or.jp/news/easy/k10011959621000/k10011959621000.html': {
    ...
    'categories': [],
    'tags': [],
    'with': ['子どもへの虐待をなくすための法律ができて、親が子どもを教育するために、', '法律では虐待をした親に専門家が子どもの育て方を', '虐待したときに叱っていただけだと言う親がいます。新しい法律では'],  
    'without': ['※下に線があることばは辞書の説明を見ることができます。 ', 'く転載することを禁じます。このページは受信料で制作しています。', 'Copyright NHK (Japan Broadcasting Corporation).'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.unocero.com/smartphones/marcas-mala-gestion-apps-segundo-plano-android/': {
    ...
    'tags': [],
    'with': ['pues al hacer esto se gastaba mucha', 'El problema es que a pesar de que', 'convierten en una desventaja para la experiencia de uso.'],  
    'without': ['y te enviaremos un correo diario con lo', 'Derechos Reservados. unocero es una', 'Modo Nocturno'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://thepointsguy.com/news/alaska-airlines-oneworld-membership-new-date/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['has a new date for when it will be a full fledged member of the Oneworld', 'at its Seattle/Tacoma International Airport (SEA) base in 2019.', 'hat it launched in 2020, according to Cirium'],  
    'without': ['This post contains references to products from one or more', 'Bonus value is an estimated value calculated by', 'responsibility to ensure all posts and/or questions are answered.'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.medicalnewstoday.com/articles/318674': {
    ...
    'with': ['Many of us have noticed that we seem to get our', 'But the exact moment at which information becomes', ' that the brain goes through to complete a'],  
    'without': ['myths, and reveal tips for improving brain functioning.', 'to such placement, do not provide the information.', '© 2004-2020 Healthline Media UK Ltd, Brighton'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.mdavis.xyz/supermarket/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['The cameras recognise me as soon as I', 'afternoon snack on way home from work', ' FoodCorp to feed ourselves, FoodCorp feeds on us'],  
    'without': ['11 Jan 2019', 'Photo by ev on Unsplash', 'find more by Matthew Davis'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://medium.com/@pimterry/host-your-node-app-on-dokku-digitalocean-1cb97e3ab041': {
    ...
    'with': ['are a superbly cheap and remarkably frictionless platform to run', 'Node project, started, and have the given port exposed.', 'You start Dokku, tell it what services you need'],  
    'without': ['Creator of HTTP Toolkit', '3 min read', 'Nodejs'],  
    'comments': ['what workflow do you recommend for local development when'],  
    'license': '',  
    'region': '',  
},
'https://www.economist.com/open-future/2018/06/18/why-collaborative-thinking-beats-individual-smarts': {
    ...
    'tags': [],
    'with': ['about the role that the proportion of men and women in', 'You might call this a measure of a person', 'Can groups be intelligent in the same way individuals'],  
    'without': ['Sign up to our free daily newsletter', 'Published since September 1843 to take part in', 'Jun 18th 2018'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://diem25.org/the-eus-green-deal-isnt-enough-save-from-climate-catastrophe/': {
    ...
    'with': ['Due to the rise of movements dedicated to addressing', 'The Green New Deal for Europe is the most', 'To answer this question, the starting point should'],  
    'without': ['Democracy in Europe Movement 2025', 'Do you want to be informed of DiEM25', 'empower workers on an unprecedented scale.'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.theatlantic.com/ideas/archive/2020/08/californias-disasters-are-a-warning-climate-change-is-here/615610/': {
    ...
    'categories': ['Ideas'],
    'tags': [],
    'with': ['When I moved to California five years ago', 'Yet some people refuse to acknowledge that climate change', 'happening in California has a name: climate change'],  
    'without': ['We want to hear what you think about this article.', 'Some were blasted by critics, some flopped at the', 'Subscribe and support 162 years of independent journalism'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.bettycrocker.com/recipes/easy-pineapple-upside-down-cake/c4d3321d-fad9-41cb-8f29-8d91a4279b07': {
    ...
    'categories': ['recipes'],
    'tags': [],
    'with': ['pineapple slices in juice, drained, juice reserved', 'Serve with sweetened whipped cream or an 8-oz', 'warm or cool. Store covered in refrigerator.'],  
    'without': ['© 2020 ®/TM General Mills All Rights Reserved', 'Get kitchen tested recipes, meal ideas and more – straight to your inbox', 'Most Recent Collections'],  
    'comments': ['My son loved it. Super easy and came out perfect.', 'Where can I find a cake recipe from scratch that works', 'Easy directions. my family is so excited that'],  
    'license': '',  
    'region': '',  
},
'https://cybercook.com.br/receitas/doces/biscoitos-doces/receita-de-sequilho-com-chocolate-amargo-124300': {
    ...
    'tags': [],
    'with': ['Todos os ingredientes', 'Composição nutricional da receita', 'Deixe secar em uma folha de papel'],  
    'without': ['Geladinho de Leite em Pó e', 'Siga o CyberCook', 'Conheça os iogurtes proteicos e inclua-os na sua alimentação!'],  
    'comments': [],  
    'license': '',  
    'region': 'BR',  
},
'https://eatsmarter.de/rezepte/vanille-hafer-porridge-mit-leinsamen-und-apfel': {
    ...
    'with': ['Haferdrink mit Haferflocken, Vanille und Zimt, Leinsamen', 'Nüsse trocken in einer Pfanne anrösten. Äpfel waschen', 'Hafer ist reich an Ballaststoffen und Calcium. Insbesondere der Quellstoff'],  
    'without': ['und Beauty. Erfahren Sie hier alles über die Kooperation.', 'Eine runde Sache also, wie Sie in dieser Warenkunde erfahren! ', 'Diätrezepte unter 400 Kcal'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://eatwhattonight.com/2020/09/vegan-styled-char-kway-teow-stir-fry-flat-rice-noodles/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Once in a while, I liked to go vegan', 'With 2 tbsp oil left in the wok', '120g kway teow (flat rice noodles)⁣'],  
    'without': ['I am Joyce from Sunny Singapore', 'Enter your keywords', 'Print Recipe'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://uk.trustpilot.com/reviews/581cf1892ae760087cadbf17': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Gousto has changed my life', 'What a fantastic idea!'],  
    'without': ['4 Nov 2016', 'Useful', 'reviews'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.hassanchef.com/2020/09/bhindi-masala-okra-stir-fry.html': {
    ...
    'categories': [],
    'tags': ['Veg recipes'],
    'with': ['Tandoori roti, Naan and paratha are also served with this masala.', 'You can many popular dishes with bhindi like', 'My wife only use red chilli powder'],  
    'without': ['Copyright © Hassanchef 2020', 'Post a Comment', 'You might like'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.kochbar.de/tipp/1918/Tomaten-richtig-schneiden.html': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Ihr kennt es sicher auch!', 'aber ohne Strunk sieht es auch schöner aus.', 'haften am Fruchtfleisch und und können nicht'],  
    'without': ['Tipp favorisieren', 'Um den Tipp "Tomaten richtig schneiden" kommentieren', 'Die besten TIPPS'],  
    'comments': ['da ich meine Tomaten zum Anrichten schon lange', 'Dankeschön emari ♥ Sehr gerne...und ja'],  
    'license': '',  
    'region': 'DE',  
},
'https://www.mindmegette.hu/levagott-ujj-vajas-kekszek-halloweenra-59841/': {
    ...
    'with': ['Szeretem, hogy a közelgő téli hónapokat', 'Ezen az éjszakán nagy bulikat szerveznek, ahol', 'azonnal, vagy tároljuk őket jól záródó dobozban'],  
    'without': ['Ezek is érdekelhetnek', 'Receptek karfiollal', 'Friss receptjeink'],  
    'comments': [],  
    'license': '',  
    'region': 'HU',  
},
'https://apply.workable.com/gousto/j/8F4D8D5904/': {
    ...
    'date': '',
    'description': 'Gousto are on a mission to become the UK&
    'categories': [],
    'tags': [],
    'with': ['Gousto are on a mission to become the UK', 'Liaise with External Agencies as required.', 'consistently go the extra mile to apply and'],  
    'without': ['This site is protected by reCAPTCHA and the Google', 'Gousto collects and processes personal data in accordance with', 'Spalding, England, United Kingdom'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.tine.no/presserom/nyhetsarkiv/nff-tine-fotballskole-viktig-for-barneidretten-gjennom-pandemien': {
    ...
    'categories': [],
    'tags': [],
    'with': ['En annerledes sesong med TINE Fotballskole nærmer seg', 'TINE Fotballskole er en fantastisk og veldig', 'TINE være med å bidra, avslutter Syversen.'],  
    'without': ['113 Kalbakken, 0902 Oslo', 'dine og tar i mot kommentarer og forslag.', '7. oktober 2020'],  
    'comments': [],  
    'license': '',  
    'region': 'NO',  
},
'https://www.vegolosi.it/news/climate-clock/': {
    ...
    'date': '2020-09-30',
    'description': 'A New York il Metronome si trasforma in un gigantesco orologio che fa il countdown dell&
    'categories': [],
    'tags': [],
    'with': ['Ce lo ripetono continuamente gli esperti che', 'Ma se la nostra specie vuole sopravvivere', 'A New York il Metronome si trasforma in un'],  
    'without': ['Per saperne di più', 'Guide di base', 'Frutta e verdura di stagione'],  
    'comments': [],  
    'license': '',  
    'region': 'IT',  
},
'https://web.archive.org/web/20200808063632/https://www.przepisy.pl/przepis/pierogi-z-dynia-w-sosie-szalwiowym': {
    ...
    'with': ['ugotowane pierogi, chwilę wymieszaj i natychmiast podawaj.', 'Przyprawa w Mini kostkach Smażona cebula', 'Przygotowanie krok po kroku'],  
    'without': ['Słodkie i soczyste owoce, które mogą być', 'się do niego warzywa, sery, mięso, zioła. Skorzystaj z', 'To naprawdę pyszne danie – przekonaj się?'],  
    'comments': [],  
    'license': '',  
    'region': 'PL',  
},
'https://journals.univie.ac.at/index.php/wdr/about/submissions': {
    ...
    'categories': [],
    'tags': [],
    'with': ['müssen Sie registriert und eingeloggt sein.', 'Soweit möglich, wurden den Literaturangaben', 'Betonungen kursiv', 'Internetquellen', 'wird in Kürze bereitgestellt.'],  
    'without': ['Beitragseinreichung', 'Aktuelle Ausgabe', 'Suchen'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://flawlessfood.co.uk/olive-herb-focaccia-bread/': {
    ...
    'with': ['Oven-baked Italian Olive & Herb Focaccia', 'oil mixture for dipping the focaccia bread into.', 'Carbohydrates: 31g'],  
    'without': ['email address will not be published. Required fields', 'We occasionally get sponsored by products, we', 'We publish new recipes weekly, so keep'],  
    'comments': ['Yum how delicious! Love the special touch of', 'Great to hear Jenny!', 'It is a great bread, hope you get'],  
    'license': '',  
    'region': 'UK',  
},
'https://sportowefakty.wp.pl/zuzel/relacja/110331/fogo-unia-leszno-rm-solar-falubaz-zielona-gora': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Znów lepszy moment startowy miejscowych, lecz', 'W Lesznie zaczął mocno padać deszcz.', 'Stadion im. Alfreda Smoczyka w Lesznie'],  
    'without': ['© 1995-2020 Grupa WP', 'Polskie gwiazdy', 'Zobacz również'],  
    'comments': ['W rundzie zasadniczej zespół z Zielonej Góry zaskoczy', 'pierwszym meczu w tej parze półfinałowe', 'Wylosowano I zestaw startowy.'],  
    'license': '',  
    'region': '',  
},
'https://www.healthline.com/nutrition/ways-to-measure-body-fat': {
    ...
    'tags': [],
    'with': ['It can be frustrating to step on the scale', 'Skinfold measurements have been used to estimate', 'Some methods, such as skinfold measurements, circumference'],  
    'without': ['to improve your health or lose weight, ', '© 2005-2020 Healthline Media a Red Ventures', 'Filter out the noise and nurture your inbox'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.realsimple.com/home-organizing/gardening/outdoor/hydrangea-care': {
    ...
    'with': ['Hydrangeas may be just about everywhere', 'Make sure that the bottom of your container has holes', '1. Choose the Right Pot'],  
    'without': ['choosing your hydrangeas at the store, look for', 'Fall is the time of year when root', 'Sarah Yang'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://thepostpartumparty.com/how-to-set-up-a-baby-nursery-in-a-small-space': {
    ...
    'date': '2019-07-24',
    'description': 'Set up your baby nursery in a small space. With these simple small nursery ideas, you can set up a functional nursery, even if you&
    'categories': [],
    'tags': [],
    'with': ['Pick products that can serve multiple purposes', 'Sometimes space is in the eye of the beholder', 'the idea of where to put everything can'],  
    'without': ['must-haves, and so much more.', 'Notify me of follow-up comments by email.', 'The Postpartum Party does not offer medical advice'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.instyle.com/beauty/wigs-for-black-women-cancer': {
    ...
    'categories': ['Beauty'],
    'tags': [],
    'with': ['decided to ditch her relaxer and transition back', 'to see themselves provides privacy and dignity.', 'All women, regardless of hair type, should'],  
    'without': ['Scroll Down For the Next Article', 'A lot of the royal families had these', 'On the other hand, Black doo-wop girl'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.dailymail.co.uk/news/article-8772683/Chef-Jamie-Oliver-joins-Mail-Sundays-war-toxic-food.html': {
    ...
    'categories': [],
    'tags': [],
    'with': ['A powerful alliance of chefs, celebrities and charities', ' would also help secure the goal set out so', 'Even George Eustice, the current Environment Secretary'],  
    'without': ['As many as a million young people', "The letter also argues that 'the British public", 'As things stand the Government is telling Tory MP'],  
    'comments': ['Cont) Some Chefs in Britain cannot even COOK MEAT PROPERLY', 'vegetarian animals, as in the EU! No BSE in the US!', 'If we want distinctively British standards and regulation'],  
    'license': '',  
    'region': 'UK',  
},
'https://www.independent.co.uk/news/uk/politics/coronavirus-false-reporting-contact-fine-penalty-b671230.html': {
    ...
    'with': ['Anyone falsely naming an antagonist as a coronavirus contact', 'But it is understood that the ban on giving', 'New fines for failure to self-isolate, starting'],  
    'without': ['Code of conduct and complaints', 'Share your thoughts and debate the big issues', 'Popular videos'],  
    'comments': ['Is this fake news?  I cannot', 'Rather than trying to force people to isolate', 'At least we don&amp;
    'license': '',  
    'region': 'UK',  
},
'https://stardewvalleywiki.com/Penny': {
    ...
    'tags': [],
    'with': ['Penny lives with her mom, Pam, in a little trailer by', 'Penny is a villager who lives in Pelican Town', 'A fermented beverage made from honey.'],  
    'without': ['Content is available under', 'Privacy policy', 'Admin noticeboard'],  
    'comments': [],  
    'license': 'CC BY-NC-SA 3.0',  
    'region': '',  
},
'https://statisticsglobe.com/change-font-size-of-ggplot2-plot-in-r-axis-text-main-title-legend': {
    ...
    'categories': [],
    'tags': [],
    'with': ['explain how to increase and decrease the text', 'y = Probability', 'If you have any further questions, please'],  
    'without': ['Get regular updates on the latest tutorials', 'On this website, I provide statistics tutorials', 'Related Tutorials'],  
    'comments': ['I posted on your youtube channel a question', 'Very helpful.'],  
    'license': '',  
    'region': '',  
},
'https://www.tomshardware.com/uk/news/where-and-how-to-buy-rtx-3080-3090-3070': {
    ...
    'categories': [],
    'tags': [],
    'with': ['RTX 3000 series graphics cards are finally', 'also some aftermarket RTX 3080 cards up on', 'RTX 3080 and RTX 3090 cards are'],  
    'without': ['No spam, we promise.', 'More about...', 'When you purchase through links on our site'],  
    'comments': ['How to buy: be a bot, otherwise, you', 'As predicted by many reviewers and journalists', 'As predicted by many reviewers and journalists'],  
    'license': '',  
    'region': '',  
},
'https://www.corkbeo.ie/news/local-news/level-3-live-cork-ireland-19056312': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Tonight at midnight Cork will be moved into Level 3', 'So we thought that this is not the', 'Taoiseach Micheal Martin confirmed this evening that'],  
    'without': ['Never miss the latest news by signing', 'Corrections and Clarifications', 'The latest update for the Irish abroad'],  
    'comments': [],  
    'license': '',  
    'region': 'IE',  
},
'https://www.nationalrail.co.uk/service_disruptions/245738.aspx': {
    ...
    'date': '',
    'description': 'The gateway to Britain&
    'categories': [],
    'tags': ['Coronavirus', 'Facebook', 'Twitter', 'Museums'],
    'with': ['Customers with disabilities will be asked about the best', 'only on longer journeys over 60 minutes', 'LNER are able to carry foldable wheelchairs as'],  
    'without': ['About this site', 'Rail Replacement', 'You are here'],  
    'comments': [],  
    'license': '',  
    'region': 'UK',  
},
'https://www.chocolate.com/view/woman-sees-a-car-stop-for-pregnant-beggar-this-is-what-she-finds-when-she-follows/&page=2': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Could it be true? Was she trying', 'working to catch those who run operations', 'she was lucky enough to receive a'],  
    'without': ['CHOCOLATE.COM2020', 'Terms Of Service', 'DMCA'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.thelist.com/214894/when-you-take-a-multivitamin-every-day-this-is-what-happens-to-your-body/': {
    ...
    'date': '2020-06-12',
    'description': 'Do you take a multivitamin every day? It certainly seems like a rational way to give yourself an extra boost, whether it&
    'categories': [],
    'tags': [],
    'with': ['Do you take a multivitamin every day?', 'sleeping for seven to nine hours a night', 'help steel yourself against any nutritional fallout.'],  
    'without': ['If you take turmeric every day, you might', 'retro-hipster chic (so 2010!) to your bathroom.', 'everyone has different nutritional needs, and she'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.sports.fr/direct-foot/50918/177512/lorient-olympique-lyonnais.html': {
    ...
    'categories': [],
    'tags': [],
    'with': ['terminé au Moustoir ! Lorient a tenu', 'Le coup de pied de coin ne donne rien.', 'se cherchent en ce début de match.'],  
    'without': ['Ligue des Champions de la CAF', 'Europa League', 'Tous les sports'],  
    'comments': [],  
    'license': '',  
    'region': 'FR',  
},
'https://pawszilla.com/pop-culture/celebrities/fans-expressed-fears-celine-dions-appearance-savagely-responded/21/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Even though Céline Dion is a multi-million-selling', 'So this led to the star coming clean to her critics in spectacular fashion.', 'Her most iconic looks of the 1990s'],  
    'without': ['Getty Images', 'Staff Writer', 'Battery Media Group'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.foxyfolksy.com/chocolate-buttercream-frosting-without-powdered-sugar-ermine-icing/': {
    ...
    'date': '2018-01-28',
    'description': 'Try this Chocolate Buttercream Frosting. No powdered sugar needed. It is so light and fluffy and smoother than the classic American Buttercream Frosting. It is a bit more work but definitely easier than Swiss Meringue Frosting. It is easily the best buttercream frosting I&
    'categories': ['Cake Recipes'],
    'tags': [],
    'with': ['Try this Chocolate Buttercream Frosting. No powdered sugar', 'Combine and sift together the flour, sugar, salt', 'work but definitely easier than Swiss Meringue Frosting'],  
    'without': ['Send me email every new post.', 'Receive new posts directly delivered to your inbox', 'miss a post. Get updates directly to your inbox '],  
    'comments': ['not as sweet as the American version', 'Amazing! Just sweet enough, silky smooth texture', 'Hi Fiona, glad this recipe was able'],  
    'license': '',  
    'region': '',  
},
'https://mydailymagazine.com/get-in-the-spooky-spirit-with-these-halloween-workouts/': {
    ...
    'with': ['Believe it or not, Halloween is just days', 'Kelsey Ellis, is perfect for you. The workout', '12 reps of each exercise with one to'],  
    'without': ['Terms & Conditions', 'Find Beauty in Imperfection with Public Holiday', 'Hot Buttered Rum Cocktail All Season Long'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://youhadmeatgardening.com/lemon-tree-from-seed': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Now you know how to grow lemon trees', 'for planting lemon seeds has a pH between', 'Place the seeds about one inch apart on a paper'],  
    'without': ['Your email address will not be published', 'We can help you grow the indoor', 'apartment gardening. Learn how to stop killing'],  
    'comments': ['I have grown a lemon tree from seed', 'Hello Tarina! Thank you for contacting us', 'inches tall but they are doing well'],  
    'license': '',  
    'region': '',  
},
'https://www.standard.co.uk/news/uk/turkey-poland-caribbean-islands-added-to-uk-quarantine-list-a4561256.html': {
    ...
    'with': ['Penalties for those who refuse to self-isolate are', 'Travellers arriving in the UK from those places after', 'to defend what the Government is doing'],  
    'without': ['There are no comments yet', 'This is London Magazine', 'Be part of the conversation'],  
    'comments': [],  
    'license': '',  
    'region': 'UK',  
},
'https://ext.theperspective.com/items-we-never-knew-we-wanted/1/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['dawn of the internet brought about a lot', 'to turn any laundry day into a blast', 'This item is perfect for those of'],  
    'without': ['All Rights Reserved', 'The Perspective Challenge', 'DMCA'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.popsugar.co.uk/smart-living/Cheap-Homemade-Halloween-Costumes-42432483/amp': {
    ...
    'with': ['thanks to these genius ideas. This year', 'With a bowler hat, a set of false lashes', 'Long hair or not, you can still pull'],  
    'without': ['Send You Push Notifications.', 'POPSUGAR Would Like To ', 'Want More?'],  
    'comments': [],  
    'license': '',  
    'region': 'UK',  
},
'https://harrypotter.fandom.com/wiki/Water-Making_Spell': {
    ...
    'date': '',
    'description': 'The Water-Making Spell2 (Aguamenti) was a charm that conjured a jet of clean, drinkable water from the tip of the caster&
    ...
    'tags': [],
    'with': ['"The Water-Making Spell conjures clean, drinkable water from', 'A jet of water flew out of the umbrella tip', 'Hermione used this charm to extinguish his burning eyebrows'],  
    'without': ['Take your favorite fandoms with you and never miss a beat.', 'What is your opinion on people becoming obsessed with Draco?', 'Harry Potter Wiki is a FANDOM Movies Community.'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.msn.com/en-gb/news/uknews/uk-university-student-halls-too-full-to-be-safe-experts-warn/ar-BB19DUqK': {
    ...
    'categories': [],
    'tags': [],
    'with': ['s increasing numbers of UK universities wrestle with', 'seven days. In Northern Ireland, call your GP.', 'Some UK universities, including Cambridge, Imperial College London'],  
    'without': ['powered by Microsoft News', 'Sign in', 'Commenting is not currently available, but don’t worry'],  
    'comments': [],  
    'license': '',  
    'region': 'UK',  
},
...
'https://villagersandheroes.com/forums/threads/patchnotes-4-47-4-tagundnachtgleiche-bugfix-build.3976/': {
    ...
    'categories': [],
    'tags': [],
    'with': ['Die Farbe der Spawn-Ankündigungen wurde geändert auf orange', 'erhöhen, zum Schaden aber nur begrenzt beitragen, entsteht.', 'Was jeder von Euch daraus nun für Konsequenzen zieht in Eventzonen'],  
    'without': ['Forum software by XenForo® © 2010-2019 XenForo Ltd.', ' Terms and rules', ' Privacy policy'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://plantcaretoday.com/how-to-grow-and-care-for-bougainvillea.html': {
    ...
    'categories': ['Vines'],
    'tags': [],
    'with': ['I need some help with Bougainvillea care and watering', 'In the United States, the peak blooms are typically', 'Hardiest species, with somewhat furry foliage and red-purple'],  
    'without': ['Plantcaretoday.com is a participant in the Amazon Services', 'Plant Care Newsletter', 'Tips On Getting Rid Of Caterpillars On Roses'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://anarc.at/blog/2020-10-18-cdpath-replacement/': {
    ...
    'with': [' I figured I might as well bite the', 'Those projects can be used to track files', 'this list through a command or the menu'],  
    'without': ['Contact', 'Copyleft © 2002-2016 The Anarcat', ' Powered by'],  
    'comments': [],  
    'license': 'CC-BY-SA',  
    'region': 'AT',  
},
'https://economictimes.indiatimes.com/tech/hardware/the-iphone-se-is-in-india-heres-all-we-know/not-a-flagship/slideshow/76280131.cms': {
    ...
    'categories': [],
    'tags': [],
    'with': ['The latest iPhone from Apple is not what', 'All of this - coupled with better cameras - comes', 'But, the iPhone SE fits in so much more'],  
    'without': ['Apple has just updated the 13-inch MacBook Pro', 'for a smoother typing experience, according to Apple.', 'production and sales but new models are still being '],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'http://www.jobsnhire.com/articles/35030/20160214/need-know-cvs-health.htm': {
    ...
    'with': ['is all about helping people who are treading', 'CVS Health also helps those diagnosed with complex', '17.6 percent to $2.7 billion. It seems CVS Health is really'],  
    'without': ['Get the Most Popular Jobs&Hire Stories in a Weekly Newsletter', ' acceptance of our Terms and Conditions of Use and Privacy Policy. ', 't Career Options, Job Titles and Descriptions'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://football.ua/germany/311510-podolski-zavershil-kareru-v-sbornojj.html': {
    ...
    'categories': [],
    'tags': [],
    'with': ['летний Лукаш Подольски – третий по количеству матчей за сборную', 'Экс-игрок Арсенала и Баварии попал в заявку', 'Решение далось мне очень тяжело. Сборная всегда была'],  
    'without': ['© 2006-2019 ООО "ВИДАВНИЦТВО УКРАЇНСЬКИЙ МЕДІА ДІМ". Все права защищены.', 'Политика в сфере конфиденциальности и персональных данных', 'Германия. Новости'],  
    'comments': ['Польди этот тот человек,который в сборной играл лучше чем в клубах ', '"Я прошел путь от двухлетнего поляка до чемпиона мира в этой футболке', 'Ждал пока Тимощук со сборной уйдет)'],  
    'license': '',  
    'region': 'UA',  
},
...
'https://web.archive.org/web/20120611024252/http://www.he.xinhuanet.com/news/2012-06/04/content_25340717.htm': {
    ...
    'categories': [],
    'tags': [],
    'with': ['一个约定，信守15年，感人至深；一段真情，延续15年', '秦皇岛、承德、张家口等10个设区市演出(此前已在保定市演出多场)，引起强烈反响。', '如今，向河北农大果树93(01)班毕业生群体学习的热潮正在全省各地深入开展。廊坊以巡演为'],  
    'without': ['copyright (c) 2000', 'ICP证010042号', '河北探索农村劳动力就地就近转移培训'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
    ...
    'date': '2020-11-03',
    'description': 'Encourage your kids to get punny with these kid-approved quips that require little to no explanation from parents. Whether it&
    'categories': [],
    'tags': [],
    'with': ['37. What did one volcano say to the other?', ' You look for fresh prints.', 'Kids are natural comedians so why not encourage'],  
    'without': ['more stories you may have missed', 'COMPANY INFO', 'AS SEEN IN'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
    ...
    'categories': [],
    'tags': [],
    'with': ['It\'s no secret', '2FA and its impact on mitigating the risk of financial breaches.', '2FA Impact on Data Breaches'],  
    'without': ['To view or add a comment', '1,192 followers', 'Share'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
    ...
    'categories': [],
    'tags': [],
    'with': ['You are able to customise and adjust the settings', 'Your Default Game Lanaguage', 'By setting this to Default, attributes are', 'CPU GAMEPLAY CUSTOMISATION'],  
...
'https://www.duengebehoerde-niedersachsen.de/duengebehoerde/news/38853_Sperrfristende_01._Februar_-_Rechtliche_Hinweise_zur_N-D%C3%BCngung': {
    ...
    'date': '',
    'with': ['und damit auch mit Wirtschaftsdünger', '. Die Regelung gilt für Grünland und', 'Aufgrund EU-Vorgaben wurde die Auslegung'],  
    'without': ['überschwemmte Böden: Düngung verboten', 'Mehr zum Thema', 'Frost: Der Boden muss am Tag des Aufbringens völlig'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.careelite.de/flaechenverbrauch-fuer-fleisch/': {
    ...
    'date': '2022-01-21',
    'with': ['Du willst mehr über den Flächenverbrauch für Fleisch,', 'dessen Entwicklung vermitteln:', 'Eine bemerkenswerte Statistik macht besonders'],  
    'without': ['Quellenangaben:', 'richtig! Die Aufmerksamkeit', 'NEUESTE BEITRÄGE.'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bund.net/service/presse/pressemitteilungen/detail/news/marode-strassen-und-bruecken-erhalt-statt-neubau-verkehrsminister-wissing-muss-sicherung-und-instandsetzung-bestehender-strecken-absoluten-vorrang-geben-und-strassenneubauprojekte-stoppen/': {
    ...
    'date': '2022-01-21',
    'with': ['Antje von Broock, BUND-Geschäftsführerin', 'leistungsfähigen Mobilitätssystems', 'örtlichen Verbänden zügig umgesetzt werden."'],  
    'without': ['Zur Übersicht', 'Koalitionsvertrag verlangt, "einen stärkeren', 'Jens Hilgenberg, BUND-Verkehrsexperte'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bund-naturschutz.de/pressemitteilungen/habeck-besuch-in-muenchen-windkraft-in-bayern-kann-nur-ohne-10-h-in-fahrt-gebracht-werden': {
    ...
    'date': '2022-01-20',
    'with': ['dass das Gespräch zwischen', 'Wir appellieren an die Ampelkoalition, dies', 'Bekämpfung der Klimakrise verlieren'],  
    'without': ['Downloads', 'Energiewende: BN stellt fünf Kernforderungen', 'Foto: Christof Stache'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bfn.de/pressemitteilungen/allervielfalt-verden-bringt-natur-die-aller-zurueck': {
    ...
    'date': '2022-01-13',
    'with': ['5,1 Millionen Euro für die erste Förderphase', 'Interessen von Landwirtschaft und', 'einer gemeinsamen Initiative von'],  
    'without': ['Weiterführende Informationen', 'Das Projektgebiet an der Aller', 'Bundesprogramm „Blaues Band Deutschland“'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.lbv.de/news/details/lebenszeichen-von-bavaria-nach-zwei-monaten-funkstille/': {
    ...
    'date': '2022-01-21',
    'with': ['November ausgefallener Sender', 'Ladestand von drei Prozent', 'der GPS-Daten im Gästebuch'],  
    'without': ['Online-Fangemeinde war beunruhig', 'zum Naturschutz in Bayern', 'LBV-HOCHSCHULGRUPPEN:'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.waldwissen.net/de/lernen-und-vermitteln/der-hollaenderholzhandel': {
    ...
    'date': '2022-01-21',
    'with': ['Heute längst vergessen, war der Holzhandel', 'Vom 17. bis ins 19. Jahrhundert war der Begriff ', 'Drittländer eintreffen. Auch der russische'],  
    'without': ['Originalartikel', 'Lernen und Vermitteln', 'Wissenstransfer, Öffentlichkeitsarbeit, Waldpädagogik'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://neubau.wsl.ch/de/index.html': {
    ...
    'date': '2022-01-17',
    'with': ['in der Grundlagenforschung tätig und stellt'],  
    'without': ['Schachbrett'],
    'comments': [],  
    'license': '',  
    'region': 'DE/CH',  
...
'https://www.eawag.ch/de/news-agenda/news-plattform/news/auf-das-erste-elektron-kommt-es-an/': {
    ...
    'date': '2022-01-12',
    'with': ['Reduktionsraten schwanken stark', 'Meret Aeppli, die Erstautorin der Studie', 'Die Studie beschreibt nur einen kleinen'],  
    'without': ['Kontakt an ETHZ', 'Rund um Wurzeln, die Sauerstoff in den Boden bringen, lagert sich', 'Originalpublikation'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.slf.ch/de/lawinenbulletin-und-schneesituation/wochen-und-winterberichte/2021/22/wochenbericht-14-20-januar-2022.html': {
    ...
    'date': '2022-01-14',
    'with': ['dieser Satz fand sich mehrfach in', 'In den Alpen zeigte sich dies mit wiederholt', 'Diese führte zu einer deutlichen Abkühlung'],  
    'without': ['Die grösste Lawine dieser Berichtsperiode', 'Oberflächenreif in einem Nordhang', 'Lawinenbulletins dieser Zeitperiode im Überblick.'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.vogelwarte.ch/de/vogelwarte/news/avinews/dezember-2021/zielartenfoerderung-im-lichten-wald-dank-aktionsplan': {
    ...
    'date': '',
    'with': ['mikroklimatische Bedingungen in der Strauch', 'BAFU, einen Aktionsplan «Zielartenförderung', ' Lebensraumförderung mit der spezifischen Artenförderung'],  
    'without': ['und der Hirschkäfer (Lucanus cervus)', 'beinhaltet auch die lichten Wälder, welche', 'Kastanienselven beispielsweise'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'xhttps://www.zoo-berlin.de/de/aktuelles/alle-news/artikel/der-turm-der-wuensche': {
    ...
    'date': '2022-01-21',
    'with': ['Zukünftig wird man bei der Ein- oder Ausfahrt', 'mehr über ihren Lebensraum im ', ' pearlman Erlebnisarchitektur geplant.'],  
    'without': ['Zurück zur Übersicht', 'PRESSE-MITTEILUNG', 'Jetzt Newsletter abonnieren'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.selbstversorger.de/eier-legen-huehner/': {
    ...
    'date': '',
    'with': ['Mit Sicherheit kennen Sie das Sprichwort: “Ich wollt’ ich', 'Ab wann legen Hühner Eier?', 'Die jeweilige Hühnerrasse spielt in Bezug'],  
    'without': ['Atme tief durch bevor du Michaela', '20 Zeichen, dass ein Herzinfarkt', 'Mann schenkt seiner Freundin eine'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.wochenblatt.com/landwirtschaft/agrarpolitik/heinen-esser-offen-fuer-existenzgruendungspraemie-12810183.html': {
    ...
    'date': '2022-02-21',
    'with': ['Die Jugendverbände der Landwirtschaft in', 'Die Jugendverbände der Landwirtschaft in', 'besprach sie Fragen zur erwartenden'],  
    'without': ['Vertreterinnen und Vertreter der', 'Jugendverbände fordern', 'Die Jugendverbände der'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://oekolandbau.de/service/nachrichten/detailansicht/tag-des-zweinutzungshuhns-am-22-januar/': {
    ...
    'date': '2022-01-21',
    'with': ['einem echten Zweinutzungstier? Die Ökotierzucht', 'wurden. Hier in Deutschland', 'halten inzwischen ÖTZ-Tiere'],  
    'without': ['Thema auf Oekolandbau.de', 'Alternativen zum Kükentöten', 'Foto: ÖTZ'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.dlg.org/de/landwirtschaft/presse/aktuell
    'file': 'dlg.org-Preis.html',
    'author': '',
    'title': 'DLG hat „Wilhelm-Rimpau-Preis“ ausgeschrieben',
    'date': '2022-01-20',
    'with': ['Auszeichnung für innovative und praxisnahe', 'Fakultät deutschsprachiger Universitäten', 'nächsten DLG-Feldtage, die'],  
    'without': ['Fotoarchiv', 'Servicebereich Kommunikation', '14.72 KB'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.zamg.ac.at/cms/de/klima/news/histalp/histalp-oesterreich-jahresbericht-2021': {
    ...
    'date': '2022-01-21',
    'with': ['zurückreichen und besonderen', 'Messwerte der Gegenwart mit', 'nternationale Klimadatensammlung'],  
    'without': ['Die ZAMG ist eine', 'Auskunft über vergangenes', 'Berechnung der erwartbaren'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.handwerksblatt.de/themen-specials/coronaschutz-im-betrieb/2g-3g-was-gilt-beim-friseurbesuch': {
    ...
    'date': '2022-01-01',
    'with': ['Corona und die neue Omikron-Variante', 'Besuch beim Friseur oder der Kosmetikerin', 'bis einschließlich 15 Jahren brauchen'],  
    'without': ['Alle Angaben ohne Gewähr', 'Quelle: Landesregierung', 'DHB jetzt auch digital!'],  
    'comments': ['Servus, Bayern hat eine Hospitalisierungsrate', 'Sehr geehrte Frau Singer', 'Frisörbesuch mit 3G möglich?'],  
    'license': '',  
    'region': 'DE',  
},
'https://www.deutsche-handwerks-zeitung.de/eigentumsvorbehalt-das-sollten-kaeufer-und-verkaeufer-wissen-168384/': {
    ...
    'date': '2022-01-21',
    'with': ['übergibt der Verkäufer dem Käufer die', 'der Käufer dem Verkäufer zu, das Eigentum', 'Lieferungen beglichen wurden. Ein'],  
    'without': ['Sie werktäglich, was erfolgreiche', 'Stapel mit Mauerziegeln: Wenn ein', 'WEITERE BEITRÄGE ZU'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.handwerk-magazin.de/cyber-angriffe-20-prozent-vom-it-budget-in-die-it-sicherheit-stecken-250901/': {
    ...
    'date': '2022-01-21',
    'with': ['Erpressungsmethoden wie Ransomeware fest.“', 'gesichtet, das sind durchschnittlich', 'weshalb das Update noch nicht umgesetzt wurde'],  
    'without': ['Steuern Sie Ihren Kundendienst', 'Mission Mittelstand - digitales', 'Cyber-Attacken nehmen weiter zu.'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.zdh.de/presse/veroeffentlichungen/pressemitteilungen/kfw-foerderungsstopp-ist-klimapolitisch-fatales-signal/': {
    ...
    'date': '2022-01-25',
    'with': ['und nicht akzeptabel ist, dass', ' Bundesregierung aufgefordert, verlässliche', 'CO2-Minderungs- und Klimaschutzziele so wichtig'],  
    'without': ['Schlagworte', 'Foto: unsplash/Bill Mead', 'Energiewende'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.selbst.de/wurmkiste-39572.html': {
    ...
    'date': '2022-01-22',
    'with': ['kompostieren. In einer Wurmkiste', 'foetida Kartoffelschalen oder Kaffeesatz', 'Nachdem der Abfall in der obersten'],  
    'without': ['Selbst.de empfiehlt', 'Mehr zum Thema', 'Einfach'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.werkzeugforum.de/heizjacken-von-bosch/': {
    ...
    'date': '2022-01-26',
    'with': ['Profis binnen drei Minuten auf „Betriebstemperatur“', 'gebückter Haltung effizient gewärmt. Die Jacke', 'jeweils in den Unisex-Größen'],  
    'without': ['Mauerschlitze fräsen', 'Eine Antwort schreiben', 'Ausbildungsvergütung: Was'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.holzwerken.net/blog/dominik-ricker/perfekte-schnitte-nach-riss-an-der-kreissaege': {
    ...
    'date': '2022-01-21',
    'with': ['Schnitten. Doch es geht auch einfacher...', 'Ein schmales Reststück wird am Parallelanschlag', 'Bei dünneren Plattenwerkstoffen'],  
    'without': ['Das könnte Sie auch interessieren!', 'Nodus-Knoten, Besteckschrank', 'Sie sind aktuell nicht eingeloggt.'],  
    'comments': ['Du bist der Beste!', 'super Idee. Hatte auch schon des', 'Danke Dominik, dieser Tipp'],  
    'license': '',  
    'region': 'DE',  
},
'https://selbermachen.de/garten/gartenhaus-selber-bauen/wohngewaechshaus-selber-bauen': {
    ...
    'date': '2022-01-15',
    'with': ['feuchteres Klima, als in unseren', 'Konstruiert nach dem Prinzip der thermischen', 'Die Traufenprofile werden mit Hilfe'],  
    'without': ['Mehr lesen über:', 'Fahrradunterstand selber', 'Hochbeet selber bauen -'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.mein-schoener-garten.de/news/3-profi-tipps-rund-um-die-topinambur-ernte-48412': {
    ...
    'date': '2022-01-26',
    'with': ['Winter Gemüse frisch aus dem Garten', 'Pflanze sind nahrhaft, ballaststoffreich und', 'Der Boden ist gefroren. Dagegen hilft'],  
    'without': ['Empfehlungen aus dem', 'Verwandte Artikel', 'Rüben: Schätze aus dem Untergrund'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.haus.de/bauen/vorsatzschalung-33656': {
    ...
    'date': '2022-01-25',
    'with': ['vor allem in der Trockenbauweise', 'Zwischen den beiden Elementen', 'Schallschutz sorgen. Bei der direkt befestigten'],  
    'without': ['HÄUFIG GESTELLTE FRAGEN', 'Wirkt eine Vorsatzschalung als Dampfbremse?', 'Schallschutz sowie die Wärmeisolierung.'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.gartenjournal.net/zaubernuss-im-winter': {
    ...
    'date': '',
    'with': ['filigrane Blüten mit bis zu 4 cm', 'bevor der Wurzelballen austrocknet', 'keine besondere Winterpflege nötig'],  
    'without': ['Hier weiterlesen', 'Wie groß wird die', 'Lesen Sie auch'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.houzz.de/magazin/best-of-houzz-2022-das-sind-die-beliebtesten-projekte-auf-houzz-stsetivw-vs~157401545': {
    ...
    'date': '2022-01.26',
    'with': ['Projekte, die bei den Millionen', 'zu den Projekten, die', 'Auszügen hat es der Community'],  
    'without': ['Verraten Sie gerne in den Kommentaren:', 'Ähnliche Artikel lesen', 'Nutzer mochten auch folgende'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.homify.de/diy/20546/wie-man-eine-runde-tischdecke-in-nur-7-schritten-herstellt': {
    ...
    'date': '2022-01-10',
    'with': ['Unabhängig von Größe und Stil kannst du', 'den Durchmesser (das ist das Maß,', 'wie du eine runde Tischdecke'],  
    'without': ['Kommentare', 'Die Seedball Manufaktur', 'Ernährungsworkshop'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bauemotion.de/magazin/schneeraeumpflicht-das-sollten-sie-wissen/15002914/': {
    ...
    'date': '',
    'with': ['Hausbesitzer sind gesetzlich dazu', 'Wenn sich ein Passant auf einem', 'Fitnesstraining an der frischen Luft.'],  
    'without': ['Meist gelesene Artikel', 'Schneeräumpflicht - was man darüber', 'Dieser Artikel wird Ihnen präsentiert'],  
    'comments': ['Vielen Dank, sehr informative Tipps!', 'das ist eigentlich ganz einfach.', 'Schneebeseitigung beginnt, um' ],  
    'license': '',  
    'region': 'DE',  
},
'https://hausinfo.ch/de/wohnen/wohnen-leben/angenehmes-raumklima/kondenswasser.html': {
    ...
    'date': '2021-12-15',
    'with': ['Fenstern nicht durch überstellte Fensterbänke', 'Dies schlägt sich aber in', 'Luftfeuchtigkeit im Raum sorgen'],  
    'without': ['Kondenswasser an den Fensterrändern', 'Angenehmes Raumklima', 'Gesund wohnen'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.outdoor-magazin.com/outdoor-szene/vanlife-in-schweden/': {
    ...
    'date': '2022-01-06',
    'with': ['Der Traum vieler Vanlife- und', 'Teilnehmern gilt die 2G-Regel', 'Schweden unzählige legale'],  
    'without': ['Das Wasser aus Bächen und Flüssen', 'Die Alstadt Stockholms', 'Weitere Tourentipps'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.alpin.de/sicher-am-berg/skitouren/51490/artikel_quantum-free-asolo-factory-130-das-beste-aus-der-touring-und-der-freeride-welt-vereint.html': {
    ...
    'date': '2022-01-21',
    'with': ['Spitzenklasse, der das Beste', 'Die zweiteilige X Dual', 'Der exklusive IF Touring'],  
    'without': ['Quantum Free Asolo Factory 130:', 'Besonders komfortable Innenschuhe', 'Thema Skitouren:'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bike-magazin.de/mtb_news/szene_news/strava-update-poi-bei-routen': {
    ...
    'date': '2022-01-26',
    'with': ['Mitte Januar 2022 hat Strava ein', 'Durch die Kombination der Datenbank', 'Unterwegs kann man spontan'],  
    'without': ['Ob Supermarkt, Pumptrack oder', 'Lesen Sie das BIKE Magazin', 'Empfehlungen aus der Redaktion'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.mtb-news.de/news/reifen-tubeless-montieren/': {
    ...
    'date': '2022-01-26',
    'with': ['gemacht! Schlauchlose Reifen', 'Dieser muss luftdicht abschliessen', 'Systeme bieten eine höhere'],  
    'without': ['Mehr zum Thema', '120 Kommentare', 'Best of Test: Die besten Bikes 2022'],  
    'comments': ['und nachhaltiger als mit CO2-Patronen.', 'und nachhaltiger als mit CO2-Patronen.', 'und nachhaltiger als mit CO2-Patronen.' ],  
    'license': '',  
    'region': 'DE',  
},
'https://www.tour-magazin.de/profisport/news/nach-unfall-auf-intensivstation-bernal-kaempft-um-karriere/a51346.html': {
    ...
    'date': '2022-01-25',
    'with': ['Sieger der Tour de France', 'Twitter und reihte sich damit', 'Der Unfall erinnert an den schweren'],  
    'without': ['Das könnte Sie auch interessieren', 'Branchen News', 'Egan Bernal verlängert bis'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.gipfelbuch.ch/outdoornews/detail/id/718': {
    ...
    'date': '2022-01-14',
    'with': ['Um einen ersten Eindruck zu erhalten', 'hilft uns in den Satellitendaten', ' Zusammengefasst berücksichtigen wir in'],  
    'without': ['Abbildung: Vergleich auf dem Aletschgletscher', 'FRAGEN AN DEN AUTOR', 'Farblich codierte Schneehöhendarstellung'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.baechli-bergsport.ch/Blog/Einblick-in-die-Praxis-und-Theorie-von-Lawinen-De-9-9-9-9-1.htm': {
    ...
    'date': '2021-12-01',
    'with': ['wir bestens vorbereitet sind,', 'Knie in die Hüfte bis in den', 'langsam sein und im Nachhinein'],  
    'without': ['Abbildung 4: klassische Schwachschicht.', 'TEILE DIESEN BEITRAG AUF', 'Vorgehensweise für grosse Ereignisse'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.lacrux.com/klettern/mammut-nimmt-adam-ondra-unter-vertrag/': {
    ...
    'date': '2022-01-25',
    'with': ['Im von Adam Ondra veröffentlichten Video', 'Black Diamond bald den Rücken zu und wechselt', 'kurze Sequenzen aneinandergereiht'],  
    'without': ['Gefällt dir unser Klettermagazin?', 'Das ist die deutsche', 'Wetter Chironico'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.sac-cas.ch/de/umwelt/schneesport-mit-ruecksicht-auf-wildtiere-35334/': {
    ...
    'date': '2022-01-25',
    'with': [' du schon einmal durch Tiefschnee gestapft bist', 'Beachte Wildruhezonen und Wildschutzgebiete:', 'sowie die Übernachtung gehören'],  
    'without': ['Verwandte Links', 'Skitour im (Voll)Mondschein', 'Alpentiere im Winter - Tiertafeln'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.bergsteigen.com/produkte/skibergestiegen-schnell-und-leicht-mit-den-camp-neuheiten/': {
    ...
    'date': '2022-01-14',
    'with': ['Fixer Aluminiumstock', 'ambitionierte Skibergsteiger, die', ' X-Press-Hauptskihalter mit innovativem'],  
    'without': ['KOMMENTARE', 'KOMMENDE TERMINE', 'One Love – Babsi Zangerl und Jacopo Larcher'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.camping.info/magazin/de/campingurlaub-an-der-italienischen-kuste-von-ligurien-camping-lino': {
    ...
    'date': '2022-01-24',
    'with': ['am Platz. Die kleine aber', 'direkt am Mittelmeer und', 'und eine Gaststätte für'],  
    'without': ['Reisen & Routen', 'Startseite', 'Campingplätze'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://mluk.brandenburg.de/mluk/de/aktuelles/presseinformationen/detail/~02-01-2022-land-zahlte-rund-1-4-millionen-euro-erlegungspraemie-fuer-wildschweine-im-jagdjahr-202020
    ...
    'date': '2022-01-02',
    'with': ['Rückblickend wurde die allgemeine Erlegungsprämie', 'Schwarzwild lag sowohl die Zahl', 'Auszahlung der Bachenprämie müssen bis zum 30. April'],  
    'without': ['Informationen zur ASP und zur Bachenprämie', 'Weiterführende Informationen', 'Weiterführende Informationen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.jagderleben.de/news/waldwege-unrechtsmaessig-gesperrt-polizei-ermittelt-wegen-noetigung-713266': {
    ...
    'date': '2022-01-26',
    'with': ['Landwirte und Eigentümer werden so', 'Hinweise unter der'],  
    'without': ['Wer die Äste immer wieder auf', 'Kommentieren Sie', 'angegriffen: Polizei'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.jaegermagazin.de/jagd-aktuell/news-fuer-jaeger/suedtirol-woelfe-toeten-hund-und-bedrohen-besitzer/': {
    ...
    'date': '2022-01-24',
    'with': ['Woche ereignete sich in Südtirol eine', 'Folgaria gemacht haben. Der', 'Als sich die Wölfe immer noch'],  
    'without': ['Hundemeute oder Solojäger?', 'Nutria bejagen und verwerten', 'Neuentdeckung: Die wahren'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://wildundhund.de/bonn-un-konvention-veroeffentlicht-empfehlungen-zur-vogelgrippe-und-zum-umgang-mit-wildvoegeln/': {
    ...
    'date': '2022-01-26',
    'with': ['Arbeitsgruppe zur Vogelgrippe und zu', 'Die CMS stellt fest, dass', 'ungefährlichen Vogelgrippe festzustellen.'],  
    'without': ['Russland: Erstmalige Infektion', 'VERWANDTE ARTIKEL', 'NOCH MEHR WILD UND HUND'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://djz.de/amoklauf-in-heidelberg-rufe-nach-schneller-aufklaerung/': {
    ...
    'date': '2022-01-25',
    'with': ['einer Meldung von heute.', 'FWR fordere eine schnelle und umfassende', 'und Europa verhindern.'],  
    'without': ['DJV-Verbandsbericht veröffentlicht', 'Vorheriger Artikel', 'Immer mehr Wildschweine in Köln'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.jagdverband.de/wir-sind-tief-erschuettert': {
    ...
    'date': '2022-01-25',
    'with': ['und schnelle Aufklärung', 'niemals anonym erworben', 'Schätzung von Experten.'],  
    'without': ['Wer wir sind und was wir tun', '(Quelle: Fleischmann/Unsplash/DJV)', 'Unsere Akademie'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://schweizerjaeger.ch/aktuell/vogeldesjahres2021.html': {
    ...
    'date': '2022-01-04',
    'with': ['Botschafter für eine Ökologische', 'Mittelland und Jura in fast', 'aber auch Hecken und'],  
    'without': ['WEITERE INTERESSANTE INFORMATIONEN', 'Wildtiere & Lebensräume im Wandel der Zeit', 'Vogel des Jahres 2022: Feldlerche'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.jagd-oesterreich.at/2021/12/14/noe-jagdverband-auf-natur-wildtier-beduerfnisse-achten/': {
    ...
    'date': '2021-12-14',
    'with': ['Ruhe, Äsung und Deckung.', 'Immer auf (Forst-)Straßen oder', 'Parkverbote missachten und auf Forst-'],  
    'without': ['Ähnliche Beiträge', 'NÖ Jagdverband: Auf Natur', 'FOLGEN SIE UNS:'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://taucher.net/diveinside-boot_tulln_2022_abgesagt-kaz8693': {
    ...
    'date': '2022-01-24',
    'with': ['Wassersportler in Österreich und', 'Optimismus und damit die Vorfreude', 'Sobald weitere Informationen vorliegen'],  
    'without': ['Letzte Artikel', 'Norwegen: Orcas und Buckelwale auf Jagd', 'Kategorie: News'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.blinker.de/angelmethoden/angeln-allgemein/news/fishing-masters-show-in-rostock-findet-naechstes-jahr-statt/': {
    ...
    'date': '2022-01-11',
    'with': ['IGA Park alles ums Angeln drehen.', 'coronabedingten Verschiebungen steht', 'frischem Räucherfisch und vielen'],  
    'without': ['Das könnte Sie auch interessieren', 'Bild: Jahr Media', 'Wir erstellen Ihr'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.zoll.de/SharedDocs/Fachmeldungen/Aktuelle-Einzelmeldungen/2021/vst_verkuendung_tabaksteuermodernisierungsgesetz.html': {
    ...
    'date': '2021-10-18',
    'with': ['für Substitute für Tabakwaren.', '1. Januar 2023', 'Beteiligte, die erstmals'],  
    'without': ['(Fachthemen)', 'Wie gefällt Ihnen unsere', 'Weitere Informationen', 'PDF'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://de.motor1.com/news/545242/bmw-3er-touring-2022-erwischt/': {
    ...
    'date': '2021-11-03',
    'with': ['eine der beliebtesten', '3er-Facelifts mit den', 'werden, die auf der in China,'],  
    'without': ['Die besten Leasing-Deals', 'Ein Service von', 'Fiat 500 Leasing für 55 Euro'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.autozeitung.de/adblue-diesel-tanken-ratgeber-180301.html': {
    ...
    'date': '2021-11-02',
    'with': ['Tankstellen: Wo kann man Adblue kaufen?', 'AdBlue-Tank einfrieren?', 'Diesel dürfen seitdem statt'],  
    'without': ['Beliebte Marken', 'So kommt die', 'Hefte testen und 35'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.automobilwoche.de/article/20211103/AGENTURMELDUNGEN/311039909/1276/krach-vor-der-vw-betriebsversammlung-es-knirscht-zwischen-diess-und-aufsichtsraeten': {
    ...
    'date': '2021-11-03',
    'with': ['bei VW mehren sich', 'VW-Chef Herbert Diess:', 'Haussegen hängt schief'],  
    'without': ['Starker Rückgang im Oktober:', 'Die neuesten Aufzeichnungen', 'Jobs in der Autobranche'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.autohaus.de/nachrichten/autohersteller/skoda-der-lange-weg-zum-strom-2980654': {
    ...
    'date': '2021-11-03',
    'with': ['immerhin auf Platz drei', 'Fuhrparks greifen zu', 'Das neue Top-Modell'],  
    'without': ['Skoda: Der lange Weg zum Strom', 'Familien-Lösung', 'Fahrbericht BMW'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://auto-presse.de/autonews.php?newsid=6486285': {
    ...
    'date': '2021-11-05',
    'with': ['wenige Wochen nach', '1,5-Liter-Hybridantrieb', 'Mit dem demnächst'],  
    'without': ['Top Meldungen', 'Mazda fertigt flexibler', 'für dynamische Fortbewegung'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.autonews.ch/?p=31228': {
    ...
    'date': '2021-11-05',
    'with': ['wieder Gerüchte zu Tesla', 'Gunsten von Qingdao', 'aber sicher eine vierte Gigafactory'],  
    'without': ['Volltext-Suche:', 'Fahrbericht Ioniq 5 von Hyundai', 'Crossback – charmant und mit'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://auto-wirtschaft.ch/news/8950-fur-die-freiheit-auf-radern-campinglosungen-von-sortimo-am-caravan-salon': {
    ...
    'date': '2021-11-04',
    'with': ['An fünf Messetagen', 'Mit dem EQV stand', 'Thule-Markise sowie'],  
    'without': ['Sinus 2021: Kinder und', 'Immer informiert bleiben', 'SHAB-Abfrage'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://auto-motor.at/Hyundai/Tests/Hyundai-Santa-Fe-Plug-in-Test.html': {
    ...
    'date': '2021-11-04',
    'with': ['Santa Fe ist weit', 'Ausstattung Sicherheit: 1', 'CO2 Ausstoß pro km in'],  
    'without': ['Die neuesten Meldungen', 'Der neue SL ist erstmals', 'Test verraten wir'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://auto.oe24.at/thema/vw-chef-diess-warnt-vor-tesla-und-golf-aus-china/497533355': {
    ...
    'date': '2021-11-05',
    'with': ['Stammsitz Wolfsburg zu einem', 'wieder zum Aushängeschild', 'Warnung vor Tesla'],  
    'without': ['Auto kostenlos bewerten', 'Mehr Videos', 'des ET7 in Europa an.'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://motor.at/zweirad/seat-mo-125-der-elektroroller-im-test/401755605': {
    ...
    'date': '2021-11-01',
    'with': ['Der (Elektro-)Roller versteht', 'Mo 125 auf 95 km/h', 'man noch die Förderung'],  
    'without': ['Kommentare gepostet', 'motor.at, and', 'Bild: Werk/CHRISTIAN HOUDEK'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://bos-fahrzeuge.info/news/Die-Haubenfahrzeuge-der-Nachkriegszeit-Teil-49-223': {
    ...
    'date': '2021-11-02',
    'with': ['seine Fahrzeuge fuhren', 'und Soldatenräte das Werk', 'Trittstufe aus über'],  
    'without': ['Störung bei der Suchfunktion', 'Florian Neunkircher...', 'von der Feuerlöschpolizei'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.cducsu.de/themen/wirtschaft-und-energie-verkehr-bildung-und-forschung/gruener-wasserstoff-das-schluesselelement-der-energiewende': {
    ...
    'date': '2021-11-02',
    'with': ['Mark Helfrich über das gewaltige', 'Aktuell befinden wir', 'Deutschland einen erheblichen'],  
    'without': ['Biokerosin, Verpackungen', 'Quelle: Foto Steven', 'Transfer in die Praxis.'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.spdfraktion.de/themen/aydan-oezoguz-vizepraesidentin': {
    ...
    'date': '2021-10-26',
    'with': ['ist zur stellvertretenden Präsidentin', 'und arbeitete als wissenschaftliche', 'türkischen Wurzeln am'],  
    'without': ['Arbeitsgruppen', 'Bei Fragen und Anregungen', 'Foto: DBT/Stella'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.gruene-bundestag.de/themen/klimaschutz/cop26-in-glasgow': {
    ...
    'date': '2021-11-03',
    'with': ['Es ist höchste Zeit', 'Versprechen, ab 2020 jährlich', 'Die Initiative der britischen'],  
    'without': ['Andrew Milligan', 'Mehr Klimaschutz', '1,5 Grad-Pfad zu kommen.'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.fdpbt.de/beendigung-epidemischen-lage-nationaler-tragweite': {
    ...
    'date': '2021-10-27',
    'with': ['Lage von nationaler Tragweite', 'erste Fraktion gewesen', 'Das Konzeptpapier'],  
...
'https://www.linksfraktion.de/themen/nachrichten/detail/abzocke-wird-als-klimaschutz-verkauft/': {
    ...
    'date': '2021-11-02',
    'with': ['der Linken-Vorsitzende', 'Aber was wir im Moment', 'Unternehmen durch immer'],  
    'without': ['Kein Recht auf Faulheit', 'Im Wortlaut von Katja', 'Pressemitteilung von'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bund.net/bund-tipps/detail-tipps/tip/unser-tipp-im-november-das-hermelin/': {
    ...
    'date': '2021-11-01',
    'with': ['Winterfell wurde ihm früher', 'Paarungszeit der Hermeline', 'Hermelin ist weit verbreitet'],  
    'without': ['Weitere Tipps', 'ist im Winter mit seinem', 'Unser Tipp im Oktober:'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.rosalux.de/news/id/45292/wir-waren-fast-40-tage-in-quarantaene?cHash=39ac749d120d127296ab076c203053d3': {
    ...
    'date': '2021-10-30',
    'with': ['Wir waren fast 40 Tage in Quarantäne', 'Wo sind Sie in die', 'Es war nach dem'],  
    'without': ['zum Thema', 'Teilen:', 'zählt für sie nicht'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.freiheit.org/de/holocaust-ueberlebende-margot-friedlaender-wird-100-jahre': {
    ...
    'date': '2021-11-05',
    'with': ['Gespräch mit Sabine', 'Herzlichen Glückwunsch.', 'Als eine der letzten'],  
    'without': ['Meist gelesen', '„Die Eskalation geht', 'Die Sorge unter der jüdischen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.hss.de/news/detail/grosse-aufgaben-fuer-die-neue-regierung-news8123/': {
    ...
    'date': '2021-11-03',
    'with': ['Najla Bouden ist die', 'Tunesier landesweit die', 'tunesische Bevölkerung durchaus in einer'],  
    'without': ['Naher Osten, Nordafrika', 'Bourguiba, Tunis.', 'Ahmed Zarrouki, Avenue Hbib'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.kas.de/de/laenderberichte/detail/-/content/kommunalwahlen-in-nordmazedonien': {
    ...
    'date': '2021-11-05',
    'with': ['Die Lokalwahlen endeten', 'Der Hauptstadt Skopje wird', 'Zaev erklärt seinen Rücktritt'],  
    'without': ['Über diese Reihe', 'Die Auslandsmitarbeiter vor Ort', 'Erdrutschsieg der'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.feuerwehrverband.de/jetzt-noch-plaetze-fuer-forum-brandschutzerziehung-sichern/': {
    ...
    'date': '2021-11-03',
    'with': ['Jetzt noch anmelden und bequem', 'digitalen Ausbildungsmöglichkeiten erweitert', 'Auch wenn wir uns freuen'],  
    'without': ['Ähnliche Artikel', 'Katastrophenhilfe zur Stärkung', 'Jens lebt auf der Insel'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bundesfeuerwehrverband.at/2021/10/20/zentrum-am-berg-offiziell-eroeffnet/': {
    ...
    'date': '2021-10-20',
    'with': ['Mit mehr als vier', 'Heinz Faßmann ging auf die', 'Würdigung der ÖBFV-Kooperation'],  
    'without': ['Landesverbände', 'Aktuelles aus dem ÖBFV', 'E-LBD Krugfahrt verstorben'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://www.berliner-feuerwehr.de/aktuelles/nachrichten/feuerwehr-und-katastrophenschutz-ehrenzeichen-verliehen-3896/': {
    ...
    'date': '2021-11-05',
    'with': ['Ehrenzeichen der Stufe 1', 'Landesbranddirektor Dr. Karsten Homrighausen', 'Kameradinnen und Kameraden erhielten'],  
    'without': ['Kameradinnen und Kameraden erhielten', '„Red levens“ - Leben retten', 'Zum Seitenanfang'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.thw.de/SharedDocs/Meldungen/DE/Meldungen/national/2021/10/meldung_01_miniserie_frauen_im_thw/meldung_001_startseite_miniserie_frauen_im_thw.html': {
    ...
    'date': '2021-10-11',
    'with': ['heute für Frauen ist und wie', 'nahezu allen Gesellschaften und Kulturen', '„Cool, ‘ne Frau in'],  
    'without': ['Mehr zum Ereignis', 'Das THW in Ihrer', 'Alle Termine'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.drk.de/presse/pressemitteilungen/meldung/drk-immer-mehr-menschen-wegen-klimawandel-auf-hilfe-angewiesen/': {
    ...
    'date': '2021-10-28',
    'with': [' Hitzewellen ausgesetzt gewesen', 'Zudem betreibt das DRK', 'Klimawandel als globale Bedrohung'],  
    'without': ['Jede kleine Spende', 'Beitrag teilen', 'Diese Seite:'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.malteser.de/newsdetails/news/hilfsorganisationen-fordern-von-kuenftiger-bundesregierung-investitionsoffensive-im-bevoelkerungsschutz-1.html': {
    ...
    'date': '2021-11-04',
    'with': ['in den Bevölkerungsschutz', 'behördlichen Strukturen und unter', 'Achtung Redaktion:'],  
    'without': ['Zurück zu allen Meldungen', 'Foto: Galli/Malteser', 'Jetzt helfen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.caritas.de/presse/pressemeldungen-dcv/eva-welskop-deffaa-zur-neuen-caritas-praesidentin-gewaehlt-7fc83ad4-6508-4c79-adba-8a0fee82a677': {
    ...
    'date': '2021-10-13',
    'with': ['Digitale Agenda des Verbande', '„Die Türen der Kirche von innen aufstoßen“', '18 Jahren als Caritas-Präsident'],  
    'without': ['Pressesprecherin des', 'Berliner Büro – Pressestelle', 'DCV / Oppitz'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bundespolizei.de/Web/DE/04Aktuelles/01Meldungen/2021/10/staendige_aktualisierung_migrationslage.html;jsessionid=51A21717FEF5DF385B5C87C9E5FABD92.2_cid324': {
    ...
    'date': '2021-11-10',
    'with': ['Die deutsch-polnische Grenze', 'Bei Personen, die unerlaubt', 'Lesen Sie dazu auch die'],  
    'without': ['Illegale Migration aus Belarus über', 'Seite drucken', 'So erreichen Sie uns:'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://weisser-ring.de/media-news/meldungen/29-10-2021': {
    ...
    'date': '2021-10-29',
    'with': ['bundesweiten Einbruchschutzkampagne K-EINBRUCH', 'seit 2015 kontinuierlich', 'Wenn Sie Ihr Haus verlassen'],  
    'without': ['Foto: www.k-einbruch.de', 'Zurück zur Übersicht', 'Startseite'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.diakonie.de/pressemeldungen/vorstellung-der-studie-lebensgefuehl-corona': {
    ...
    'date': '2021-11-10',
    'with': ['Lebensgefühl der Menschen', 'ist eine Studie der Evangelischen', 'Online-Pressekonferenz'],  
    'without': ['Kathrin Klinkusch', 'Hermann Bredehorst', 'und Berufe bei der Diakonie'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.jugend-forscht.de/presse/pressemitteilungen/archiv/neuartige-feuerloeschtechnik-alternative-grillkohle-und-redox-flow-technologie-mint-talente-praesentieren-innovative-ideen.html': {
    ...
    'date': '2021-11-02',
    'with': ['Preisträger von Deutschlands bekanntestem', 'Kern-Brennstoff“ ist eine', 'Geschäftsführender Vorstand'],  
    'without': ['Folge uns', 'Video: Mehrwert eines Jugend', 'Projektdatenbank'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.awo.org/menschenrechte-achten': {
    ...
    'date': '2021-11-10',
    'with': ['Gesundheitsversorgung gewähren und', 'Geflüchtete brauchen einen', 'Dies gelingt durch einen'],  
    'without': ['Aktionstag Suchtberatung.', 'Suchtberatung wirkt', 'Klassismus in'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.tierschutzpartei.de/eine-private-wildvogelauffang-und-auswilderungsstation/': {
    ...
    'date': '2021-11-08',
    'with': ['Dortmund-Dorstfeld jedoch anders sein', 'Ewald Ferlemann und sein', 'Sebastian Everding stellt nach'],  
    'without': ['8. November 2021', 'Wildvogelstation Ferlemann in', 'Aktuelle Wahlen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.refinery29.com/de-de/vreni-frost-instagram-werbung-abmahnung': {
    ...
    'date': '2018-05-23',
    'with': ['Sie betreibt seit', 'Ab wie vielen Followern ist', 'Vreni, du wurdest'],  
    'without': ['Vreni Frost im offenen', 'Start a discussion, not', 'Foto: Vreni Fros'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.achgut.com/artikel/bericht_zur_coronalage_vom_22.04.2020_worauf_wartet_die_politik': {
    ...
    'date': '2020-04-22',
    'with': ['Noch nicht offiziell ist die Zahl', 'Wie schwer ist die Krankheit', 'Wahlumfrage, Wahlprognose'],  
    'without': ['Sie lesen gern Achgut.com?', 'schnell & einfach einen Boot-Stick', 'Sensationelles Urteil für Dieselfahrer'],  
    'comments': ['Toten noch bei 2500, mit', 'den wir einer Regierung', 'wie wir ohne Maske ab Montag'], 
    'license': '',  
    'region': 'DE',  
},
'https://www.tvtoday.de/entertainment/kino-news/will-smith-gestoertes-verhaeltnis-zu-sohn-trey-205331.html': {
    ...
    'title': 'Will Smith',
    'date': '',
    'with': ['ältesten Spross im Alter von gerade', 'Immer wieder posten', 'hat der Familienvater'],  
    'without': ['Das könnte Sie auch', 'Kinoprogramm-Suche', 'Judy Eddy/WENN.com'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.gelbe-liste.de/produkte/Chininum-salicylicum-D4-DHU-Tabletten_433873': {
    ...
    'date': '',
    'with': ['Gebrauchsinformation', 'Keine Basisinformation zu diesem', 'Hersteller bereitgestellt'],  
    'without': ['Mit der Identa-Suche', 'bei Eisenmangel', 'Zusatzinfos für'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.auswaertiges-amt.de/de/ReiseUndSicherheit/italiensicherheit/211322': {
    ...
    'date': '2021-11-12',
    'with': ['kann weiterhin zu Einschränkungen', 'Beachten Sie die ausführlichen', 'Besonderheiten in den Regionen'],  
    'without': ['Schlagworte', 'Reisewarnungen anlässlich', 'Gesellschaftsgruppen. Das Sendeformat'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.swr.de/sport/mehr-sport/volleyball/mtv-stuttgart/stuttgart-ohne-rivers-im-finale-100.html': {
    ...
    'date': '2021-04-21',
    'with': ['"Was genau sie hat', 'Lena Große Scharmann übernimmt', 'letzten beiden Finalspielen'],  
    'without': ['Die meistgelesenen Artikel', 'Gelten neue Regeln', 'Corona-Alarmstufe'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'http://www.finanztreff.de/realtimenews/influencer-und-trading-apps-die-jungen-entdecken-die-boerse/24437626': {
    ...
    'date': '2021-04-28',
    'with': ['informieren sich bei Instagram', 'ausschließlich Einzelaktien ins Depot.', 'Die Kanäle heißen «Aktien mit Kopf»'],  
    'without': ['Krypto-Hot-Stock mit 60%', 'MIDDAY BRIEFING - Unternehmen', 'Weitere Nachrichten'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.rtl.de/cms/bericht-bund-und-laender-wollen-lockdown-verlaengern-um-weitere-vier-wochen-4723862.html ': {
    ...
    'date': '2021-03-20',
    'with': ['bringt die ganze Impfstrategie', 'Wie der "Business Insider" unter', 'TVNOW-DOKU: Das Impfdilemma'],  
    'without': ['Stefan Boness', "Zahlen explodieren - Politik pennt?!", "Wohnen & Haushalt Gutscheine"],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.tonight.de/unterhaltung/promis/daniela-buechner-danni-und-ennesto-monte-trennen-sich-arschloch_114240.html': {
    ...
    'date': '2021-03-16',
    'with': ['gescheitert“, schrieb der 46-Jährige.', 'einem halben Jahr', 'Danni Büchner hat derweil ihren'],  
    'without': ['Foto: Instagram', 'Wegen Corona:', 'Promis'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.dw.com/fr/la-perte-des-terres-fertiles-et-les-%C3%A9l%C3%A9phants-en-guin%C3%A9e-conakry/a-6533123': {
    ...
    'date': '2011-05-23',
    'with': ['24 milliards de tonnes', 'développement, IRD à Dakar.', "d'une étude menée"],  
    'without': ['et vidéos sur le sujet', 'terres fertiles et les éléphants en Guinée-Conakry', 'Permalien'],  
    'comments': [],  
    'license': '',  
    'region': 'FR',  
},
'https://france.attac.org/actus-et-medias/dans-les-medias/article/les-privatisations-sont-au-profit-d-interets-prives-financiers-des': {
    ...
    'date': '2019-06-13',
    'with': ['Aurélie Trouvé, porte-parole', 'partagé pour empêcher', ' pour parler du'],  
    'without': ['Dans la même rubrique', 'Je fais un don à Attac', 'Abandon du projet'],  
    'comments': [],  
    'license': '',  
    'region': 'FR',  
},
'https://www.katzen-forum.net/threads/jede-nacht-verliert-pepe-soviel-dreck-aus-dem-fell.230143/': {
    ...
    'date': '2018-09-27',
    'with': ['auf seiner beigefarbenen', '(Vor allem die "Bettelmänner", wenn', 'schon seit 5 Uhr draußen'],  
    'without': ['das wirklich Katzenflöhe!?', 'Ähnliche Themen', 'Katzen Forum'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.arteradio.com/son/61661515/la_voix_des_nuls': {
    ...
    'date': '2019-05-23',
    'with': ['revendication prend chaque', 'jour par les "gilets', 'spécialiste du sujet.'],  
    'without': ['Vous aimerez aussi', 'Tous nos derniers podcasts', 'de messagerie est uniquement'],  
    'comments': [],  
    'license': '',  
    'region': 'FR',  
},
'http://www.womencantalksports.com/top-10-women-talking-sports/': {
    ...
    'date': '2014-01-22',
    'with': ['begin a series highlighting', '5. Kristi Dosh', 'I really love what'],  
    'without': ['Submit your sports', 'Twitter Talk', 'So Much Math in Football?'],  
    'comments': [],  
    'license': '',  
    'region': 'US',  
},
'https://mitundvoneinander.wordpress.com/2008/12/31/ratschlage-geben/': {
    ...
    'date': '2008-12-31',
    'with': ['PDF:'],
    'without': ['Teilen Sie dies mit', 'Gib das erste', 'Dezember'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.aclu.org/blog/juvenile-justice/school-prison-pipeline/county-criminalized-students-bad-grades-until-now': {
    ...
    'date': '2019-07-25',
    'with': ['criminal justice system.', 'more than a decade', 'many areas of juvenile'],  
    'without': ["Fight for everyone's rights", 'RELATED STORIES', 'of Our Students'],  
    'comments': [],  
    'license': '',  
    'region': 'US',  
},
'https://francais.radio.cz/le-ministre-de-la-sante-surpris-sans-masque-au-restaurant-8698000': {
    ...
    'date': '2020-10-23',
    'with': ["savoir qu'il lui cherchait", 'Andrej Babiš a également', 'de la Santé avait'],  
    'without': ['ARTICLES CORRESPONDANTS', 'Pour faire face à l’épidémie', 'Roman Prymula, photo:'],  
    'comments': [],  
    'license': '',  
    'region': 'CZ',  
},
'https://www.nestle-family.com/en/recipes/roasted-chicken-oriental-rice': {
    ...
    'date': '',
    'with': ['1 large or 1200 g whole', '1 tablespoon ground', 'cups or 1125 ml of'],  
    'without': ['NEW AND EXCITING SIMILAR', 'Like recipe?', 'basket and deliver to you'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://edition.cnn.com/2021/03/08/uk/meghan-harry-oprah-interview-recap-scli-gbr-intl/index.html': {
    ...
    'date': '2021-03-14',
    'with': ['The duchess has hinted', 'broach the topic', 'Harry also criticized'],  
    'without': ["baby's skin color", 'PAID CONTENT', 'Berlin: Eine Senior-Dating'],  
    'comments': [],  
    'license': '',  
    'region': 'US',  
},
'https://web.archive.org/web/20070228213001/http://www.alternatives-economiques.fr/site/hs72_003_35heures.html': {
    ...
    'date': '',
    'with': ['autres travaillent moins', '350 000 emplois créés', 'âge effectif de'],  
    'without': ['Le marché du travail est-il trop', 'Hors-série n° 72', 'L’état de l’économie'],  
    'comments': [],  
    'license': '',  
    'region': 'FR',  
},
'https://www.ekd.de/andacht-zur-friedensdekade-in-der-kaiser-wilhelm-69810.htm': {
    ...
    'date': '2021-11-11',
    'with': ['Bevollmächtigter des', 'mit euch und Friede', 'unerschrocken und furchtlos'],  
    'without': ['SCHWERPUNKTE DER EKD', 'Sie suchen Fakten', 'Deswegen haben wir'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.ekiba.de/detail/nachricht-seite/id/35204-trauern-digital-am-ewigkeitssonntag/?default=true': {
    ...
    'date': '2021-12-12',
    'with': ['Gottesdiensten ihrer Gemeinden', 'Namen von Verstorbenen', ' und dazu laden wir herzlich ein'],  
    'without': ['Kirchengemeinde braucht klares Ziel“', 'Erlebnisraum Kirche', 'weitere Veranstaltungen ...'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.ekhn.de/aktuell/detailmagazin/news/ekd-papier-fordert-reform-der-pflegefinanzierung.html': {
    ...
    'date': '2021-11-12',
    'with': ['soziale Ordnung anhand', 'Bewährungstest des Sozialstaates', 'besser bewältigt werden'],  
    'without': ['zu diesem Thema', 'Pflege: Diakonie und', 'Gewalt'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.ekbo.de/themen/detail/nachricht/bischofswort.html': {
    ...
    'date': '2021-11-11',
    'with': ['zur Eröffnung der Schloßkirche', 'Bei der Erweiterung', '„Wir sind Kirche mit Geflüchteten'],  
    'without': ['Ähnliche Nachrichten', 'Livestream der Synode', 'Wort des Bischofs zur Herbstsynode'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.erzbistum-koeln.de/presse_und_medien/magazin/Totenmonat-November-Niemand-geht-allein/': {
    ...
    'date': '2021-11-08',
    'with': ['entschieden, ehrenamtliche Bestattungsbeauftragte', 'Pastoralreferenten sind schon', 'Niemand wird vergessen'],  
    'without': ['Bräuche zu Sankt Martin', 'ein Stadtteil von Neuss', 'Bestattungsbeauftragte Marianne Ricking'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://kath.net/news/76785': {
    ...
    'date': '2021-11-12',
    'with': ['da sammeln sich auch', 'hauptsächlich der orthodoxen', 'Die scheinbare Verherrlichung'],  
    'without': ['(Weihe-)Alter', 'Bistum Hildesheim: Das', 'meist-diskutiert'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.piratenpartei.de/2021/11/12/patrick-breyer-haugen-anhoerung-entlarvt-den-unwillen-der-eu-das-digitale-zeitalter-in-die-eigene-hand-zu-nehmen/': {
    ...
    'date': '2021-11-12',
    'with': ['„Haugen warnt, dass Facebooks', 'Die Anhörung der Facebook-Whistleblowerin', 'profitgetriebenen Konzernen anzuvertrauen'],  
    'without': ['Schreibe einen Kommentar', 'Meinen Namen, meine E-Mail-Adresse', 'Topthemen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://evang.at/lockdown-gottesdienste-bleiben-unter-strengen-auflagen-moeglich/': {
    ...
    'date': '2021-11-19',
    'with': ['in Pfarrgemeinden sollen als', 'seien alle Presbyterien dringend', 'Mit Verweis auf den Lockdown'],  
    'without': ['Foto: ccnull/Marco', 'Aus dem Evangelium', 'theologiebedürftig'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://www.katholisch.at/aktuelles/136290/alleinerziehende-kinderbetreuung-flaechendeckend-ausbauen': {
    ...
    'date': '2021-11-19',
    'with': ['anlässlich des internationalen', 'kostengünstigen, niederschwelligen und', 'Die Plattform für Alleinerziehende'],  
    'without': ['Einkommens sein', 'wie etwa Caritas-Lerncafés', 'Symposium des Akademikerverbands'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://www.evref.ch/oekumene-trifft-diplomatie-aussenminister-cassis-und-kardinalstaatssekretaer-parolin-besuchen-synode-der-eks/': {
    ...
    'date': '2021-11-08',
    'with': ['In ihren Grusswörtern', 'Cassis auf die parlamentarische', 'Präsidentin Rita Famos überreichte'],  
...
'https://www.livenet.ch/themen/gesellschaft/ethik/ethik/398805-von_sprachregeln_genderpolitik_und_ganz_normalem_deutsch.html': {
    ...
    'date': '2021-11-19',
    'with': ['dem Jakobsweg geschrieben!', 'die Journalistin, ob es', 'über Gender-Politik finden'],  
    'without': ['The Edge wurde 60', 'Dienstag 30.11.2021 in Baden', 'von Livenet in der'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.domradio.de/themen/laien/2021-11-19/reformstau-loesen-irme-stetter-karp-ist-neue-zdk-praesidentin': {
    ...
    'date': '2021-11-19',
    'with': ['votierten 41 Delegierte.', 'Für Reformen kämpfen', 'Stil des ZdK-Präsidiums.'],  
    'without': ['Logo des Zdk', 'Nach oben', 'Zentralkomitee der'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.kirche-und-leben.de/artikel/muensters-caritas-chef-kessmann-ist-gegen-impfpflicht-in-der-pflege': {
    ...
    'date': '2021-11-19',
    'with': ['Die Impfpflicht für die Pflege', 'Impfquoten mit zwischen', 'komme es trotz hohen'],  
    'without': ['Die Ignoranz der', 'können entscheiden', 'auf Corona-Tests vor'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://ditib.de/detail1.php?id=765&lang=de': {
    ...
    'date': '2021-10-16',
    'with': ['Mit seinen durch die Schwüre', 'Süden und vom Osten', 'Knappheit, sowie in Zeiten'],  
    'without': ['Nachrichten und Pressemeldungen', 'Botschaft', 'Twittern'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://islamische-zeitung.de/bundespraesident-sieht-radikalisierung-bei-querdenkern-und-corona-leugnern/': {
    ...
    'date': '2021-11-19',
    'with': ['eigenen Worten eine „zunehmende', 'Bundeskriminalamts im „föderalen Sicherheitsgefüge“', 'Verbindungen in weite Teile'],  
    'without': ['Schreibe einen Kommentar', 'Anzeige: Mehr lesen mit dem IZ+ Abo', 'Corona & die Folgen, Debatte'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.fisch-hitparade.de/magazine/alkohol-auf-dem-boot/': {
    ...
    'date': '2022-01-07',
    'with': ['sodass man dazu geneigt ist,', 'und der Führer des Wasserfahrzeugs', 'zwischen 0,5 und 1,09 werden als Ordnungswidrigkeiten'],  
    'without': ['Alkohol beim Angeln – Diskussion im Forum', 'Jetzt teilen!', 'Video: Achtung Kontrolle'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://anglerboard.de/ams/raubfisch-rute-im-test-die-iaconelli-spinning-rod.434/': {
    ...
    'date': '2022-01-21',
    'with': ['Classic-Gewinner Mike "IKE" Iaconelli', 'ist für jeden Spinnangler hier die', 'Zuerst ging es für mich aufs Boot, um'],  
    'without': ['Kategorie Catch more fish', 'Pulse Realistic Softbaits - wie echt!', 'Diesen Artikel teilen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://fischundfang.de/radical-pop-ups-und-dips/': {
    ...
    'date': '2022-01-28',
    'with': ['Kein Wunder – die Murmeln gibt', 'mit denen die Köder nochmal', 'Pop-Ups haben sich mittlerweile'],  
    'without': ['Radical Dips: "Bloody Chicken", "Smashed Fish', 'Matzes Zander Scheuche', 'mit Jörg Strehlow'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://fischerhuette.hejfish.com/anglertalk-mit-stephan-hoeferer/': {
    ...
    'date': '2022-01-07',
    'with': ['Zudem produziere er eigenständige', 'gibt es keine Angelpause im Jahr', 'Ich liebe meine Brandenburger Gewässer in ihrer'],  
    'without': ['Schreibe einen Kommentar', 'Das könnte dich auch interessieren:', 'Anglertalk mit'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://angelmagazin.de/fische-schmerzen/': {
    ...
    'date': '2022-01-12',
    'with': ['anatomischen Voraussetzungen für ein Schmerzempfinden', 'Fähigkeiten, d. h. sie können Umweltinformationen', 'Situation zum Bewusstsein beitragen.'],  
    'without': ['Über den Autor', 'zusätzlich noch einen Kaffee ', 'Angeln in Magdeburg'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.petri-heil.ch/de/bielerseewinterhechte--1026': {
    ...
    'date': '2022-01-26',
    'with': ['unterschätzter Zielfisch in der Schweiz', 'kalten Jahreszeit im Revier', 'kräftezehrend hochgedrillt werden'],  
    'without': ['Keine Kommentare', 'Faszination Bass', 'Unterwasser Angriff'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://mannschaft.com/benjamin-naessler-liebe-kennt-keine-pause-gegen-homophobie-in-katar/': {
    ...
    'date': '2022-01-28',
    'with': ['Petition heisst es: «Im Winter 2022', 'US-Bürger eine sechsmonatige Haftstrafe', 'Organisatoren zu verteidigen und die Bühne'],  
    'without': ['VIELLEICHT AUCH', 'Hans und Kosh', 'Coming-outs 2021'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://gay.ch/news/vatikan-eltern-sollen-queere-kinder-unterstuetzen-sagt-der-papst': {
    ...
    'date': '2022-01-28',
    'with': ['Obwohl sich gerade viele Gläubige', 'sorgte Papst Franzikus nun', 'Der Zickzack-Kurs der Katholischen'],  
    'without': ['Weitere Artikel zum Thema:', 'VATIKAN: Papst fordert', 'SCHWEIZ/ DEUTSCHLAND:'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.lsvd.de/de/ct/6520-Erste-Zusagen-fuer-Aufnahmen-von-ueber-80-LSBTI-aus-Afghanistan': {
    ...
    'date': '2022-01-20',
    'with': ['Wir begrüßen die mehr als 80 Aufnahmezusagen', 'vom Auswärtigen Amt bei der Familienzusammenführung', 'Situation verschiedener Personengruppen'],  
    'without': ['Pressesprecher*in Markus Ulrich', 'zuständiges Vorstandsmitglied', 'Der Lesben- und Schwulenverband (LSVD) ist'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.siegessaeule.de/magazin/p%C3%A4dophilie-als-politisches-machtinstrument/': {
    ...
    'date': '2022-01-28',
    'with': ['Dabei gab es dort keine Befürwortung', 'wie etwa die QAnon-Erzählung', 'Wir haben auch heute noch keinen Weg'],  
    'without': ['Peter Rehberg: „Schwule glauben, sich', 'KULTUR', 'Bild: Stefan Müller'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.l-mag.de/news-1010/holocaust-gedenktag-lesbische-erinnerungskultur-mit-stolpersteinverlegung.html?L=422': {
    ...
    'date': '2022-01-27',
    'with': ['Deutschland waren queere Opfer', 'Mit der Wahl von Dr. Hertha Kraus', 'international an der Integration von'],  
    'without': ['Weiterlesen:', 'Die aktuelle Ausgabe der L-MAG', ' von den Wirtschaftsweibern'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.maenner.media/gesellschaft/community/interview-mit-rainer-teuber-outinchurch/': {
    ...
    'title': 'Interview mit Rainer Teuber – 
    'date': '2022-01-24',
    'with': ['den Besucherservice. Er ist schwul', 'Was müsste sich in den Bistümern', 'Über das Rogate-Kloster: Eine'],  
    'without': ['HuK (Homosexuelle und Kirche)', 'Der Einsatz für die Menschenrechte ist', 'Kostenloser Download:'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.regenbogenportal.de/aktuelles/08112021-online-fachtag-zum-intersex-day-of-remembrance': {
    ...
    'date': '2021-11-08',
    'with': ['digitale Veranstaltung zum Thema', 'Für inter* Personen ist es wichtig', 'Familie, Senioren, Frauen und Jugend'],  
    'without': ['Newsletter abonnieren', 'Online-Fachtag zum Intersex', 'Anlaufstellen, Fachveranstaltungen und Materialien'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.falstaff.de/nd/burgenland-best-of-ruster-ausbruch-dac/': {
    ...
    'date': '2022-01-28',
    'with': ['Jahr 2020 ist dieses Juwel aus', 'Die sanften Hänge des Ruster Hügellands', 'Ruster Ausbruch DAC'],  
    'without': ['Mehr zum Thema', 'ERSCHIENEN IN', 'Rust am Westufer des'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.silkes-weinkeller.de/weinblatt-magazin/wein-dekantieren/': {
    ...
    'date': '2021-10-14',
    'with': ['Während die Trennung vom Depot', 'Die meisten Gefäße bestehen', ' Potenzial, den Genuss'],  
    'without': ['Wein zum Spargel:', 'Schreibe einen Kommentar', 'Inhaltsverzeichnis'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.deutscheweine.de/aktuelles/meldungen/details/news/detail/News/rieslingbirthday-posts-gewinnen/': {
    ...
    'title': '
    'date': '2022-01-27',
    'with': ['Es gibt zahlreiche "erste" Erwähnungen', 'zeigen die Verwandtschaft mit Wildreben', 'Instagram-Posts mit dem hashtag'],  
    'without': ['MELDUNGEN AUS DEM DWI', 'Downloadbereich', 'UNSERE APP DEUTSCHE WEINE IM APPSTORE'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.meininger.de/wein/erzeuger/lvmh-mit-ordentlichem-wachstum': {
    ...
    'date': '2022-01-28',
    'with': ['meldet für 2021 einen Umsatz von 64,2', 'Wichtige Brands sind etwa die Champagnermarken', 'Joint Venture Cheval des Andes'],  
    'without': ['Unsere neue Rubrik. Zum Auftakt fragen', 'Italien-Fans alles, was das Herz begehrt', 'Sektkellerei am'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.weinkenner.de/st-magdalener-rotweine-mit-eleganz-und-charakter/': {
    ...
    'date': '2022-01-27',
    'with': ['Italiens, neben Barolo und Barbaresco', 'St. Magdalener überzeugen mit zarter Frucht', 'ernatschwein, der vom Gambero'],  
    'without': ['Über den Autor', 'Südtiroler Weissweine die Geschichte schrieben', 'Das ideale Universal-Weinglas'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.alacarte.at/reisen/der-historische-purzelbaum-20215/': {
    ...
    'date': '2021-11-25',
    'with': ['Leipzig war, widerfuhr mir etwas Merkwürdiges', 'Menschen umfassende Saal bis auf', 'anderswo kennengelernt hatte, und'],  
    'without': ['Milchbar Pinguin', 'In Auerbachs Keller tafelten Faust und Mephisto', 'SHARE'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://www.umweltbundesamt.de/themen/eu-taxonomie-atomkraft-erdgas-sind-nicht-nachhaltig': {
    ...
    'date': '2022-01-25',
    'with': ['Entwurf der Europäischen Kommission für einen', 'denn die Entsorgung', 'Energien auszubauen und Technologien'],  
    'without': ['Die Auswertung der Stimmen beansprucht einige Zeit.', 'Quelle: jorisvo / Fotolia.com', 'Greenwashing'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bmwi.de/Redaktion/DE/Meldung/2022/20220124-foerderung-fur-energieeffiziente-gebaude-durch-kfw.html': {
    ...
    'date': '2022-01-24',
    'with': [' EH55 Neubauförderung hat', 'wieder aufgenommen, sobald', 'Über die Zukunft der Neubauförderung'],  
    'without': ['Verwandte Themen', 'Europäische und internationale Energiepolitik', 'MEDIENRAUM'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
...
'https://www.bmas.de/DE/Service/Presse/Meldungen/2022/aenderung-der-anforderungen-an-impf-und-genesenennachweisen.html': {
    ...
    'date': '2022-01-26',
    'with': ['Das Robert-Koch-Institut (RKI) wurde beauftragt', 'Anforderungen an 3G-Nachweise ggf.', 'wieder den Status "vollständig geimpft"'],  
    'without': ['FAQs Betrieblicher Infektionsschutz', 'Fragen zum Thema Betrieblicher Infektionsschutz.', 'NACH OBEN'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bmfsfj.de/bmfsfj/aktuelles/alle-meldungen/bundeskabinett-legt-schwerpunkte-der-praesidentschaft-fest-192440': {
    ...
    'date': '2022-01-21',
    'with': ['Gruppe der Sieben verständigt', 'Am 1. Januar hat Deutschland turnusgemäß', 'ein starkes Miteinander.'],  
    'without': ['G7 Germany 2022: Informationen zur', 'Internationales und Europa', 'Bundesregierung/Steffen Kugler'],  
    'comments': [],  
    'license': '',  
    'region': '',  
},
'https://www.bfs.de/SharedDocs/Pressemitteilungen/BfS/DE/2022/001.html': {
    ...
    'date': '2022-01-25',
    'with': ['richtet sich an alle, die sich über die Radon-Situation', 'darüber hinaus bereits vorhandene Messdaten', 'nur mit einer Radon-Messung im Boden'],  
    'without': ['Was ist Radon?', 'Radon in der Boden-Luft in Deutschland', 'Wie bewerten Sie diesen Artikel?'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bmbf.de/bmbf/shareddocs/pressemitteilungen/de/2022/01/260122-Directions.html': {
    ...
    'date': '2022-01-26',
    'with': ['Mit dem Forschungsprojekt legen wir dafür den Grundstein.', 'Mit Hilfe eines Gütesiegels (Stufe I) und', 'Datenschutzzertifizierung für'],  
    'without': ['Mediathek', 'Pressemitteilungen', 'Pressemitteilungen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bsi.bund.de/DE/Service-Navi/Presse/Pressemitteilungen/Presse2022/220128_Forschungsprojek-KI-Auto_BSI-ZF.html': {
    ...
    'date': '2022-01-28',
    'with': ['orteile von KI-Systemen in der Mobilität', 'Anforderungen, Methoden und Werkzeuge', 'KI-Systemen in Autos nach allgemein'],  
    'without': ['Verbraucherinnen und Verbraucher', 'IT-SICHERHEITSVORFALL', 'FOLGEN SIE UNS'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bmel.de/DE/themen/laendliche-regionen/zukunftsforum2022.html;jsessionid=ED5DD5866BE5A5FAA71D389A9C6A5802.live922': {
    ...
    'date': '2022-01-26',
    'with': ['Bürgerschaftliches Engagement und Ehrenamt', 'Zwei Tage wurde darüber diskutiert,', 'Ehrenamtliche in ländlichen Regionen.'],  
    'without': ['Gestalten, anstatt zu spalten: Ehrenamtliche', 'Kommission Gleichwertige', 'Rückblick: Das 14. Zukunftsforum Ländliche'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bka.de/DE/Presse/Listenseite_Pressemitteilungen/2022/Presse2022/220126_PM_Telegram.html': {
    ...
    'date': '2022-01-26',
    'with': ['entwickelt sich nach Einschätzung der', 'BKA gemeinsam mit den Landeskriminalämtern', 'Corona-Pandemie hat dazu beigetragen'],  
    'without': ['Pressemitteilung als PDF', 'Haben Sie das Gesuchte nicht', 'Neue Taskforce des Bundeskriminalamtes'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bundesrat.de/SharedDocs/texte/22/20220127-weremember-gedenkstunde-kranzniederlegung.html;jsessionid=FD52ED97F4C3551B332D2AA670DAE45C.1_cid382':{
    ...
    'date': '2022-01-27',
    'with': ['wurde als Siebenjährige von Stuttgart', 'Neben der gastgebenden Bundestagspräsidentin', 'als Zeichen des Gedenkens an die Opfer'],  
    'without': ['Presse- und Informationsamt der Bundesregierung | Jesco Denzel', ' Bundesrat | Frank Bräuer', 'Ist dieser Beitrag hilfreich?'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bmz.de/de/aktuelles/aktuelle-meldungen/schulze-deutschland-an-der-der-seite-wfp-im-kampf-gegen-hunger-103026': {
    ...
    'date': '2022-01-25',
    'with': ['tragen auch der Klima­wandel', 'Fast fünf Millionen Menschen', 'Alleine im letzten Jahr'],  
    'without': ['Sonderinitiative EINEWELT', 'SDG 2: Kein Hunger', 'Siehe auch'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.mein-haustier.de/hund/eat-small/': {
    ...
    'date': '2022-01-28',
    'with': ['Nachhaltigkeit ist heutzutage ein wichtiges Thema', 'Ressourcen benötigen, sind sie', 'Alleinfutter für alle etwas ruhigeren Hunde'],  
    'without': ['Energy Snack', 'Ähnliche Artikel', 'WALD Nassfutter'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.tierwelt.ch/news/natur-umwelt/immer-mehr-modemarken-werden-pelzfrei-so-erkennen-sie-echtpelz-im-laden': {
    ...
    'date': '2022-02-02',
    'with': ['Waschbären oder Hunde unter schlechten', 'Fell aus einer Zucht oder gezieltem Wildfang', 'Sind die Haarspitzen sichtbar'],  
    'without': ['übergeben worden ist.', 'Pelzdeklarationskontrolleure haben im vergangenen', 'Die aktuelle Ausgabe'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.martinruetter.com/service/aktuelles/aktuelles/schneefloeckchen-weissroeckchen-mit-hund-im-winter/': {
    ...
    'date': '2022-01-27',
    'with': ['Spaziergang in geschlossener Schneedecke', 'Müssen Hunde im Winter auch Schneeschuhe', 'Wichtig bei allen Trainingsstunden'],  
    'without': ['Martin Rütter DOGS', 'Umgang mit dem', 'HUNDESCHULEN'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://tierschutz-berlin.de/aktuelles/tierschutzverein-ruft-zu-boellerverzicht-auf/': {
    ...
    'date': '2021-12-29',
    'with': ['Vorstandsvorsitzende Eva Rönspieß.', 'ihre Lieblinge möglichst gut gegen', 'Silvesternacht gerade in Stadtrandbezirken'],  
    'without': ['Tierschutzverein für Berlin und Umgebung', 'Bank für Sozialwirtschaft', 'Hausvaterweg 39'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.haustiermagazin.com/kaufratgeber-vergleich-bestes-elektronisches-katzenspielzeug/': {
    ...
    'date': '2022-02-01',
    'with': ['haben uns deshalb verschiedene elektrische', 'Welches Spiel zu deiner Mieze passt', 'elektrisches Katzenspielzeug bereits'],  
    'without': ['TIPPS, HILFE UND SCHNÄPPCHEN', 'Bei den Verlinkungen handelt es sich um', 'drei Kater und aktuell zwei portugiesische'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.eurosport.de/olympia/olympia-2022-in-peking/2022/olympia-2022-zweiter-coronafall-deutschen-team-aufregung-thomas-weikert-vorganger-attackiert_sto8749554/story.shtml': {
    ...
    'date': '2022-02-02',
    'with': ['Alfons Hörmann seinen Nachfolger Thomas', 'die Defensive. Kurz vor der Eröffnungsfeier', 'Athlet oder Betreuer, sitzt symptomfrei mit einem'],  
    'without': ['LETZTE NEWS', 'DOLL "BEIM ERSTEN MAL LOCKERER"', 'NÄCHSTES DEUTSCHES TEAMMITGLIED'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.laola1.at/de/red/fussball/bundesliga/news/rapids-barisic-geschlaucht---dann-hau--ich-mein-handy-zam-/': {
    ...
    'date': '2022-02-02',
    'with': ['Business wird immer schnelllebiger', 'Kampfmannschaft gekommen sind, die aus unserer Akademie', 'Die Corona-Pandemie sorgt nicht nur für sportliche'],  
    'without': ['Status quo: Das passiert noch beim SK Rapid', 'Action! Anna Gasser im Olympia-Interview', 'WAC: "Handschrift von Dutt verinnerlicht"'],  
    'comments': ['Wieviele Rapid Artikel kommen heute', 'Schaust mal wie viele Reaktionen es', 'Hauptsachen schwurbeln - oder?'],  
    'license': '',  
    'region': 'DE',  
},
'https://www.sportnews.bz/artikel/wintersport/wintersport-mix/peking-sucht-den-superstar-7-moegliche-gesichter': {
    ...
    'date': '2022-02-02',
    'with': ['bereits zur jüngsten Slalom-Olympiasiegerin', 'Gu gilt als Musterschülerin, sie ist Stanford', 'bisher allerdings nicht optimal gelaufen'],  
    'without': ['AFP / MARCO BERTORELLO', 'So viel verdienen Lkw-Fahrer in Berlin', 'Tausende Hausbesitzer'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.munich2022.com/de/europas-topathleten-fit-fur-munchen-2022': {
    ...
    'date': '2022-01-31',
    'with': ['Weltjahresbestleistung von 6,02 m', 'dass ich viel Selbstvertrauen habe,', 'dass ich viel Selbstvertrauen habe,'],  
    'without': ['Getty Images', 'Externer Inhalt', 'Tags'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.golfpost.de/golf-im-tv-777789172/': {
    ...
    'date': '2022-01-31',
    'with': ['Nach zuvor zwei Rolex-Series-Events', 'Kalifornien, die DP World Tour', 'Deutsche um Max Kieffer, Matti Schmid'],  
    'without': ['Jetzt für Golf-Lotse Top-News anmelden', 'News rund um PGA Tour', 'Überblick. (Foto: Getty)'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.golf.de/i7484_1.html': {
    ...
    'date': '2022-02-01',
    'with': ['Weg dorthin war für den in Dallas geborenen', 'Blickt man auf Elders Werdegang', 'Zocker und Wettliebhaber arbeitete'],  
    'without': ['Nicklaus – Mann der großen Worte', 'Mehr zum Thema', 'Augusta National/Getty Images'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.motorsport-total.com/formel-1/news/nach-erstem-f1-test-2022-alfa-romeo-plant-spaeten-launch-des-c42-22020203': {
    ...
    'date': '2022-02-02',
    'with': ['Team bestätigte am Mittwoch, dass sein neues Auto', '25. Februar auf dem Circuit de Barcelona-Catalunya', 'Giovinazzi und werden versuchen'],  
    'without': ['Was kostet eine Solaranlage', 'Lada Niva Monster: Russlands', 'auf dem Formel-1-Auto für 2022'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.motorsport-magazin.com/formel1/news-275350-formel-1-fahrercheck-alphatauri-das-koennen-pierre-gasly-yuki-tsunoda-f1-2022/': {
    ...
    'date': '2022-02-02',
    'with': ['beginnt das Jahr mit einem Fahrer-Formcheck', 'Fehltritte ein, die hin und wieder auch große Konsequenzen haben.', 'zeigt, ist, dass er gelegentlich Gefahr'],  
    'without': ['Formel 1 - Pierre Gasly', 'mischt Top-Teams', 'Motorsport-Magazin.com Redakteur'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.autosprint.ch/de/classic/histo-monte-pistenstopp-in-rheinfelden/': {
    ...
    'date': '2022-01-31',
    'with': ['Histo-Monte stehen gut. Die', 'gesperrte historische Stadtbrücke benutzten', 'früherer Veranstaltungen zur Verfügung'],  
    'without': ['Beiträge zum Thema', 'Respekt vor dem', 'Erinnerung an den'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.eishockeynews.de/aktuell/artikel/2022/02/01/zweimal-kuusela-im-powerplay-und-ein-konter-muenchen-verliert-bei-tappara-tampere-mit-0-3-und-verpasst-das-chl-endspiel/c90d406b-2b41-4e98-b9cd-4aa661e512b2.html': {
    ...
    'date': '2022-02-01',
    'with': ['Tappara ging dabei bereits nach rund', 'sowie die bessere Struktur. So', 'Saison 2021/22 und damit den Nachfolger'],  
    'without': ['DAS KÖNNTE SIE AUCH INTERESSIEREN', 'Wenn du Zeit am Computer', 'Schwenningen, Landshut oder'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.skispringen.com/marita-kramer-verpasst-olympische-spiele-in-peking/': {
    ...
    'date': '2022-02-01',
    'with': ['Spiele in Peking werden ohne die große Top', 'Ich habe so viel Energieund Zeit investiert', 'die Einzel-Entscheidung auf'],  
    'without': ['Über Luis Holuch', 'Ryoyu Kobayashi gewinnt die 70.', 'NATIONENCUP 2021/2022'],  
    'comments': ['der WM haben sie genau vor Ihr verkürzt','Du bist dann erst 24/25 und kannst Olympiasiegerin','werden folgen, egal von welcher'],  
    'license': '',  
    'region': 'DE',  
},
'https://berkutschi.com/de/front/news/10759-marius-lindvik-gewinnt-in-willingen': {
    ...
    'date': '2022-01-31',
    'with': ['und dem Slowenen Cene Prevc durch', 'zu den Top-Favoriten auf Olympisches', 'Olympischen Spiele am'],  
    'without': ['Wettkampfdaten', 'Weltcup Herren', 'Weitester Sprung'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.handball-world.news/o.red.r/news-1-1-1-139353.html': {
    ...
    'date': '2022-02-02',
    'with': ['Jahre zum Handball Sport', 'Lippe und die SG Flensburg-Handewitt', 'Erinnerungen an Hamburg'],  
    'without': ['Eine Tasse davon', 'nimmt...', '"Waren vier'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.handball.ch/de/news/2022/cup-vorschau-beim-bsv-stans-freut-man-sich-auf-ein-bruderduell-und-viele-fans/': {
    ...
    'date': '2022-02-02',
    'with': ['Ich glaube fest daran, dass wir die Halle füllen', 'spezielle Affiche. Mit Daniel', 'mit Spannung erwarteten Viertelfinals HSC'],  
    'without': ['Gemeinsam den Verein', 'DAS KÖNNTE DICH', 'HSC Kreuzlingen in die'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.liquimoly-hbl.de/de/n/news/2--liga/2021-22/transfers/tsv-bayer-dormagen/neuer-cheftrainer-fuer-dormagen--matthias-flohr-uebernimmt-ab-sommer-2022/': {
    ...
    'date': '2022-01-31',
    'with': ['mit einer bestens motivierten Mannschaft den', 'Haases breitem Netzwerk. Auch heimische', 'aber ich habe ein gutes Gefühl'],  
    'without': ['Verwandte Themen', 'Coburg', '
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.dhb.de/de/redaktionsbaum/nationalteams/a-frauen/erneuter-verzicht-auf-regionallehrgang-/': {
    ...
    'date': '2022-02-02',
    'with': ['im März beginnen. Teil der Maßnahme', 'HBF und Liga können die freigewordenen', 'Nationalmannschaft im März mit'],  
    'without': ['NEWS', 'Foto: Sascha Klahn', 'A-FRAUEN'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.rhein-neckar-loewen.de/kleiner-vorverkauf-fuer-liga-heimspiele-gestartet-920981': {
    ...
    'date': '2022-02-02',
    'with': ['können die Rhein-Neckar Löwen lediglich', '12. Februar, 20.30 Uhr treffen die Löwen', 'sollte sich die erlaubte Zuschauer-Kapazität'],  
...
'https://www.hvw-online.org/aktuell/detail/news/zuschauerrueckkehr-bei-den-proficlubs-der-region': {
    ...
    'date': '2022-02-02',
    'with': ['Heimspiele keine Tickets zu erwerben.', 'Göppingen und den TVB Stuttgart geht', 'Beachtung der 2G+-Regelung'],  
...
'https://www.biathlonworld.com/de/news': {
    ...
    'date': '2022-02-02',
    'with': ['kam die chinesische Damenstaffel viermal', 'BMW IBU Weltcupgesamtwertung', 'und eine solide Basis für die Weiterentwicklung'],  
    'without': ['BEIJING 2022 - CHINA STORY', 'ABONNIERE UNSEREN NEWSLETTER', 'OLYMPISCHE WINTERSPIELE'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.biathlon-antholz.it/de/newsroom/23-01-2022-dorothea-wierer-darf-beim-antholz-abschluss-noch-jubeln/17-378.html': {
    ...
    'date': '2022-01-23',
    'with': ['beim letzten Weltcuprennen schlug', 'Biathlon-Tross pausiert jetzt knapp', 'die trotz Corona, gut verlaufen'],  
    'without': ['ZURÜCK ZUR LISTE', 'MIT FREUNDEN TEILEN', 'DAS KÖNNTE SIE AUCH'],  
    'comments': [],  
    'license': '',  
    'region': 'IT',  
},
'https://www.leichtathletik.de/news/news/detail/76066-erfurt-maximilian-thorwirth-ueberrascht-auf-1500-meter-distanz': {
    ...
    'date': '2022-02-01',
    'with': ['mit zwei Topzeiten ihre gute Form', 'hätte ich mit dieser Zeit nicht gerechnet.', 'Karlsruhe kam Imke Onnen (Hannover 96)'],  
    'without': ['Bildergalerie', 'WEITERE NEWS', 'Trauer um Henning von Papen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.leichtathletik-berlin.de/pressemitteilungen_reader/norddeutschland-sucht-seine-meister.html': {
    ...
    'date': '2022-01-31',
    'with': ['Goldrausch auf den 1500 Metern', 'Altersklasse souverän auf den 60m', 'den 2. Platz erreichen.'],  
    'without': ['Gisele Wender', 'Sponsoren', 'Pressemitteilungen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.flvw.de/news/detail/joana-herrmann-fliegt-bei-den-flvw-hallenmeisterschaften-ueber-178-meter/': {
    ...
    'date': '',
    'with': ['Eine Woche nach seinem Titelgewinn', 'Sekunden bedeutet für sie eine', 'dreimal vergeblich an 1,80 Meter'],  
    'without': ['Themenrelevante Nachrichten', 'Dreisprung auf 13,93 Meter', 'im Kugelstoßen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.boxen.de/news/viviane-obenauf-staatsanwaltschaft-hat-beweise-vorgelegt-70501': {
    ...
    'date': '2022-02-02',
    'with': ['Das wurde abgelehnt, weil die Beweislage', 'Chevrolet Camaro zur Tatzeit vor dem Apartment', 'Tatzeit zuhause gewesen zu sein'],  
    'without': ['Ähnliche Beiträge', 'Tyson Fury vs Dillian Whyte wird von', 'Trevor Bryan siegt über Jonathan Guidry'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.boxen1.com/morgen-abend-chris-eubank-jr-mit-ring-rueckkehr-gegen-liam-williams-60586/': {
    ...
    'date': '2022-02-04',
    'with': ['Wochenende wieder in den Ring. Der', '„Gegen mich wird er den Schlussgong', 'Monaten offizieller Pflichtherausforderer.'],  
    'without': ['BOXEN1-Award: Das sind Boxer, Boxerin,', 'Promoter des Jahres 2021', 'Chris Eubank Jr.'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.spox.com/de/sport/olympia/2202/Artikel/zwei-corona-faelle-olympische-spiele-peking-eric-frenzel-terence-weber.html': {
    ...
    'date': '2022-02-04',
    'with': ['Kombinierer waren am Tag zuvor in China', 'besten sieben Athleten des Gesamtweltcups', 'November im finnischen Ruka den ersten Weltcupsieg'],  
    'without': ['Die Nordischen Kombinierer Terence Weber', 'Gegen Peking: Tibeter protestieren vor IOC-Hauptquartier', 'Olympia 2022 - Nordische Kombination:'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.tennisnet.com/news/diese-ymers-zwei-ueberraschungen-an-einem-tag': {
    ...
    'date': '2022-02-04',
    'with': ['Montpellier für zwei Überraschungen gesorgt', 'Drei-Kronen-Team wieder einmal Gesprächsthema', 'Mann am Start, der nach seinem frühen'],  
    'without': ['Hier das Einzel-Tableau in Pune', 'ATP: Aufschlag-Hüne Milos Raonic fällt', 'Berlin: GEERS sucht 700'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.tennismagazin.de/news/zverev-zieht-ins-viertelfinale-von-montpellier-ein/': {
    ...
    'date': '2022-02-04',
    'with': ['besaß der mit einer Wildcard ausgestattete', 'Niederlage gegen Jonathan Erlich/Edouard', 'Achtelfinal-Aus gegen Denis Shapovalov'],  
    'without': ['Alexander Zverev steht im Viertelfinale des ATP-Turniers', 'AUCH AUF TENNISMAGAZIN.DE', 'Ein Kommentar von tennis'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.btv.de/de/spielbetrieb/news/auf-den-spuren-von-rafael-nadal.html': {
    ...
    'date': '2022-02-03',
    'with': ['Februar 2022 in der TennisBase Oberhaching', 'und diesmal sogar in der dritthöchsten', 'findet am kommenden Wochenende'],  
    'without': ['Weitere Infos unter www.itfjuniors.de.', 'Liam Gavrielides', 'PARTNER'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.oetv.at/news/artikel/d/erfolgreiches-masters-debuet-fuer-taucher-2.html': {
    ...
    'date': '2022-02-02',
    'with': ['Rollstuhlclub ENJO Vorarlberg erneut', 'Nachwuchssportler ging es dabei bereits einige Tage', 'Im Match Tiebreak hatten die Engländer'],  
    'without': ['Top Themen der Redaktion', 'Weltspitze der Junioren angekommen. (Foto: Privat)', 'feierte indes in der vergangenen Woche internationale'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.dtb-tennis.de/Tennis-International/Davis-Cup/News-Features/Davis-Cup-Qualifiers-Kohlmann-nominiert-zwei-Neulinge': {
    ...
    'date': '2022-02-04',
    'with': ['Michael Kohlmann hat die Mannschaft für die Davis Cup-Qualifiers', 'Dass auch Kevin Krawietz und Tim Pütz mit ihrer makellosen', 'Gespielt werden Dreisatz-Matches mit'],  
    'without': ['Kohlmann: „Als nächstes gewinnen wir den Davis Cup“', 'ZURÜCK NACH OBEN ', 'DTB nominiert Porsche Nachwuchsteams für 2022'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.dsv.de/synchronschwimmen/aktuelles-synchronschwimmen/lesen/?tx_ttnews%5Btt_news%5D=5793&cHash=36febeba61a32f5c94f98d8f59efb32e': {
    ...
    'date': '2022-02-01',
    'with': ['also, dass die filigranen Meerestiere als', 'Die Kosten für den Levelpass belaufen', 'dokumentiert. „So haben die Kinder auch etwas'],  
    'without': ['UNSERE PARTNER - SYNCHRONSCHWIMMEN', 'KOMMENDE EVENTS', 'TERMINE / AUSSCHREIBUNGEN'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://swim.de/training/lagen-pyramide-mit-ga2/': {
    ...
    'date': '2022-02-03',
    'with': ['Wählen Sie Übungen, bei denen Sie sich', 'vierten Stufe dürfen Sie entscheiden,', 'Hälfte der Teilstrecke in'],  
    'without': ['studierte Sportwissenschaften, bevor', 'Starker Serienauftakt in der', 'Wenn du auf den Abo-Button klickst, verpasst'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://schwimmverband.at/news-artikel tx_news_pi1%5Baction%5D=detail&tx_news_pi1%5Bcontroller%5D=News&tx_news_pi1%5Bnews%5D=2236&cHash=892ac1491204c09aa3b2f080298e0218': {
    ...
    'date': '2022-02-01',
    'with': ['Wochen kolportiert wurde, ist', 'verschoben werden müssen.', 'Möglichkeiten für Wettkämpfe auf höchstem'],  
...
'https://www.dtb.de/weitere-nachrichten/nachrichten/artikel/massnahmen-umgesetzt-und-kulturwandel-angestossen': {
    ...
    'date': '2022-02-03',
    'with': ['Verantwortlichen Zeit, eine erste Bilanz zu ziehen', 'Präventions- und Interventionskonzept zum Schutz', 'die Ergebnisse aus verschiedenen Perspektiven'],  
    'without': ['Weiterführende Links', 'Kultur- und Strukturwandel im DTB – ein Zwischenfazit', 'Weitere Informationen hierzu gibt es in Kürze auf der Website des'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.st-georg.de/news/mehr-sport/pferdesport-definitiv-bei-olympia-2028-dabei/': {
    ...
    'date': '2022-02-04',
    'with': ['Dezember kam die Meldung, dass Reiten', 'Sportarten dort zu sehen sein werden. Reiten ist', 'für die Umwelt und die Frage, ob der Sport'],  
    'without': ['Tschüss, Bauchfett!', '(FEI/Christophe Taniere)', 'OLYMPISCHE SPIELE'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.reiterrevue.de/ausbildung-und-praxis/fuetterung/heulage-besser-als-ihr-ruf-12842649.html': {
    ...
    'date': '2022-02-03',
    'with': ['Pferdefutter einen weniger guten Ruf.', ',die die Heulage haltbar machen, die natürli', '„atmen“ und gammelt schnell.'],  
    'without': ['Heu ist die Grundlage einer', 'und Schimmelpilze. Was Sie bei', 'DAS PERFEKTE DINNER'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.pferderevue.at/aktuelles/ausbildung/2022/schluss-mit-poltern--vier-uebungen-fuer-einen-geschmeidigen-sitz.html': {
    ...
    'date': '2022-01-27',
    'with': ['poltert’s bei Ihnen beim Aussitzen?', 'Pferde selbst in den schwierigsten', 'Kursen im In- und Ausland gemacht hat. Dieses'],  
    'without': ['Große Beckenkreise (links) stabiliseren,', 'Bei der Beckenkippung nach hinten sinkt der Brustkorb ein', 'Das Buch & der Online-Lehrgang zum'],  
    'comments': [],  
    'license': '',  
    'region': 'AT',  
},
'https://www.pferd-aktuell.de/news/aktuelle-meldungen/zucht/stellungnahme-der-fn-zum-hlp-pilotjahr-2022': {
    ...
    'date': '2022-02-04',
    'with': ['Bereits seit Jahren haben sich die Zuchtverbände', 'Pferde altersgemäß stattfindet und im Einklang', 'Veranlagungsprüfung von Hengsten der deutschen'],  
    'without': ['zurück zur vorherigen Seite', 'HLP: Zuchtverbände planen 2022 als Pilotjahr', 'TSF Dalera BB: Tänzerin im'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.natuerlich-jagd.de/allgemein/neue-djv-online-seminare/': {
    ...
    'date': '2022-02-03',
    'with': ['Umgang mit den sozialen Medien sowie', 'Wie müssen Texte und Fotos dafür', 'tätige Presseobleute aus den'],  
    'without': ['Quelle: Deutscher Jagdverband (DJV)', 'Neue DJV-Online-Seminare starten im März', 'Folgen Sie uns'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.eurailpress.de/nachrichten/unternehmen-maerkte/detail/news/hafen-goeteborg-umschlag-auf-rekordniveau.html':{
    ...
    'date': '2022-02-04',
    'with': ['Bahnshuttles zurückzuführen, die den Hafen', 'Der Hafen rechnet wegen des Ausbaus des', 'unter anderem auf die Einführung'],  
    'without': ['Redaktion Eurailpress', 'Artikel', 'Unternehmen & Märkte'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://aerobuzz.de/militar/cae-bildet-kuenftig-luftwaffen-piloten-in-bremen-aus/': {
    ...
    'date': '2022-02-04',
    'with': ['GmbH hat sich bei der Ausschreibung', 'Bremen am Flughafen ein neues Trainingszentrum', 'Industriepartner die Flugzeuge und die'],  
    'without': ['Schon gelesen?', 'Die CAE GmbH wird Nachwuchspiloten', 'Luftwaffe hat mit dem Training auf den H145 von NHV begonnen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.autohaus.de/nachrichten/autohandel/vda-chefin-mueller-das-autohaus-ist-alternativlos-3126349': {
    ...
    'date': '2022-02-03',
    'with': ['den stationären Handel weiter', 'geht in vielen Bereichen Richtung', 'Das begrüßen wir ausdrücklich, damit ist dann'],  
    'without': ['Lesezeit: 4 min 1 Kommentare', 'Hildegard Müller, Präsidentin des Herstellerverbandes VDA', 'DAT-Report – wichtiges Planungsinstrument'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.gruene-bundestag.de/themen/biologische-vielfalt-naturschutz/natuerlicher-klima-und-artenschutz': {
    ...
    'date': '2022-02-01',
    'with': ['Überschwemmungen gleichermaßen vor.', 'trat 1975 in Kraft. Die Bundesrepublik', 'Bewirtschaftung. Das kostet zweifellos'],  
    'without': ['Ähnliche Beiträge', 'Hohe Energiepreise durch Gas und Kohle', 'Bild von Michael Gaida auf Pixabay'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.feuerwehrverband.de/dfv-auf-der-vorbereitungstagung-der-interkulturellen-woche/': {
    ...
    'date': '2022-02-04',
    'with': ['bundesweite Vorbereitungstagung der Interkulturellen', 'Geplant sind unter anderem Workshops', 'Die eigentliche Interkulturelle Woche'],  
    'without': ['DFV-Experte Carsten Schneider', 'DFV und DJF bei 4.', 'Trauer um Polizeiangehörige in'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.erzbistum-koeln.de/presse_und_medien/magazin/Blasius-Segen-Schutz-vor-Halskrankheiten/': {
    ...
    'date': '2022-01-26',
    'with': ['der bekanntesten Legende soll', 'ab dem Vorabend des Gedenktages des hl. Blasius', 'Gott Mensch geworden ist, will uns'],  
    'without': ['Radiobeitrag zum Blasius-Segen', 'Der Valentinstag am 14. Februar ist der', 'Live-Übertragungen der Hl.'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.bundeskanzleramt.gv.at/bundeskanzleramt/nachrichten-der-bundesregierung/2022/02/bundesministerin-raab-mit-Laendern-und-unternehmen-frauen-und-familienfreundliche-rahmenbedingungen-gestalten.html': {
    ...
    'date': '2022-02-01',
    'with': ['damit Mütter selbstverständlich', 'bei der Vereinbarkeit von Beruf', '"dass wir einen großen Gap bei den'],  
...
'https://www.be.ch/de/start/dienstleistungen/medien/medienmitteilungen.html?newsID=c3aa546f-24d3-4b47-9c0c-59db58b2f725': {
    ...
    'date': '2022-02-08',
    'with': ['daher die zusätzlich aufgebauten Impforte', 'schwere Krankheitsverläufe zu schützen.', 'eine Kartenansicht umgestellt werden.'],  
    'without': ['Seite teilen', 'Inhalt', 'Zurück zur Übersicht'],  
    'comments': [],  
    'license': '',  
    'region': 'CH',  
},
'https://www.mix1.de/music/leslie-clio/brave-new-woman/': {
    ...
    'title': 'Leslie Clio',
    'date': '2022-02-04',
    'with': ['Zuvor hatte die Sängerin und Songschreiberin', 'Clio präsentiert das Album', 'bisherigen Karriere geschrieben.'],  
    'without': ['amazon Tipp: Nutzen Sie die Musik', 'Tracklist / Infos', 'Sie möchten wöchtliche Produktvorstellungen?'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.spoe.at/2022/02/04/automatische-mieterhoehung-verhindern/': {
    ...
    'date': '2022-02-04',
    'with': ['April zusätzlich aufgrund einer', 'das sind pro Jahr über 500 Euro an Mehrkosten', 'Wohnverhältnisse sollen als Ausnahme'],  
    'without': ['Wohnen', 'nicht noch zusätzlich', 'Preise für das tägliche'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.gitarrebass.de/dm-native-advert/gitarre-bass-02-2022/': {
    ...
    'date': '2022-02-24',
    'with': ['Und hat einen neuen Signature-Amp', 'hat sich Matthias Mineur mit ihm', 'Vintage-Fender-Telecaster,'],  
    'without': ['Alles Gute zum neuen Jahr', 'Schreibe einen Kommentar', 'AKTUELLE AUSGABE'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.peta.de/neuigkeiten/veterinaeraemter-2021/': {
    ...
    'date': '2022-02-08',
    'with': ['für die Überwachung und den', 'immer die gesamte Behörde', 'Unterschreiben Sie unsere Petition'],  
    'without': ['1. Kreisveterinäramt', 'VERWANDTE ARTIKEL', 'Alle Blogbeiträge zu unseren'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.onmeda.de/krankheiten/coronavirus/paxlovid-id212627/': {
    ...
    'date': '2022-01-28',
    'with': ['durch das Coronavirus. Erfahren Sie', 'Präparat namens Molnupiravir brachte', 'Menschen mit einem erhöhten Risiko'],  
    'without': ['Dieser Text entspricht den', 'Covid-19 oder Grippe?', 'Tschüss, Bauchfett! Hilfe'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.macwelt.de/ratgeber/iPhone-14-Warum-sich-das-Warten-wirklich-lohnt-11153570.html': {
    ...
    'date': '2022-02-04',
    'with': ['Unternehmen auf Features, die wir durchaus', 'Frontkamera setzen, wie der Experte Ross Young', 'Eine Periskop-Kamera findet sich bereits'],  
    'without': ['Shopping24 Angebot', 'Eine kleine runde Aussparung für die Facetime-Kamera', 'Eine kleine runde Aussparung'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.dhz-online.de/de/news/detail/artikel/schwangere-zu-mehr-bewegung-motivieren/': {
    ...
    'date': '2022-02-07',
    'with': ['schlussfolgern aus ihren Daten, dass körperliche', 'Schwangerschaft sollte geschärft werden.', 'durchgeführt wurden waren Bummeln'],  
    'without': ['Weitere Meldungen aus', 'Alle Meldungen der Rubrik', 'Sylter Hebammen-Notruf wieder erreichbar'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://guten-tach.de/dgb-brueckensperrung-belegt-die-versaeumnisse-der-letzten-jahre/': {
    ...
    'date': '2022-02-08',
    'with': ['einhergehenden katastrophalen Auswirkungen', 'Ihre gemeinsame Aussage lautet:', 'so die DGB-Vertreter. Auch'],  
    'without': ['HINTERLASSEN SIE EINE ANTWORT', 'NOCH MEHR NEWS', 'Ingo Degenhardt (DGB Südwestfalen)'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.gdp.de/gdp/gdp.nsf/id/DE_GdP-Vize-Klemmer-Mangelnde-Wertschaetzung-fuer-die-Beschaeftigten-des-oeD?open&ccm=000': {
    ...
    'date': '2021-10-29',
    'with': ['Potsdam die bisherige Sprachlosigkeit', 'Verhandlungsort wollen am', '5 Prozent, mindestens'],  
    'without': ['GdP Länder & Bezirke', 'GdP App 2.0', 'Foto: GdP/Hagen Immel'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.amnesty.de/allgemein/pressemitteilung/autonome-waffensysteme-gefahr-menschenrechte': {
    ...
    'date': '2021-11-02',
    'with': ['die globale Kampagne', 'wird zu verheerenden Verstößen', 'nationalen Nichtregierungsorganisationen'],  
    'without': ['Wir respektieren deine Privatsphäre', 'Aktuell', 'Getty Images'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.for-me-online.de/familie/kinder/tochter-pubertaet': {
    ...
    'date': '2022-02-17',
    'with': ['Dann ist sie wohl in der Pubertät!', 'bei Problemen auch an andere', 'Du wirst manchmal sehr'],  
    'without': ['Mehr Inspiration', 'Jetzt registrieren', 'erhalten Sie exklusive'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.lidl.de/c/nachhaltigkeit-im-onlineshop/s10009344': {
    ...
    'date': '',
    'with': ['Wegfall des Lieferscheins und der', 'geben wir an unsere Kartonagelieferanten weiter.', 'unserer Kundschaft zukünftig die'],  
    'without': ['ZUR NACHHALTIGKEIT IM ONLINESHOP', 'SCHRITT FÜR SCHRITT ANLEITUNG', 'Ich habe als Gast bestellt'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.nestle-marktplatz.de/mitmachen/produkttests': {
    ...
    'date': '',
    'with': ['können Sie die Einstellung ganz', 'auf Foren und Blogs, teilen Sie', 'Wir zählen auf Ihre Meinung'],  
    'without': ['Aktuelle Produkttests', 'NESQUIK Trinkfertig', 'Wie läuft ein Produkttest ab'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.theinsidersnet.com/de-de/campaigns/info/55887/welladryhairspraysmf2202.htm': {
    ...
    'date': '',
    'with': ['Dann haben wir genau das richtige für Dich!', 'Du möchtet Deinen Look nach', 'Dose kräftig schütteln. Sprühkopf'],  
    'without': ['Start', 'das Influencer-Marketingnetzwerk', 'eine Kampagne mit uns'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
'https://www.arbeitsagentur.de/news/arbeitsmarkt-2022': {
    ...
    'date': '2022-02-01',
    'with': ['sagte der Vorstand Regionen der Bundesagentur', 'Beschäftigung nahm saisonbereinigt von Oktober', 'Anzeigen wurde vom 1. bis einschließlich'],  
    'without': ['Auf der Seite Aktuelle Meldungen 2021', 'auf der Seite Entwicklung des', 'Arbeitsmarkts in den Vorjahren lesen'],  
    'comments': [],  
    'license': '',  
    'region': 'DE',  
},
