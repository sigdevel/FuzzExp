...
" (The Dragon Book).  LALR(1) has since been replaced
...
"coding style."   Modify the code at your
...
"." represents the current location of the parse.  Here
...
class LRGeneratedTable(LRTable):
    ...
    "N : . A B C", we run it forward
    "N : A B C ."   We then build a relationship between this final
