...
class StrToBool(dbops.Function):
    ...
    "true|false" at all. On
    
    "true" and
    "false". So the boolean value is then "true" if the
...
class SysConfigFullFunction(dbops.Function):
    ...
    "_edgecon_state" is a temporary table
