...
SOPK = {
   ...
   (0x15, 0x15, 0x14, 0x14, 0x15, "s_setreg_imm32_b32"), 
...
VOP2 = {
   ...
   (  -1,   -1,   -1,   -1, 0x06, "v_fmac_legacy_f32", True), 
   ...
   (0x25, 0x25, 0x19, 0x19,   -1, "v_add_co_u32", False), 
   (0x26, 0x26, 0x1a, 0x1a,   -1, "v_sub_co_u32", False), 
   (0x27, 0x27, 0x1b, 0x1b,   -1, "v_subrev_co_u32", False), 
   ...
   (  -1,   -1,   -1, 0x34, 0x25, "v_add_u32", False), 
   (  -1,   -1,   -1, 0x35, 0x26, "v_sub_u32", False), 
   (  -1,   -1,   -1, 0x36, 0x27, "v_subrev_u32", False), 
...
VOP1 = {
   ...
   (0x09, 0x09,   -1,   -1, 0x09, "v_mov_fed_b32", True, False), 
...
VOPP = {
   ...
   (0x20, "v_fma_mix_f32", True), 
   (0x21, "v_fma_mixlo_f16", True), 
   (0x22, "v_fma_mixhi_f16", True), 
}
...
VOP3 = {
   ...
   (0x168, 0x168, 0x284, 0x284, 0x168, "v_ldexp_f64", False, True, InstrClass.ValuDouble), 
   ...
   (0x16b, 0x16b, 0x285, 0x285, 0x16b, "v_mul_lo_i32", False, False, InstrClass.ValuQuarterRate32), 
   (0x16c, 0x16c, 0x287, 0x287, 0x16c, "v_mul_hi_i32", False, False, InstrClass.ValuQuarterRate32),
   (0x16d, 0x16d, 0x1e0, 0x1e0, 0x16d, "v_div_scale_f32", True, True), 
   (0x16e, 0x16e, 0x1e1, 0x1e1, 0x16e, "v_div_scale_f64", True, True, InstrClass.ValuDouble), 
   (0x16f, 0x16f, 0x1e2, 0x1e2, 0x16f, "v_div_fmas_f32", True, True), 
   (0x170, 0x170, 0x1e3, 0x1e3, 0x170, "v_div_fmas_f64", True, True, InstrClass.ValuDouble), 
   (0x171, 0x171, 0x1e4, 0x1e4, 0x171, "v_msad_u8", False, False),
   (0x172, 0x172, 0x1e5, 0x1e5, 0x172, "v_qsad_pk_u16_u8", False, False),
   (0x172,    -1,    -1,    -1,    -1, "v_qsad_u8", False, False), 
   (0x173, 0x173, 0x1e6, 0x1e6, 0x173, "v_mqsad_pk_u16_u8", False, False),
   (0x173,    -1,    -1,    -1,    -1, "v_mqsad_u8", False, False), 
   ...
   (0x12f, 0x12f, 0x296, 0x296, 0x12f, "v_cvt_pkrtz_f16_f32_e64", True, False), 
   ...
   (   -1,    -1,    -1,    -1, 0x140, "v_fma_legacy_f32", True, True, InstrClass.ValuFma), 
}
...
DS = {
   ...
   (0x35, 0x35, 0x3d, 0x3d, 0x35, "ds_swizzle_b32"), 
...
MUBUF = {
   ...
   (  -1,   -1,   -1,   -1, 0x34, "buffer_atomic_csub"), 
}
...
opcode("image_msaa_load", -1, -1, 0x80, Format.MIMG, InstrClass.VMem) 
...
IMAGE_GATHER4 = {
   ...
   "image_gather4h"), VEGA only?
   (0x44, "image_gather4_l"), 
   (0x45, "image_gather4_b"),
   (0x46, "image_gather4_b_cl"),
   (0x47, "image_gather4_lz"),
   (0x48, "image_gather4_c"),
   (0x49, "image_gather4_c_cl"), 
   "image_gather4h_pck"), VEGA only?
   "image_gather8h_pck"), VGEA only?
...
for (gfx7, gfx8, gfx10, name) in FLAT:
    opcode(name, gfx7, gfx8, gfx10, Format.FLAT, InstrClass.VMem, is_atomic = "atomic" in name) 
...
GLOBAL = {
   ...
   (  -1, 0x16, "global_load_dword_addtid"), 
   (  -1, 0x17, "global_store_dword_addtid"), 
   (  -1, 0x34, "global_atomic_csub"), 
}
