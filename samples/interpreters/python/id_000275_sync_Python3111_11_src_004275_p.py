...
class DeferredFrameTest(_AbstractFrameTest):
  ...
  @parameterized.expand([
      (pd.Series(range(10)), ),  
      (pd.Series(list(range(100)) + [0]), ),  
      (pd.Series(list(range(100)) + [0]) / 100, ),  
      (pd.Series(['a', 'b', 'c', 'd']), ),  
      (pd.Series(['a', 'b', 'a', 'c', 'd']), ),  
  ])
  ...
  @parameterized.expand([
      (pd.Series(range(10)), ),  
      (pd.Series([1, 2, np.nan, 3, np.nan]), ),  
      (pd.Series(['a', 'b', 'c', 'd', 'e']), ),  
      (pd.Series(['a', 'b', None, 'c', None]), ),  
  ])
  ...
  def test_cat(self):
    ...
    "category") in Beam, which makes a non-deferred
