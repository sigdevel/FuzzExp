...
class PyUITest(pyautolib.PyUITestBase, unittest.TestCase):
  ...
  def RestartBrowser(self, clear_profile=True, pre_launch_hook=None):
    ...
    self.set_clear_profile(orig_clear_state)  
  ...
  def DownloadAndWaitForStart(self, file_url, windex=0):
    ...
    self.NavigateToURL(file_url, windex)  
      ...
      { u'browser_pid': 93737,
        ...
        u'windows': [ { u'index': 0,
                        ...
                        u'tabs': [ {
                          ...
                          u'url': u'http://slides.html5rocks.com/
                            ],
                        u'type': u'tabbed',
                        u'width': 925,
                        u'x': 26,
  ...
  def LaunchApp(self, app_id, windex=0):
    ...
    Raises:
      pyauto_errors.JSONInterfaceError if the automation call returns an error.
    """
    self.AppendTab(GURL('chrome://newtab'), windex)  
    cmd_dict = {
      'command': 'LaunchApp',
      'id': app_id,
    }
  ...
  def GetUpdateInfo(self):
    ...
    Returns:
      ...
      { u'status': u'downloading',
        u'release_track': u'beta-channel',
        u'download_progress': 0.1203236708350371,   
        u'new_size': 152033593,                     
        u'last_checked_time': 1302055709}           
...
class Main(object):
  ...
  def _ExpandTestNames(self, args):
    ...
    """
    if not args:  
      if self._HasTestCases('__main__'):    
