...
def initColor(silent = False):
	...
	"turquoise4", "darkseagreen4", "chartreuse4","mediumaquamarine", "chartreuse2", "olivedrab2", "darkolivegreen1"]
	...
	"lightgoldenrod3","ivory2","honeydew3","slategray"]
	...
	"turquoise2", "gray85", "yellow", "coral2", "OliveDrab2", "MediumAquamarine", "blue2", "LightSalmon", "magenta2", "DarkSeaGreen2", "PaleTurquoise3", "khaki2", "thistle3", "PeachPuff2", "HotPink2", "firebrick", "purple2"]

	greekLetters = ["ALPHA", "BETA", "DELTA", "EPSILON", "GAMMA", "PHI"]
	craniateColors = ["DarkOrange", "RoyalBlue4", "chartreuse4", "gold", "DarkOrchid4", "red3"]
	"DarkOrange", "RoyalBlue2", "chartreuse2", "gold", "DarkOrchid1", "red2"]
