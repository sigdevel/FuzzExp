...
def test_search_ani_containment_fail(runtmp):
    ...
    "WARNING: size estimation for at least one of these sketches may be inaccurate. ANI values will not be reported for these comparisons." in c.last_result.err
    ...
    for i in range(len(idx_to_sig)):
        ...
        for j in range(len(idx_to_sig)):
            ...
            if i == j:
                ...
                assert containment_ani == mat_val 
