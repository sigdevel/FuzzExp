...
"Intérêts d'emprunts", val_type = "monetary", cerfa_field = u'7')) 
...
"7" sont remplacés par des "H" dans les CERFA-FIELDS

"", val_type = "monetary", cerfa_field = u'7UC', end = date(2011,12,31)))  
