...
class SMB:
    ...
    def signSMB(self, packet, signingSessionKey, signingChallengeResponse):
        ...
        "seq(%d) signingSessionKey %r, signingChallengeResponse %r" % (self._SignSequenceNumber, signingSessionKey, signingChallengeResponse)
    ...
    def checkSignSMB(self, packet, signingSessionKey, signingChallengeResponse):
        ...
        "Signature received: %r " % signature
        self.signSMB(packet, signingSessionKey, signingChallengeResponse)
        "Signature calculated: %r" % packet['SecurityFeatures']
