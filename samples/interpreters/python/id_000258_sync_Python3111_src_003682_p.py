...
class Jira(AtlassianRestAPI):
    ...
    Reference: https://docs.atlassian.com/software/jira/docs/api/REST/8.5.0/
    """
    ...
    def add_user_to_application(self, username, application_key):
        ...
        :see: https://docs.atlassian.com/software/jira/docs/api/REST/7.5.3/
        """
    ...
    def jql_get_list_of_tickets(
        ...
        while True:
            ...
            "DBG: response: total={total} start={startAt} max={maxResults}".format(**response))
...
api-group-workflows/
    ...
    def add_issue_type_scheme(self, scheme_id, project_key):
        ...
        https://docs.atlassian.com/software/jira/docs/api/REST/8.5.8
    ...
    def create_issuetype_scheme(self, name, description, default_issue_type_id, issue_type_ids):
        ...
        https://docs.atlassian.com/software/jira/docs/api/REST/8.13.6/
    ...
    def tempo_account_add_account(self, data=None):
        ...
        if data is None:
            return """Please, provide data e.g.
                       ...
                       detail info: http://developer.tempo.io/doc/accounts/api/rest/latest/
                   """
        return self.post(url, data=data)
    ...
    def add_issues_to_backlog(self, issues):
        ...
        https://docs.atlassian.com/jira-software/REST/8.9.0/
        """
