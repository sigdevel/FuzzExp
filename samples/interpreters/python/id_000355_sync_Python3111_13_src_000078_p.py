...
"license" file accompanying this file. This file is
...
_SIMPLE_SYMBOLS_TEXT=(
    ...
    (u'hello\u3000world', (br"'hello\u3000world'", b"'hello\xe3\x80\x80world'")),  
    (u'hello\U0001f4a9world', (br"'hello\U0001f4a9world'", b"'hello\xf0\x9f\x92\xa9world'")),  
)
...
SIMPLE_SCALARS_MAP_BINARY = {
    ...
    _IT.TIMESTAMP: (
        ...
        (timestamp(2016, precision=TimestampPrecision.YEAR), b'\x63\xC0\x0F\xE0'),  
