      ...
      for ebw in 1, 2, 4, 8:
        with self.subTest(bw=bw, ebw=ebw):
          data = bytes([
              ...
              *uint_bytes(len(vector), ebw),
              *uint_bytes(15 + 1 * ebw, ebw),  
              *uint_bytes(11 + 2 * ebw, ebw),  
              *uint_bytes(5 + 3 * ebw, ebw),  
      ...
      for ebw in 1, 2, 4, 8:
        with self.subTest(bw=bw, ebw=ebw):
          data = bytes([
              ...
              *str_bytes(vector[0], 1),  
              *str_bytes(vector[1], 1),  
              *str_bytes(vector[2], 1),  
              
              *uint_bytes(len(vector), ebw),
              *uint_bytes(17 + 1 * ebw, ebw),  
              *uint_bytes(12 + 2 * ebw, ebw),  
              *uint_bytes(5 + 3 * ebw, ebw),  
    ...
    for bw in 1, 2, 4, 8:
      with self.subTest(bw=bw):
        data = bytes([
            ...
            *uint_bytes(2 * len(vector) + len(vector), bw),  
        ...
        for vbw in 1, 2, 4, 8:
          with self.subTest(kbw=kbw, vbw=vbw, bw=bw):
            data = bytes([
                ...
                *uint_bytes(4 + 1 * kbw, kbw),  
                *uint_bytes(8 + 2 * kbw, kbw),  
                *uint_bytes(len(value) * kbw, vbw),  
                *uint_bytes(kbw, vbw),
