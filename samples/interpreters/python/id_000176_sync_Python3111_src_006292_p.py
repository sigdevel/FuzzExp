...
"dict" --enable-slots --export="write validate" --no-questions -f -o ".\Code\nuget\generated\_nuspec.py" -
...
"generatedscollector" containing a class
"GdsCollector".  See the default class definition below for
