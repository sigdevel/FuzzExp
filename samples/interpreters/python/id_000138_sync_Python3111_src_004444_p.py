...
class F3D:
    ...
    def __init__(self, F3D_VER, _HW_VERSION_1):
        ...
        self.G_TRI_FILL = 0xC8  
        self.G_TRI_SHADE = 0xCC  
        self.G_TRI_TXTR = 0xCA  
        self.G_TRI_SHADE_TXTR = 0xCE  
        self.G_TRI_FILL_ZBUFF = 0xC9  
        self.G_TRI_SHADE_ZBUFF = 0xCD  
        self.G_TRI_TXTR_ZBUFF = 0xCB  
        self.G_TRI_SHADE_TXTR_ZBUFF = 0xCF  
        ...
        self.G_MAXFBZ = 0x3FFF  

        

        if F3DEX_GBI_2:
            self.G_MTX_MODELVIEW = 0x00  
            self.G_MTX_PROJECTION = 0x04
            self.G_MTX_MUL = 0x00  
            self.G_MTX_LOAD = 0x02
            self.G_MTX_NOPUSH = 0x00  
        ...
        self.G_SHADE = 0x00000004  
        
        if F3DEX_GBI_2:
            self.G_TEXTURE_ENABLE = 0x00000000  
            self.G_SHADING_SMOOTH = 0x00200000  
            self.G_CULL_FRONT = 0x00000200
            self.G_CULL_BACK = 0x00000400
            self.G_CULL_BOTH = 0x00000600  
        else:
            self.G_TEXTURE_ENABLE = 0x00000002  
            self.G_SHADING_SMOOTH = 0x00000200  
            self.G_CULL_FRONT = 0x00001000
            self.G_CULL_BACK = 0x00002000
            self.G_CULL_BOTH = 0x00003000  
        self.G_FOG = 0x00010000
        self.G_LIGHTING = 0x00020000
        self.G_TEXTURE_GEN = 0x00040000
        self.G_TEXTURE_GEN_LINEAR = 0x00080000
        self.G_LOD = 0x00100000  
        if F3DEX_GBI or F3DLP_GBI:
        ...
        self.G_LOD_H = self.G_LOD / 0x10000  
        if F3DEX_GBI or F3DLP_GBI:
        ...
        self.G_MDSFT_BLENDMASK = G_MDSFT_BLENDMASK = 0  
        ...
        self.G_MDSFT_COLORDITHER = G_MDSFT_COLORDITHER = 22  
...
class FModel:
    def __init__(self, f3dType: F3D, isHWv1: bool, name: str, DLFormat: "DLFormat", matWriteMethod: GfxMatWriteMethod):
        ...
        self.texturesSavedLastExport: int = 0  
...
class FImage:
    ...
    def to_c_tex_separate(self, texPath, texArrayBitSize):
        return self.to_c_helper('"' + texPath + self.filename + '"', texArrayBitSize)
