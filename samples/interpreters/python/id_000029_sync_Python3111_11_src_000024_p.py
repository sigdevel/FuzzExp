    ...
    def _extract_account_syncid(*args):
        ...
        for data in args:
            ...
            if len(sync_ids) >= 2 and sync_ids[1]:
                "channel_syncid||user_syncid" for secondary channel
                "user_syncid||" for primary channel. We only want the channel_syncid
                return sync_ids[0]
...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _VALID_URL = r"""(?x)^
                     (
                         ...
                         (?:.*?\
                         (?:                                                  
                             (?:(?:v|embed|e|shorts)/(?!videoseries|live_stream))  
                             |(?:                                             
    ...
    _TESTS = [
        ...
        
        {
            ...
            'info_dict': {
                'id': 'CsmdDsKjzN8',
                'ext': 'mp4',
                'upload_date': '20150501',  "datePublished"', but in other places it's 20150510
                'uploader': 'Airtek',
        ...
        {
            "};" (see https://github.com/ytdl-org/youtube-dl/issues/7468)
    ...
    def _live_dash_fragments(self, format_id, live_start_time, mpd_feed, ctx):
        ...
        while is_live:
            ...
            if no_fragment_score > 30:
                return
            if last_segment_url:
                "X-Head-Seqnum" header value from each segment
                try:
    ...
    def _comment_entries(self, root_continuation_data, ytcfg, video_id, parent=None, tracker=None):
        ...
        def extract_header(contents):
            ...
            for content in contents:
                ...
                comment_sort_index = int(get_single_config_arg('comment_sort') != 'top')  
        ...
        if pctr:
            ...
            for lang_code, caption_track in captions.items():
                ...
                for trans_code, trans_name in translation_languages.items():
                    ...
                    "-orig" label to the original language so that it can be distinguished.
                    "-orig" as well for compatibility
    ...
    def _entries(self, tab, item_id, ytcfg, account_syncid, visitor_data):
        ...
        for page_num in itertools.count(1):
            ...
            known_continuation_renderers = {
                ...
                'sectionListContinuation': extract_entries,  
            }
    ...
    def _extract_webpage(self, url, item_id, fatal=True):
        ...
        while count < retries:
            ...
            try:
                webpage = self._download_webpage(
                    url, item_id,
                    note='Downloading webpage%s' % (' (retry 
...
class YoutubeTabIE(YoutubeTabBaseInfoExtractor):
    ...
    _TESTS = [{
        ...
        'note': 'Playlist with deleted videos (
...
class YoutubeLivestreamEmbedIE(InfoExtractor):
    ...
    _VALID_URL = r'https?://(?:\w+\.)?youtube\.com/embed/live_stream/?\?(?:[^
    _TESTS = [{
...
class YoutubeSearchURLIE(YoutubeTabBaseInfoExtractor):
    ...
    _VALID_URL = r'https?://(?:www\.)?youtube\.com/(?:results|search)\?([^
    _TESTS = [{
...
class YoutubeMusicSearchURLIE(YoutubeTabBaseInfoExtractor):
    IE_DESC = 'YouTube music search URLs with selectable sections (Eg: 
    IE_NAME = 'youtube:music:search_url'
    _VALID_URL = r'https?://music\.youtube\.com/search\?([^
    _TESTS = [{
    ...
    def _real_extract(self, url):
        ...
        if params:
            ...
            section = compat_urllib_parse_unquote_plus((url.split('
