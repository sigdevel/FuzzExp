...
class TestCqlshCopy(Tester):
    ...
    def all_datatypes_prepare(self):
        ...
        self.data = ('ascii',  
                     ...
                     [1, 2, 3],  
                     ImmutableSet(['3', '2', '1', '']),  
                     ImmutableDict([(date1, '1'), (date2, '2'), (date3, '')]),  
                     (1, '1', True),  
                     addr1,  
                     ...
                     {'key1': ['value1', 'value2', '']},  
                     {3: bytes.fromhex('74776f')},  
                     [bytes.fromhex('74776f')],  
                     {bytes.fromhex('74776f')}  
                     )
    ...
    def assertCsvResultEqual(self, csv_filename, results, table_name=None,
        ...
        try:
            ...
            if len(csv_results) != len(results):
                logger.warning("Different ".format(len(csv_results), len(results)))
            else:
                line_matches = True
    ...
    def test_reading_max_parse_errors(self):
        ...
        assert num_rows_imported < (num_rows / 2)  
    ...
    def test_reading_max_insert_errors(self):
        ...
        - fail one chunk permanently (via CQLSH_COPY_TEST_FAILURES so that chunk_size rows will fail a 
        ...
        def do_test(max_insert_errors, chunk_size):
            ...
            num_expected_rows = num_rows - chunk_size  
    ...
    def test_copy_from_with_large_cql_rows(self):
        ...
        """
        num_records = 100
        self.prepare(nodes=1, configuration_options={'batch_size_warn_threshold_in_kb': '1',   
                                                     'batch_size_fail_threshold_in_kb': '5'})  
    ...
    def test_unusual_dates(self):
        ...
        expected_results = [
            [1, datetime.datetime(9999, 12, 31, 23, 59, 59)],  
            [2, 253402300801000],  
