...
class TaskInstance(Base, LoggingMixin):
    ...
    def get_template_context(
        ...
        def get_next_execution_date() -> pendulum.DateTime | None:
            ...
            "next" execution date doesn't make sense, and should be set
        ...
        def get_prev_execution_date():
            ...
            "previous" execution date doesn't make sense, and should be set
        ...
        "lie" in the type stub to say it
    ...
    def get_relevant_upstream_map_indexes(
        ...
        *,
        ...
        "partial" value. Let's break down the mapped ti count
        ...
        "ti_count == ancestor_ti_count" does not work, since the further
