...
class NumpyExtrasTest(unittest.TestCase):
    ...
    def test_c_wrapper_test(self):
        input = np.arange(0, 16).reshape((4, 4))  
    ...
    def test_aggregate_attention_volume(self):
        ...
        self.assertAlmostEqual(attentionAgg.min(), 0.0)  
        self.assertAlmostEqual(attentionAgg[:10].min(), 0.01)  
