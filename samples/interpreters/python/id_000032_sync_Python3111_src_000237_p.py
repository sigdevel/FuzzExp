    ...
    * ``comment`` - str : attachment comment
    ...
    def __init__(self, **kwargs) -> None:
        ...
        try:
            ...
            if self.id != b"":
                message = f'Expected "" block @{hex(address)} but found "{self.id}"'
    ...
    def __init__(self, **kwargs) -> None:
        ...
        if "stream" in kwargs:
            ...
            if mapped:
                ...
                if self.id != b"":
                    message = (
                        f'Expected "" block @{hex(address)} but found "{self.id}"'
                    )
                    logger.exception(message)
                    raise MdfException(message)
                        ...
                        if address:
                            if address in tx_map:
                                ...
                                if _id == b"":
                                    ...
                                    message = f'Expected "" or "" block @{hex(address)} but found "{_id}"'
                                    logger.exception(message)
                                    raise MdfException(message)
    ...
    def __init__(self, **kwargs) -> None:
        ...
        try:
            ...
            if mapped:
                ...
                if self.id not in (b"", b"", b"", b"", b""):
                    message = f'Expected "", "", "", "" or "" block @{hex(address)} but found "{self.id}"'
                    logger.exception(message)
                    raise MdfException(message)
    ...
    * ``address`` - int : text block address
    ...
    def __init__(self, **kwargs) -> None:
        ...
        if "safe" in kwargs:
            ...
            text = kwargs["text"]
            size = len(text)
            self.id = b"" if kwargs["meta"] else b""
            self.reserved0 = 0
            self.links_nr = 0
            self.text = text
            ...
            self.id = b"" if kwargs.get("meta", False) else b""
            self.reserved0 = 0
            self.links_nr = 0
            self.text = text
