...
class BaseXYTestCase(unittest.TestCase):
    ...
    def test_a85encode(self):
        ...
        tests = {
            ...
            bytes(range(255)): b"""!!*-'"9eu7"(`=52*$$"""
               b"""(B+<_pR,UFcb-n-Vr/1iJ-0JP==1c70M3&s"""
               b"""H9MJ8X:f1+h<)lt"""
    ...
    def test_b85encode(self):
        ...
        tests = {
            b'': b'',
            b'www.python.org': b'cXxL
            bytes(range(255)): b"""009C61O)~M2nh-c3=Iws5D^j+6crX17"""
                b"""AR!_nBqb&%C@Cr{EG;fCFflSSG&MFiI5|2yJUu=?KtV!7L`6nNNJ&ad"""
                b"""OifNtP*GA-R8>}2SXo+ITwPvYU}0ioWMyV&XlZI|Y;A6DaB*^Tbai%j"""
                b"""czJqze0_d@fPsR8goTEOh>41ejE"""
                b"""q@|{(sHv)}tgWuEu(7hUw6(UkxVgH!yuH4^z`?@9"""
                b"""(9zP<)YaD4*xB0K+}+;a;Njxq<mKk)=;`X~?CtLF@bU8V^!4`l`1$("""
                b"""{Qdp""",
            b"""abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"""
                b"""0123456789!@""":
                b"""VPa!sWoBn+X=-b1ZEkOHadLBXb"""
                b"""Q&d$}S6EqEFflSSG&MFiI5{CeBQRbjDkv""",
    ...
    def test_b85decode(self):
        ...
        tests = {
            b'': b'',
            b'cXxL
            b"""009C61O)~M2nh-c3=Iws5D^j+6crX17"""
                b"""AR!_nBqb&%C@Cr{EG;fCFflSSG&MFiI5|2yJUu=?KtV!7L`6nNNJ&ad"""
                b"""OifNtP*GA-R8>}2SXo+ITwPvYU}0ioWMyV&XlZI|Y;A6DaB*^Tbai%j"""
                b"""czJqze0_d@fPsR8goTEOh>41ejE"""
                b"""q@|{(sHv)}tgWuEu(7hUw6(UkxVgH!yuH4^z`?@9"""
        ...
        self.check_other_types(base64.b85decode, b'cXxL
                               b"www.python.org")
