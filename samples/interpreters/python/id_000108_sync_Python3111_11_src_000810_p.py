...
def test_info(s3):
    ...
    s3.invalidate_cache()  
    s3.ls(parent)  
    assert s3.info(a) == s3.dircache[parent][0]  
    assert id(s3.info(a)) == id(s3.dircache[parent][0])  
