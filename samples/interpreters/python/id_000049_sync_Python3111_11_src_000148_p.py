...
browser_init_page = "https://searchencrypt.com" 
check_ip_service1 = 'https://checkip.org/' 
check_ip_service2 = 'https://whatismyip.org/' 
check_ip_service3 = 'https://ip.42.pl/ra' 

torrent_seed = "https://ufonet.03c8.net/ufonet/ufonet-v1.8.tar.gz.torrent" 
...
<center>Grid profile updated. Re-enter to see changes..."""+self.pages["/footer"]
    ...
    def html_stats(self):
        ...
        if self.ranking == "Rookie": 
            ...
            your_ranking = "<font color='red'>UFOl33t! [&"
        else:
...
<canvas id="starfield" style="z-index:-1; background-color:"></canvas>
<center>
...
""" + self.pages["/footer"]
    ...
    def html_board(self):
        self.board_welcome = "<div id='board_warning' style='display: none;'><pre><u>WARNING:</u> <br><br> 1) This is our 'Space Cantina': DON'T BE A LAMER!!! <br> 2) NO language RESTRICTIONS <br> 3) ABUSING == " 
        self.board_topic = "<select id='board_selector'><option value='general'>GENERAL</option><option value='opsec'> - OPSEC: "
        ...
        if device_state == "OFF":
            ...
            board_filter = "<table cellpadding='5' border='1'><tr><td><input type='radio' name='filter' id='filter_all' value='ALL' CHECKED>/ALL<br> </td><td><input type='radio' name='filter' id='filter_general' value='GENERAL'>/GENERAL</td><td><input type='radio' name='filter' id='filter_opsec' value='OPSEC'>/"
        if device_state == "OFF":
            sync_panel = ""
        else:
        ...
        with open(self.wargames_file) as f:
            ...
            for m in self.list_wargames: 
                if wargames_msg_sep in m:
                    ...
                    wargame_state = str("HSvtfBFwQBSms8h/7Ra/tKGNYp7KqiiNeOMPzDmrChJqyBJ+yuRiHpY9H+/LDQ==")[0:12] "ENCRYPTED!")
...
<center><table cellpadding="5" border="1"><tr><td>Blackhole/IP:</td><td><input type='text' name='link_source' id='link_source' size='20' value='"""+default_blackhole+"""'></td><td><button title="Download 'links' proposed by other motherships..." onclick="SyncLinks()">DOWNLOAD!</button></td><td><form method='GET'><input type="hidden" name="link_deckey" id="link_deckey" size="20" value='"""+self.crypto_key+"""' READONLY><a style='color:red;text-decoration:underline red;' onclick=javascript:Decrypt_links();>Try decryption!</a></td></tr></table></center></form><br><hr><form method='GET'><table cellpadding='5' cellspacing='5'><tr><td>TOPIC:</td><td> <select id="link_topic">
  ...
  <option value="APT">APT - ArT.Trolling / 
...
""" + self.pages["/footer"]
    ...
    def __init__(self):
        ...
        if int(self.acompleted) > 0: 
            ...
            self.mothership_acc = 100 "the only way to win in Nuclear War is not to play"
        if int(self.acompleted) < 5: 
            ...
            self.ranking = "Bandit"
        elif int (self.acompleted) < 50 and int(self.tcrashed) > 4: "crashers" ;-)
...
<div><a id="mH5" href="javascript:show('nb5');" style="text-decoration: none;" >+ Support</a></div> <div class="nb" id="nb5" style="display: none;">    - Testing; use the tool and search for possible bugs and new ideas
    ...
    - Donating; money, objects, privacy, exploits, <a href="https://en.wikipedia.org/wiki/Love" target="_blank">love</a> ;-)
      ...
      - <a href="https://ecoin.03c8.net/blockexplorer" target="_blank">Ecoin [ECO]</a>: <b>ETsRCBzaMawx3isvb5svX7tAukLdUFHKze</b></div> <div><a id="mH6" href="javascript:show('nb6');" style="text-decoration: none" >+ Contact</a></div> <div class="nb" id="nb6" style="display: none;">   - <a target="_blank" href="wormhole">Wormhole</a>: irc.freenode.net / 
   - Email: <a href="mailto: epsylon@riseup.net">epsylon@riseup.net</a> [GPG:0xB8AC3776]
</div></td></tr>
<tr>
<td>"/treemap" target="_blank">VIEW</a> | SHIP.BROWSER: <a href="javascript:Browser()">OPEN</a> | SHIP.GAMES: <a href="javascript:Games()">PLAY!</a> 
</td></tr>
<tr>
...
<tr>
 ...
 <tr>
    <td align="center"><font color='red' size='4'>&"center"><font color='red'>UFOl33t!</font></td><td align='center'><font color='red'><a style="text-decoration:none" href="javascript:alert('Secret Achievement!');">???</a></font></td></tr>
 </table>
 </td>
 </tr></table>
<br>
                ...
                for m in self.list_moderator_rev: 
                    if board_msg_sep in m:
                        ...
                        if self.decryptedtext:
                            ...
                            nick = 'Anonymous' 
                        try:
                            nick = nick.decode('latin-1') "her.man.xs-latino"
                        except:
                            pass
                        if len(nick) < 3:
                            nick = 'Anonymous'
                ...
                for m in self.list_grid_rev: 
                    if grid_msg_sep in m:
                        ...
                        if grid_ranking == 1: 
                            ...
                            grid_ranking = "<font color='red' size='4'>&"
                            member_5 = member_5 + 1
                        else:
                            grid_ranking = nodec_text
                        grid_totalchargo = m[2] 
            ...
            if tv_deckey != "": 
                ...
                for n in self.list_tv_rev: 
                    ...
                    if url_tv != nodec_text:
                        ...
                        tv_table += "<table><tr><td>[<a href='"+str(url_tv)+"')>PLAY!</a>]</td><td><a href='"+str(url_tv)+"' target='_blank'>"+str(self.playing_title)+"</a></td></tr></table>"
                    else:
