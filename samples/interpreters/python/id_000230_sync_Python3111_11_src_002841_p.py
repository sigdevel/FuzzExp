...
_symbolic_accidental_regex_atom = "(?P<symbolic_accidental>["
...
_range_string_regex_body = r"""
    ...
    (?P<start_pitch>
        {}|{}|(?P<start_pitch_number>-?\d+) 
    )
    ,               
    [ ]*            
    (?P<stop_pitch>
        {}|{}|(?P<stop_pitch_number>-?\d+) 
    )
    (?P<close_bracket>
        [\])]       
    )
...
class NamedPitch(Pitch):
    ...
    ..  container:: example
        ...
        >>> abjad.NamedPitch("C", arrow=abjad.UP)
    ...
    def simplify(self) -> "NamedPitch":
        ...
        while alteration > 2:
            step_size = 2
            if diatonic_pc_number == 2:  
                step_size = 1
            elif diatonic_pc_number == 6:  
                step_size = 1
                octave += 1
        ...
        while alteration < -2:
            step_size = 2
            if diatonic_pc_number == 3:  
                step_size = 1
            elif diatonic_pc_number == 0:  
                step_size = 1
                octave -= 1
            diatonic_pc_number = (diatonic_pc_number - 1) % 7
            alteration += step_size
