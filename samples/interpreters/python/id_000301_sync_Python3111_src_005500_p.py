...
class TypeHandler(object):
  ...
  def AddImmediateFunction(self, generator, func):
    ...
    immediate = func.GetInfo('immediate')  
...
""")
  ...
  def WritePepperGLES2Interface(self, filename, dev):
    ...
    file.Write(""ppapi/c/pp_resource.h\"\n")
    if dev:
      file.Write(""ppapi/c/ppb_opengles2.h\"\n\n")
    else:
      file.Write("\n")
  ...
  def WritePepperGLES2Implementation(self, filename):
    ...
    file.Write(""ppapi/shared_impl/ppb_opengles2_shared.h\"\n\n")
    file.Write(""base/logging.h\"\n")
    file.Write(""gpu/command_buffer/client/gles2_implementation.h\"\n")
    file.Write(""ppapi/shared_impl/ppb_graphics_3d_shared.h\"\n")
    file.Write(""ppapi/thunk/enter.h\"\n\n")
  ...
  def WriteGLES2ToPPAPIBridge(self, filename):
    ...
    file.Write("")
    file.Write("")
    file.Write(""ppapi/lib/gl/gles2/gl2ext_ppapi.h\"\n\n")
  ...
  def WritePepperGLES2NaClProxy(self, filename):
    ...
    file.Write(""native_client/src/shared/ppapi_proxy"
...
def main(argv):
  ...
  if options.alternate_mode == "ppapi":
    ...
    "make ppapi_gles_implementation"
