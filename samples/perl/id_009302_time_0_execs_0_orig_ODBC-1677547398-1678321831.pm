...
%ReturnTypes =
(
SQL_ACCESSIBLE_PROCEDURES           => 'SQLCHAR'
, SQL_ACCESSIBLE_TABLES               => 'SQLCHAR'
, SQL_ACTIVE_CONNECTIONS              => 'SQLUSMALLINT'
, SQL_ACTIVE_ENVIRONMENTS             => 'SQLUSMALLINT'
, SQL_ACTIVE_STATEMENTS               => 'SQLUSMALLINT'
, SQL_AGGREGATE_FUNCTIONS             => 'SQLUINTEGER bitmask'
, SQL_ALTER_DOMAIN                    => 'SQLUINTEGER bitmask'
, SQL_ALTER_TABLE                     => 'SQLUINTEGER bitmask'
, SQL_ASYNC_MODE                      => 'SQLUINTEGER'
, SQL_BATCH_ROW_COUNT                 => 'SQLUINTEGER bitmask'
, SQL_BATCH_SUPPORT                   => 'SQLUINTEGER bitmask'
, SQL_BOOKMARK_PERSISTENCE            => 'SQLUINTEGER bitmask'
, SQL_CATALOG_LOCATION                => 'SQLUSMALLINT'
, SQL_CATALOG_NAME                    => 'SQLCHAR'
, SQL_CATALOG_NAME_SEPARATOR          => 'SQLCHAR'
, SQL_CATALOG_TERM                    => 'SQLCHAR'
, SQL_CATALOG_USAGE                   => 'SQLUINTEGER bitmask'
, SQL_COLLATION_SEQ                   => 'SQLCHAR'
, SQL_COLUMN_ALIAS                    => 'SQLCHAR'
, SQL_CONCAT_NULL_BEHAVIOR            => 'SQLUSMALLINT'
, SQL_CONVERT_BIGINT                  => 'SQLUINTEGER bitmask'
, SQL_CONVERT_BINARY                  => 'SQLUINTEGER bitmask'
, SQL_CONVERT_BIT                     => 'SQLUINTEGER bitmask'
, SQL_CONVERT_CHAR                    => 'SQLUINTEGER bitmask'
, SQL_CONVERT_DATE                    => 'SQLUINTEGER bitmask'
, SQL_CONVERT_DECIMAL                 => 'SQLUINTEGER bitmask'
, SQL_CONVERT_DOUBLE                  => 'SQLUINTEGER bitmask'
, SQL_CONVERT_FLOAT                   => 'SQLUINTEGER bitmask'
, SQL_CONVERT_FUNCTIONS               => 'SQLUINTEGER bitmask'
, SQL_CONVERT_GUID                    => 'SQLUINTEGER bitmask'
, SQL_CONVERT_INTEGER                 => 'SQLUINTEGER bitmask'
, SQL_CONVERT_INTERVAL_DAY_TIME       => 'SQLUINTEGER bitmask'
, SQL_CONVERT_INTERVAL_YEAR_MONTH     => 'SQLUINTEGER bitmask'
, SQL_CONVERT_LONGVARBINARY           => 'SQLUINTEGER bitmask'
, SQL_CONVERT_LONGVARCHAR             => 'SQLUINTEGER bitmask'
, SQL_CONVERT_NUMERIC                 => 'SQLUINTEGER bitmask'
, SQL_CONVERT_REAL                    => 'SQLUINTEGER bitmask'
, SQL_CONVERT_SMALLINT                => 'SQLUINTEGER bitmask'
, SQL_CONVERT_TIME                    => 'SQLUINTEGER bitmask'
, SQL_CONVERT_TIMESTAMP               => 'SQLUINTEGER bitmask'
, SQL_CONVERT_TINYINT                 => 'SQLUINTEGER bitmask'
, SQL_CONVERT_VARBINARY               => 'SQLUINTEGER bitmask'
, SQL_CONVERT_VARCHAR                 => 'SQLUINTEGER bitmask'
, SQL_CONVERT_WCHAR                   => 'SQLUINTEGER bitmask'
, SQL_CONVERT_WLONGVARCHAR            => 'SQLUINTEGER bitmask'
, SQL_CONVERT_WVARCHAR                => 'SQLUINTEGER bitmask'
, SQL_CORRELATION_NAME                => 'SQLUSMALLINT'
, SQL_CREATE_ASSERTION                => 'SQLUINTEGER bitmask'
, SQL_CREATE_CHARACTER_SET            => 'SQLUINTEGER bitmask'
, SQL_CREATE_COLLATION                => 'SQLUINTEGER bitmask'
, SQL_CREATE_DOMAIN                   => 'SQLUINTEGER bitmask'
, SQL_CREATE_SCHEMA                   => 'SQLUINTEGER bitmask'
, SQL_CREATE_TABLE                    => 'SQLUINTEGER bitmask'
, SQL_CREATE_TRANSLATION              => 'SQLUINTEGER bitmask'
, SQL_CREATE_VIEW                     => 'SQLUINTEGER bitmask'
, SQL_CURSOR_COMMIT_BEHAVIOR          => 'SQLUSMALLINT'
, SQL_CURSOR_ROLLBACK_BEHAVIOR        => 'SQLUSMALLINT'
, SQL_CURSOR_SENSITIVITY              => 'SQLUINTEGER'
, SQL_DATA_SOURCE_NAME                => 'SQLCHAR'
, SQL_DATA_SOURCE_READ_ONLY           => 'SQLCHAR'
, SQL_DATABASE_NAME                   => 'SQLCHAR'
, SQL_DATETIME_LITERALS               => 'SQLUINTEGER bitmask'
, SQL_DBMS_NAME                       => 'SQLCHAR'
, SQL_DBMS_VER                        => 'SQLCHAR'
, SQL_DDL_INDEX                       => 'SQLUINTEGER bitmask'
, SQL_DEFAULT_TXN_ISOLATION           => 'SQLUINTEGER'
, SQL_DESCRIBE_PARAMETER              => 'SQLCHAR'
, SQL_DM_VER                          => 'SQLCHAR'
, SQL_DRIVER_HDBC                     => 'SQLUINTEGER'
, SQL_DRIVER_HDESC                    => 'SQLUINTEGER'
, SQL_DRIVER_HENV                     => 'SQLUINTEGER'
, SQL_DRIVER_HLIB                     => 'SQLUINTEGER'
, SQL_DRIVER_HSTMT                    => 'SQLUINTEGER'
, SQL_DRIVER_NAME                     => 'SQLCHAR'
, SQL_DRIVER_ODBC_VER                 => 'SQLCHAR'
, SQL_DRIVER_VER                      => 'SQLCHAR'
, SQL_DROP_ASSERTION                  => 'SQLUINTEGER bitmask'
, SQL_DROP_CHARACTER_SET              => 'SQLUINTEGER bitmask'
, SQL_DROP_COLLATION                  => 'SQLUINTEGER bitmask'
, SQL_DROP_DOMAIN                     => 'SQLUINTEGER bitmask'
, SQL_DROP_SCHEMA                     => 'SQLUINTEGER bitmask'
, SQL_DROP_TABLE                      => 'SQLUINTEGER bitmask'
, SQL_DROP_TRANSLATION                => 'SQLUINTEGER bitmask'
, SQL_DROP_VIEW                       => 'SQLUINTEGER bitmask'
, SQL_DYNAMIC_CURSOR_ATTRIBUTES1      => 'SQLUINTEGER bitmask'
, SQL_DYNAMIC_CURSOR_ATTRIBUTES2      => 'SQLUINTEGER bitmask'
, SQL_EXPRESSIONS_IN_ORDERBY          => 'SQLCHAR'
, SQL_FETCH_DIRECTION                 => 'SQLUINTEGER bitmask'
, SQL_FILE_USAGE                      => 'SQLUSMALLINT'
, SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES1 => 'SQLUINTEGER bitmask'
, SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES2 => 'SQLUINTEGER bitmask'
, SQL_GETDATA_EXTENSIONS              => 'SQLUINTEGER bitmask'
, SQL_GROUP_BY                        => 'SQLUSMALLINT'
, SQL_IDENTIFIER_CASE                 => 'SQLUSMALLINT'
, SQL_IDENTIFIER_QUOTE_CHAR           => 'SQLCHAR'
, SQL_INDEX_KEYWORDS                  => 'SQLUINTEGER bitmask'
, SQL_INFO_SCHEMA_VIEWS               => 'SQLUINTEGER bitmask'
, SQL_INSERT_STATEMENT                => 'SQLUINTEGER bitmask'
, SQL_INTEGRITY                       => 'SQLCHAR'
, SQL_KEYSET_CURSOR_ATTRIBUTES1       => 'SQLUINTEGER bitmask'
, SQL_KEYSET_CURSOR_ATTRIBUTES2       => 'SQLUINTEGER bitmask'
, SQL_KEYWORDS                        => 'SQLCHAR'
, SQL_LIKE_ESCAPE_CLAUSE              => 'SQLCHAR'
, SQL_LOCK_TYPES                      => 'SQLUINTEGER bitmask'
, SQL_MAXIMUM_CATALOG_NAME_LENGTH     => 'SQLUSMALLINT'
, SQL_MAXIMUM_COLUMNS_IN_GROUP_BY     => 'SQLUSMALLINT'
, SQL_MAXIMUM_COLUMNS_IN_INDEX        => 'SQLUSMALLINT'
, SQL_MAXIMUM_COLUMNS_IN_ORDER_BY     => 'SQLUSMALLINT'
, SQL_MAXIMUM_COLUMNS_IN_SELECT       => 'SQLUSMALLINT'
, SQL_MAXIMUM_COLUMN_NAME_LENGTH      => 'SQLUSMALLINT'
, SQL_MAXIMUM_CONCURRENT_ACTIVITIES   => 'SQLUSMALLINT'
, SQL_MAXIMUM_CURSOR_NAME_LENGTH      => 'SQLUSMALLINT'
, SQL_MAXIMUM_DRIVER_CONNECTIONS      => 'SQLUSMALLINT'
, SQL_MAXIMUM_IDENTIFIER_LENGTH       => 'SQLUSMALLINT'
, SQL_MAXIMUM_INDEX_SIZE              => 'SQLUINTEGER'
, SQL_MAXIMUM_ROW_SIZE                => 'SQLUINTEGER'
, SQL_MAXIMUM_SCHEMA_NAME_LENGTH      => 'SQLUSMALLINT'
, SQL_MAXIMUM_STATEMENT_LENGTH        => 'SQLUINTEGER'
, SQL_MAXIMUM_TABLES_IN_SELECT        => 'SQLUSMALLINT'
, SQL_MAXIMUM_USER_NAME_LENGTH        => 'SQLUSMALLINT'
, SQL_MAX_ASYNC_CONCURRENT_STATEMENTS => 'SQLUINTEGER'
, SQL_MAX_BINARY_LITERAL_LEN          => 'SQLUINTEGER'
, SQL_MAX_CATALOG_NAME_LEN            => 'SQLUSMALLINT'
, SQL_MAX_CHAR_LITERAL_LEN            => 'SQLUINTEGER'
, SQL_MAX_COLUMNS_IN_GROUP_BY         => 'SQLUSMALLINT'
, SQL_MAX_COLUMNS_IN_INDEX            => 'SQLUSMALLINT'
, SQL_MAX_COLUMNS_IN_ORDER_BY         => 'SQLUSMALLINT'
, SQL_MAX_COLUMNS_IN_SELECT           => 'SQLUSMALLINT'
, SQL_MAX_COLUMNS_IN_TABLE            => 'SQLUSMALLINT'
, SQL_MAX_COLUMN_NAME_LEN             => 'SQLUSMALLINT'
, SQL_MAX_CONCURRENT_ACTIVITIES       => 'SQLUSMALLINT'
, SQL_MAX_CURSOR_NAME_LEN             => 'SQLUSMALLINT'
, SQL_MAX_DRIVER_CONNECTIONS          => 'SQLUSMALLINT'
, SQL_MAX_IDENTIFIER_LEN              => 'SQLUSMALLINT'
, SQL_MAX_INDEX_SIZE                  => 'SQLUINTEGER'
, SQL_MAX_OWNER_NAME_LEN              => 'SQLUSMALLINT'
, SQL_MAX_PROCEDURE_NAME_LEN          => 'SQLUSMALLINT'
, SQL_MAX_QUALIFIER_NAME_LEN          => 'SQLUSMALLINT'
, SQL_MAX_ROW_SIZE                    => 'SQLUINTEGER'
, SQL_MAX_ROW_SIZE_INCLUDES_LONG      => 'SQLCHAR'
, SQL_MAX_SCHEMA_NAME_LEN             => 'SQLUSMALLINT'
, SQL_MAX_STATEMENT_LEN               => 'SQLUINTEGER'
, SQL_MAX_TABLES_IN_SELECT            => 'SQLUSMALLINT'
, SQL_MAX_TABLE_NAME_LEN              => 'SQLUSMALLINT'
, SQL_MAX_USER_NAME_LEN               => 'SQLUSMALLINT'
, SQL_MULTIPLE_ACTIVE_TXN             => 'SQLCHAR'
, SQL_MULT_RESULT_SETS                => 'SQLCHAR'
, SQL_NEED_LONG_DATA_LEN              => 'SQLCHAR'
, SQL_NON_NULLABLE_COLUMNS            => 'SQLUSMALLINT'
, SQL_NULL_COLLATION                  => 'SQLUSMALLINT'
, SQL_NUMERIC_FUNCTIONS               => 'SQLUINTEGER bitmask'
, SQL_ODBC_API_CONFORMANCE            => 'SQLUSMALLINT'
, SQL_ODBC_INTERFACE_CONFORMANCE      => 'SQLUINTEGER'
, SQL_ODBC_SAG_CLI_CONFORMANCE        => 'SQLUSMALLINT'
, SQL_ODBC_SQL_CONFORMANCE            => 'SQLUSMALLINT'
, SQL_ODBC_SQL_OPT_IEF                => 'SQLCHAR'
, SQL_ODBC_VER                        => 'SQLCHAR'
, SQL_OJ_CAPABILITIES                 => 'SQLUINTEGER bitmask'
, SQL_ORDER_BY_COLUMNS_IN_SELECT      => 'SQLCHAR'
, SQL_OUTER_JOINS                     => 'SQLCHAR'
, SQL_OUTER_JOIN_CAPABILITIES         => 'SQLUINTEGER bitmask'
, SQL_OWNER_TERM                      => 'SQLCHAR'
, SQL_OWNER_USAGE                     => 'SQLUINTEGER bitmask'
, SQL_PARAM_ARRAY_ROW_COUNTS          => 'SQLUINTEGER'
, SQL_PARAM_ARRAY_SELECTS             => 'SQLUINTEGER'
, SQL_POSITIONED_STATEMENTS           => 'SQLUINTEGER bitmask'
, SQL_POS_OPERATIONS                  => 'SQLINTEGER bitmask'
, SQL_PROCEDURES                      => 'SQLCHAR'
, SQL_PROCEDURE_TERM                  => 'SQLCHAR'
, SQL_QUALIFIER_LOCATION              => 'SQLUSMALLINT'
, SQL_QUALIFIER_NAME_SEPARATOR        => 'SQLCHAR'
, SQL_QUALIFIER_TERM                  => 'SQLCHAR'
, SQL_QUALIFIER_USAGE                 => 'SQLUINTEGER bitmask'
, SQL_QUOTED_IDENTIFIER_CASE          => 'SQLUSMALLINT'
, SQL_ROW_UPDATES                     => 'SQLCHAR'
, SQL_SCHEMA_TERM                     => 'SQLCHAR'
, SQL_SCHEMA_USAGE                    => 'SQLUINTEGER bitmask'
, SQL_SCROLL_CONCURRENCY              => 'SQLUINTEGER bitmask'
, SQL_SCROLL_OPTIONS                  => 'SQLUINTEGER bitmask'
, SQL_SEARCH_PATTERN_ESCAPE           => 'SQLCHAR'
, SQL_SERVER_NAME                     => 'SQLCHAR'
, SQL_SPECIAL_CHARACTERS              => 'SQLCHAR'
, SQL_SQL92_DATETIME_FUNCTIONS        => 'SQLUINTEGER bitmask'
, SQL_SQL92_FOREIGN_KEY_DELETE_RULE   => 'SQLUINTEGER bitmask'
, SQL_SQL92_FOREIGN_KEY_UPDATE_RULE   => 'SQLUINTEGER bitmask'
, SQL_SQL92_GRANT                     => 'SQLUINTEGER bitmask'
, SQL_SQL92_NUMERIC_VALUE_FUNCTIONS   => 'SQLUINTEGER bitmask'
, SQL_SQL92_PREDICATES                => 'SQLUINTEGER bitmask'
, SQL_SQL92_RELATIONAL_JOIN_OPERATORS => 'SQLUINTEGER bitmask'
, SQL_SQL92_REVOKE                    => 'SQLUINTEGER bitmask'
, SQL_SQL92_ROW_VALUE_CONSTRUCTOR     => 'SQLUINTEGER bitmask'
, SQL_SQL92_STRING_FUNCTIONS          => 'SQLUINTEGER bitmask'
, SQL_SQL92_VALUE_EXPRESSIONS         => 'SQLUINTEGER bitmask'
, SQL_SQL_CONFORMANCE                 => 'SQLUINTEGER'
, SQL_STANDARD_CLI_CONFORMANCE        => 'SQLUINTEGER bitmask'
, SQL_STATIC_CURSOR_ATTRIBUTES1       => 'SQLUINTEGER bitmask'
, SQL_STATIC_CURSOR_ATTRIBUTES2       => 'SQLUINTEGER bitmask'
, SQL_STATIC_SENSITIVITY              => 'SQLUINTEGER bitmask'
, SQL_STRING_FUNCTIONS                => 'SQLUINTEGER bitmask'
, SQL_SUBQUERIES                      => 'SQLUINTEGER bitmask'
, SQL_SYSTEM_FUNCTIONS                => 'SQLUINTEGER bitmask'
, SQL_TABLE_TERM                      => 'SQLCHAR'
, SQL_TIMEDATE_ADD_INTERVALS          => 'SQLUINTEGER bitmask'
, SQL_TIMEDATE_DIFF_INTERVALS         => 'SQLUINTEGER bitmask'
, SQL_TIMEDATE_FUNCTIONS              => 'SQLUINTEGER bitmask'
, SQL_TRANSACTION_CAPABLE             => 'SQLUSMALLINT'
, SQL_TRANSACTION_ISOLATION_OPTION    => 'SQLUINTEGER bitmask'
, SQL_TXN_CAPABLE                     => 'SQLUSMALLINT'
, SQL_TXN_ISOLATION_OPTION            => 'SQLUINTEGER bitmask'
, SQL_UNION                           => 'SQLUINTEGER bitmask'
, SQL_UNION_STATEMENT                 => 'SQLUINTEGER bitmask'
, SQL_USER_NAME                       => 'SQLCHAR'
, SQL_XOPEN_CLI_YEAR                  => 'SQLCHAR'
);
=head2 %ReturnValues
See: sql.h, sqlext.h
Edited:
