...
our $bl_para   = "-seg yes -evalue 0.000001 -max_target_seqs 100000";
our $bl_para_u = "";
our $bl_STDIN  = 1;
our $keep_bl   = 0;
...
$bl_para   = "-seg yes -evalue 0.000001 -max_target_seqs 100000 -num_threads $bl_threads";
}
...
$bl_para   = "-dust yes -evalue 0.000001 -max_target_seqs 100000 -num_threads $bl_threads";
}
...
if (@blm8_buffer and ($this_id ne $last_id)) {
...
for ($j=0; $j<$num_qsub; $j++) {
my $t = "psi-cd-hit-$j";
my $cmd = `qsub -N $t $remote_sh_script $j`;
my $qsub_id = 0;
