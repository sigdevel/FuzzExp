...
$html .= "<td align='middle' width='15%' bgColor='
$html .= "</tr><tr>\n" unless ++$i % 3;
}
}
elsif ( $string eq 'stations' ) {
my @stations = &mp3_radio_stations;
$html .= "<td align='center' colspan=2 bgColor='
...
if ($show_details) {
$html .= "<td align='center' width='15%' bgColor='
$html .= "<td align='center' width='15%' bgColor='
$html .= "<td align='center' width='15%' bgColor='
$html .= "<td align='center' width='5%' bgColor='
$html .= "<td align='center' width='10%' bgColor='
$html .= "</tr><tr>\n";
}
}
else {
